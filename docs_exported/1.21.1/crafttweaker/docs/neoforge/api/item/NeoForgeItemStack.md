...
```zenscript
// NeoForgeItemStack.getPotPattern() as DecoratedPotPattern?

myNeoForgeItemStack.getPotPattern();
```
...
```zenscript
// NeoForgeItemStack.getPotPatternId() as ResourceKey<T>?

myNeoForgeItemStack.getPotPatternId();
```
