...
<tag:item:minecraft:wool>.add(<tag:item:minecraft:wool>);
```
...
<tag:item:minecraft:wool>.addId(<resource:minecraft:diamond>);
```
...
<tag:item:minecraft:wool>.contains(<resource:minecraft:white_wool>);
```
...
<tag:item:minecraft:wool>.equals(<tag:item:minecraft:wool>);
```
...
<tag:item:minecraft:wool>.exists();
```
...
<tag:item:minecraft:wool>.idElements();
```
...
<tag:item:minecraft:wool>.remove(<tag:item:minecraft:wool>);
```
...
<tag:item:minecraft:wool>.removeId(<resource:minecraft:diamond>);
```
...
<resource:minecraft:white_wool> in <tag:item:minecraft:wool>
```
...
<tag:item:minecraft:wool> == <tag:item:minecraft:wool>
```
