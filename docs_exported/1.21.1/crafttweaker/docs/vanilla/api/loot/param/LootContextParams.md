...
```zenscript
// LootContextParams.attackingEntity() as LootContextParam<Entity>
...
:::group{name=directAttackingEntity}
...
```zenscript
// LootContextParams.directAttackingEntity() as LootContextParam<Entity>
