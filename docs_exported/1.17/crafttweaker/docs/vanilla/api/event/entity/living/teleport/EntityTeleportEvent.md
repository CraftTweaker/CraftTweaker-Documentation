...
EntityTeleportEvent extends [EntityEvent](/vanilla/api/event/entity/EntityEvent). That means all methods available in [EntityEvent](/vanilla/api/event/entity/EntityEvent) are also available in EntityTeleportEvent
