...
RightClickItemEvent extends [PlayerInteractEvent](/vanilla/api/event/entity/player/interact/PlayerInteractEvent). That means all methods available in [PlayerInteractEvent](/vanilla/api/event/entity/player/interact/PlayerInteractEvent) are also available in RightClickItemEvent
