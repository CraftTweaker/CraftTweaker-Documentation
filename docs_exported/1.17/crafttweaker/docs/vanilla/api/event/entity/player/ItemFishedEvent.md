...
ItemFishedEvent extends [PlayerEvent](/vanilla/api/event/entity/player/PlayerEvent). That means all methods available in [PlayerEvent](/vanilla/api/event/entity/player/PlayerEvent) are also available in ItemFishedEvent
...
|------|------|------------|------------|-------------|
| damageRodBy | [ItemFishedEvent](/vanilla/api/event/entity/player/ItemFishedEvent) | false | true | Sets the amount of durability damage to inflict on the fishing rod. |
