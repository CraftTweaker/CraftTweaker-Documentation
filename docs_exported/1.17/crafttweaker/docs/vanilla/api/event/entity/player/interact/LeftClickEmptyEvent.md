...
```zenscript
import crafttweaker.api.event.entity.player.interact.LeftClickEmptyEvent;
```


## Extending PlayerInteractEvent

LeftClickEmptyEvent extends [PlayerInteractEvent](/vanilla/api/event/entity/player/interact/PlayerInteractEvent). That means all methods available in [PlayerInteractEvent](/vanilla/api/event/entity/player/interact/PlayerInteractEvent) are also available in LeftClickEmptyEvent
