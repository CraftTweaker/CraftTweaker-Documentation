...
SpreadPlayersCommandTeleportEvent extends [EntityTeleportEvent](/vanilla/api/event/entity/living/teleport/EntityTeleportEvent). That means all methods available in [EntityTeleportEvent](/vanilla/api/event/entity/living/teleport/EntityTeleportEvent) are also available in SpreadPlayersCommandTeleportEvent
