...
CropGrowPostEvent extends [CropGrowEvent](/vanilla/api/event/block/crop/CropGrowEvent). That means all methods available in [CropGrowEvent](/vanilla/api/event/block/crop/CropGrowEvent) are also available in CropGrowPostEvent
