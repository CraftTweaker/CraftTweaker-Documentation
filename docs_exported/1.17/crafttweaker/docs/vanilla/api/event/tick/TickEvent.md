...
Return Type: [Phase](/vanilla/api/event/tick/Phase)
...
Return Type: [Type](/vanilla/api/event/tick/Type)
...
| phase | [Phase](/vanilla/api/event/tick/Phase) | true | false | No Description Provided |
...
| type | [Type](/vanilla/api/event/tick/Type) | true | false | No Description Provided |
