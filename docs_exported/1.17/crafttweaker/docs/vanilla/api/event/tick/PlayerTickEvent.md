...
PlayerTickEvent extends [TickEvent](/vanilla/api/event/tick/TickEvent). That means all methods available in [TickEvent](/vanilla/api/event/tick/TickEvent) are also available in PlayerTickEvent
