...
FluidIngredient that facilitates accepting either a single, or multiple [IFluidStack](/vanilla/api/fluid/IFluidStack)s, com.blamejared.crafttweaker.api.tag.MCTag<Fluid>s
