...
```zenscript
// CraftingTableRecipeManager.getAllRecipes() as stdlib.List<RecipeHolderRecipeHolder<T>>
...
```zenscript
CraftingTableRecipeManager.getRecipeByName(name as string) as RecipeHolderRecipeHolder<T>?
```
...
```zenscript
// CraftingTableRecipeManager.getRecipeMap() as RecipeHolderRecipeHolder<T>[ResourceLocation]
...
```zenscript
CraftingTableRecipeManager.getRecipesByOutput(output as IIngredient) as stdlib.List<RecipeHolderRecipeHolder<T>>
```
...
```zenscript
CraftingTableRecipeManager.getRecipesMatching(predicate as Predicate<RecipeHolderRecipeHolder<T>>) as stdlib.List<RecipeHolderRecipeHolder<T>>
```
...
```zenscript
// CraftingTableRecipeManager.removeMatching(predicate as Predicate<RecipeHolderRecipeHolder<T>>)
