...
<recipetype:create:milling>.addRecipe("milled", [<item:minecraft:diamond> % 50, <item:minecraft:apple>, (<item:minecraft:dirt> % 12) * 2], <item:minecraft:dirt>, 200);
```
...
```zenscript
MillingManager.removeByName(name as string) as void
```
