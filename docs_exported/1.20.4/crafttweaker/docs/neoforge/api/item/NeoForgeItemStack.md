...
```zenscript
// NeoForgeItemStack.anyDamage() as IngredientConditioned<IIngredient>
...
```zenscript
NeoForgeItemStack.getEnchantmentLevel(enchantment as Enchantment) as int
```
...
```zenscript
// NeoForgeItemStack.getEnchantments() as int?[Enchantment]

myNeoForgeItemStack.getEnchantments();
```
...
```zenscript
// NeoForgeItemStack.getFood() as FoodProperties?

myNeoForgeItemStack.getFood();
```
...
```zenscript
// NeoForgeItemStack.getHoverName() as Component

myNeoForgeItemStack.getHoverName();
```
...
```zenscript
// NeoForgeItemStack.getMaxStackSize() as int

myNeoForgeItemStack.getMaxStackSize();
```
...
```zenscript
// NeoForgeItemStack.getOrCreateTag() as IData

myNeoForgeItemStack.getOrCreateTag();
```
...
```zenscript
// NeoForgeItemStack.getRarity() as Rarity

myNeoForgeItemStack.getRarity();
```
...
```zenscript
// NeoForgeItemStack.isEdible() as boolean

myNeoForgeItemStack.isEdible();
```
...
```zenscript
// NeoForgeItemStack.isFireResistant() as boolean
...
```zenscript
// NeoForgeItemStack.matches(stack as IItemStack) as boolean
...
```zenscript
NeoForgeItemStack.only(condition as IIngredientCondition<IIngredient>) as IngredientConditioned<IIngredient>
```
...
```zenscript
// NeoForgeItemStack.onlyDamaged() as IngredientConditioned<IIngredient>
...
```zenscript
NeoForgeItemStack.onlyDamagedAtLeast(minDamage as int) as IngredientConditioned<IIngredient>
```
...
```zenscript
NeoForgeItemStack.onlyDamagedAtMost(maxDamage as int) as IngredientConditioned<IIngredient>
```
...
```zenscript
NeoForgeItemStack.onlyIf(uid as string, function as Predicate<IItemStack>) as IngredientConditioned<IIngredient>
```
...
```zenscript
// NeoForgeItemStack.removeEnchantment(enchantment as Enchantment) as IItemStack
...
```zenscript
// NeoForgeItemStack.resetHoverName()

myNeoForgeItemStack.resetHoverName();
```
...
```zenscript
// NeoForgeItemStack.reuse() as IIngredientTransformed<IIngredient>
...
```zenscript
NeoForgeItemStack.setEnchantments(enchantments as int?[Enchantment]) as IItemStack
```
...
```zenscript
NeoForgeItemStack.setFireResistant(fireResistant as boolean)
```
...
```zenscript
NeoForgeItemStack.setFood(food as FoodProperties?)
```
...
```zenscript
// NeoForgeItemStack.setMaxStackSize(newMaxStackSize as int)

myNeoForgeItemStack.setMaxStackSize(16);
```
...
```zenscript
// NeoForgeItemStack.setRarity(newRarity as Rarity)

myNeoForgeItemStack.setRarity(Rarity.UNCOMMON);
```
...
```zenscript
NeoForgeItemStack.transform(transformer as IIngredientTransformer<IIngredient>) as IIngredientTransformed<IIngredient>
```
...
```zenscript
NeoForgeItemStack.transformCustom(uid as string, function as Function<IItemStack,IItemStack>) as IIngredientTransformed<IIngredient>
```
...
```zenscript
NeoForgeItemStack.transformDamage(amount as int) as IIngredientTransformed<IIngredient>
```
...
```zenscript
NeoForgeItemStack.transformReplace(replaceWith as IItemStack) as IIngredientTransformed<IIngredient>
```
...
```zenscript
// NeoForgeItemStack.withAttributeModifier(attribute as Attribute, name as string, value as double, operation as AttributeOperation, slotTypes as EquipmentSlot[], preserveDefaults as boolean) as IItemStack

myNeoForgeItemStack.withAttributeModifier(<attribute:minecraft:generic.attack_damage>, "Extra Power", 10, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:chest>], true);
```
...
```zenscript
// NeoForgeItemStack.withAttributeModifier(attribute as Attribute, uuid as stdlib.UUID, name as string, value as double, operation as AttributeOperation, slotTypes as EquipmentSlot[], preserveDefaults as boolean) as IItemStack

myNeoForgeItemStack.withAttributeModifier(<attribute:minecraft:generic.attack_damage>, "8c1b5535-9f79-448b-87ae-52d81480aaa3", "Extra Power", 10, AttributeOperation.ADDITION, [<constant:minecraft:equipmentslot:chest>], true);
```
...
```zenscript
// NeoForgeItemStack.withAttributeModifier(attribute as Attribute, uuid as string, name as string, value as double, operation as AttributeOperation, slotTypes as EquipmentSlot[], preserveDefaults as boolean) as IItemStack
...
```zenscript
// NeoForgeItemStack.withDamage(damage as int) as IItemStack
...
```zenscript
// NeoForgeItemStack.withDisplayName(name as Component) as IItemStack
...
```zenscript
// NeoForgeItemStack.withEnchantment(enchantment as Enchantment, level as int) as IItemStack
...
```zenscript
// NeoForgeItemStack.withLore(lore as Component?[]) as IItemStack
...
```zenscript
// NeoForgeItemStack.withTag(tag as MapData) as IItemStack
...
```zenscript
// NeoForgeItemStack.withoutTag() as IItemStack
