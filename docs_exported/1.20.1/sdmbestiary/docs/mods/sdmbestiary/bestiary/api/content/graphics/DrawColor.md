...
| Parameter |                                          Type                                          |
|-----------|----------------------------------------------------------------------------------------|
| consumer  | Consumer&lt;[DrawColor](/mods/sdmbestiary/bestiary/api/content/graphics/DrawColor)&gt; |
...
Return Type: [DrawColor](/mods/sdmbestiary/bestiary/api/content/graphics/DrawColor)
