...
Builder to create a 'DamageSourceProperties' loot condition.
 ...
 This condition checks the [DamageSource](/vanilla/api/util/DamageSource) obtained from the [LootContext](/vanilla/api/loot/LootContext), along with
 additional relevant data, such as origin and world, according to the given [DamageSourcePredicate](/vanilla/api/predicate/DamageSourcePredicate).
