...
```zenscript
import mods.sdmcrtplus.events.entity.living.BabyEntitySpawnEvent;
```
...
| parentA | [Entity](/vanilla/api/entity/Entity)             | true       | false      |
| parentB | [Entity](/vanilla/api/entity/Entity)             | true       | false      |
