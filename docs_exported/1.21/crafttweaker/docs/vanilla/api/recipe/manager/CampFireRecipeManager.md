...
campfire.addRecipe("wool2diamond", <item:minecraft:diamond>, <tag:item:minecraft:wool>, 1.0, 30);
```
...
```zenscript
// CampFireRecipeManager.addRecipe(name as string, category as CookingBookCategory, output as IItemStack, input as IIngredient, xp as float, cookTime as int)

campfire.addRecipe("wool2diamond", <constant:minecraft:cookingbookcategory:misc>, <item:minecraft:diamond>, <tag:item:minecraft:wool>, 1.0, 30);
```
...
```zenscript
CampFireRecipeManager.getRecipeAsJson(name as string) as IData?
```
...
campfire.remove(<tag:item:minecraft:wool>);
```
...
campfire.removeRecipe(<item:minecraft:diamond>, <tag:item:minecraft:wool>);
```
