...
blastFurnace.addRecipe("wool2diamond", <item:minecraft:diamond>, <tag:item:minecraft:wool>, 1.0, 30);
```
...
blastFurnace.addRecipe("wool2diamond", <constant:minecraft:cookingbookcategory:misc>, <item:minecraft:diamond>, <tag:item:minecraft:wool>, 1.0, 30);
```
...
```zenscript
BlastFurnaceRecipeManager.getRecipeAsJson(name as string) as IData?
```
...
blastFurnace.remove(<tag:item:minecraft:wool>);
```
...
blastFurnace.removeRecipe(<item:minecraft:diamond>, <tag:item:minecraft:wool>);
```
