...
myKnownTagManager.elements(<tag:item:minecraft:dirt>);
```
...
myKnownTagManager.exists(<tag:item:minecraft:wool>);
```
...
myKnownTagManager.idElements(<tag:item:minecraft:wool>);
```
