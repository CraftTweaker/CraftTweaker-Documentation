...
SimpleInputOutput extends [SimpleJeiCategory](/mods/JEI/API/Category/SimpleJeiCategory). That means all methods available in [SimpleJeiCategory](/mods/JEI/API/Category/SimpleJeiCategory) are also available in SimpleInputOutput
