...
RandomChanceWithLootingLootCondition extends Record. That means all methods available in Record are also available in RandomChanceWithLootingLootCondition
