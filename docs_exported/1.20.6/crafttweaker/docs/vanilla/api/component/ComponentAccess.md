...
```zenscript
ComponentAccess.withBaseColor(color as invalid) as T
```
...
```zenscript
ComponentAccess.withCanBreak(predicate as invalid) as T
```
...
```zenscript
ComponentAccess.withCanPlaceOn(predicate as invalid) as T
```
...
```zenscript
ComponentAccess.withLock(lock as invalid) as T
```
...
```zenscript
ComponentAccess.withMapId(mapId as invalid) as T
```
...
```zenscript
ComponentAccess.withPotionContents(contents as invalid) as T
```
