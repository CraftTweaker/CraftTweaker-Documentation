...
| isRaining()        | regnet          | boolean                                          | Returns true if it is currently raining.                                                                                                                                                                  |
| isThundering()     | donnernd        | boolean                                          | Returns true if it is currently thundering.                                                                                                                                                               |
| getMoonPhase()     | mondphase       | int                                              | Returns the current moon phase.                                                                                                                                                                           |
| isDayTime()        | dayTime         | boolean                                          | Checks if it is daytime.                                                                                                                                                                                  |
| getWorldTime()     | Zeit            | long                                             | Returns the world's time.                                                                                                                                                                                 |
| getDimension()     | maße            | int                                              | Returns the world's dimension.                                                                                                                                                                            |
| isSurfaceWorld()   | oberflächenwelt | boolean                                          | Returns whether you are in a surface world or not.                                                                                                                                                        |
| getDimensionType() | dimensiontyp    | String                                           | Returns the dimension's type name.                                                                                                                                                                        |
