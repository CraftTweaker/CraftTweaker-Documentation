...
- **probabilityGroups** - An array of arrays with an double followed by any # of [IItemStack](/Vanilla/Items/IItemStack/)s. The double refers to the probability for its group. The double refers to the probability for its group. The double refers to the probability for its group.
