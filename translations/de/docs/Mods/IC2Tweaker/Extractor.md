...
`importieren mods.ic2.Extractor;`
...
```zenscript
mods.ic2.Extractor.addRecipe(IItemStack Ausgabe, IIngredient);
...
- Wenn Ic2 Experimental verwendet wird, um ein Rezept zu entfernen, entfernen Sie einfach die entsprechende Zeile in `config/ic2/extractor.ini`
