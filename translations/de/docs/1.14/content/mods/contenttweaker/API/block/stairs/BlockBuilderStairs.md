...
| Parameter     | Type                | Beschreibung                               |
| ------------- | ------------------- | ------------------------------------------ |
| bottomTexture | MCResource-Standort | The texture to be used for the bottom side |
...
| Parameter    | Type                | Beschreibung                         |
| ------------ | ------------------- | ------------------------------------ |
| sidesTexture | MCResource-Standort | The texture to be used for the sides |
...
| Parameter  | Type                | Beschreibung                            |
| ---------- | ------------------- | --------------------------------------- |
| topTexture | MCResource-Standort | The texture to be used for the top side |
