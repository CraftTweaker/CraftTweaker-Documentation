...
## Konstrukteure
```zenscript
neue crafttweaker.api.event.entity.player.MCUseHoeEvent(Handler als Funktion.Verbraucher<crafttweaker.api.event.entity.player.MCUseHoeEvent>);
```
| Parameter | Type                                                                                                                    | Beschreibung                 |
| --------- | ----------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.MCUseHoeEvent](/vanilla/api/event/entity/player/MCUseHoeEvent)> | Keine Beschreibung angegeben |
...
```zenscript
myMCUseHoeEvent.setCanceled(Abbrechen als boolean);
```
