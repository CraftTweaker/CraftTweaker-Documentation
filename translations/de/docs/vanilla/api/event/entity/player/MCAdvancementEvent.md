...
## Konstrukteure
```zenscript
neue crafttweaker.api.event.entity.player.MCAdvancementEvent(Handler als Funktion.Verbraucher<crafttweaker.api.event.entity.player.MCAdvancementEvent>);
```
| Parameter | Type                                                                                                                              | Beschreibung                 |
| --------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.MCAdvancementEvent](/vanilla/api/event/entity/player/MCAdvancementEvent)> | Keine Beschreibung angegeben |
...
```zenscript
myMCAdvancementEvent.setCanceled(Abbrechen als boolean);
```
