...
```zenscript
crafttweaker.api.event.entity.player.PlayerInteractEvent.MCRightClickLety
```

## Konstrukteure
```zenscript
neue crafttweaker.api.event.entity.player.PlayerInteractEvent.MCRightClickEmpty(Handler als Funktion.Verbraucher<crafttweaker.api.event.entity.player.PlayerInteractEvent.MCRightClickEmpty>);
```
| Parameter | Type                                                                                                                                                                   | Beschreibung                 |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.PlayerInteractEvent.MCRightClickLety](/vanilla/api/event/entity/player/PlayerInteractEvent/MCRightClickEmpty)> | Keine Beschreibung angegeben |
...
```zenscript
myMCRightClickEmpty.isAbbrechbar();
```
...
```zenscript
myMCRightClickEmpty.isStorniert();
```

### abgebrochen

```zenscript
myMCRightClickEmpty.setAbgebrochen (abbrechen als boolean);
```
