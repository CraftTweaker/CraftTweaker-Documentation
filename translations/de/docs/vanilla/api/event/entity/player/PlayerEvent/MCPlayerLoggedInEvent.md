...
## Konstrukteure
```zenscript
neue crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInEvent(Handler als Funktion.Verbraucher<crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInEvent>);
```
| Parameter | Type                                                                                                                                                            | Beschreibung                 |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInEvent](/vanilla/api/event/entity/player/PlayerEvent/MCPlayerLoggedInEvent)> | Keine Beschreibung angegeben |
...
```zenscript
myMCPlayerLoggedInEvent.setCanceled(abbrechen als boolean);
```
