...
## 함수의 변수화
함수를 변수처럼 사용할 수 있습니다. 이 경우에는 별도의 클래스와 같이 생성을 합니다. Other than that, they work pretty much the same as static functions, you call them by their variable name.  
