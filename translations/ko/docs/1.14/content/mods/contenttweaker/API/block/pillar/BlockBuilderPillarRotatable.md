...
| Parameter  | Type               | Description |
| ---------- | ------------------ | ----------- |
| endTexture | MCResourceLocation | 끝 면에 쓰일 텍스처 |
...
| Parameter  | Type                                                                        | Description |
| ---------- | --------------------------------------------------------------------------- | ----------- |
| endTexture | function.Function&lt;MCResourceLocation, MCResourceLocation&gt; | 사용할 함수      |
...
| Parameter    | Type               | Description |
| ------------ | ------------------ | ----------- |
| sidesTexture | MCResourceLocation | 측면에 쓰일 텍스처  |
...
| Parameter    | Type                                                                        | Description |
| ------------ | --------------------------------------------------------------------------- | ----------- |
| sidesTexture | function.Function&lt;MCResourceLocation, MCResourceLocation&gt; | 사용할 함수      |
