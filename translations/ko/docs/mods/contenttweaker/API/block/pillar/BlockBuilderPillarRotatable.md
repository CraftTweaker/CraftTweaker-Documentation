...
| Parameter  | Type                                     | Description |
| ---------- | ---------------------------------------- | ----------- |
| endTexture | crafttweaker.api.util.MCResourceLocation | 끝 면에 쓰일 텍스처 |
...
| Parameter  | Type                                                                                                                    | Description |
| ---------- | ----------------------------------------------------------------------------------------------------------------------- | ----------- |
| endTexture | function.Function&lt;crafttweaker.api.util.MCResourceLocation, crafttweaker.api.util.MCResourceLocation&gt; | 사용할 함수      |
...
| Parameter    | Type                                     | Description |
| ------------ | ---------------------------------------- | ----------- |
| sidesTexture | crafttweaker.api.util.MCResourceLocation | 측면에 쓰일 텍스처  |
...
| Parameter    | Type                                                                                                                    | Description |
| ------------ | ----------------------------------------------------------------------------------------------------------------------- | ----------- |
| sidesTexture | function.Function&lt;crafttweaker.api.util.MCResourceLocation, crafttweaker.api.util.MCResourceLocation&gt; | 사용할 함수      |
