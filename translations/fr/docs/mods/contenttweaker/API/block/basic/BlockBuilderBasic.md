...
Ce constructeur construit le type de bloc qui est utilisé par défaut dans [mods.contenttweaker.block.basic.BlockBuilderBasic#build](/mods/contenttweaker/API/block/basic/BlockBuilderBasic/#build) Ce constructeur n'offre aucune propriété spéciale à définir, vous ne pouvez que le construire.
...
```zenscript
mods.contenttweaker.block.basic.format@@0 BlockBuilderBasic
```
