...
| Parameter  | Type                          | Description                               |
| ---------- | ----------------------------- | ----------------------------------------- |
| endTexture | format@@0 MCRessourceLocation | The texture to be used for the end sides. |
...
| Parameter    | Type                          | Description                           |
| ------------ | ----------------------------- | ------------------------------------- |
| sidesTexture | format@@0 MCRessourceLocation | The texture to be used for the sides. |
