...
| `stack.withTag(tag IData, bool matchTagExact)`   | A new IItemStack with the specified NBT tag                       | [IData](/Vanilla/Data/IData/), bool |
| `stack.removeTag(String nom)`                    | A new IItemStack with the specified NBT tag removed, if it exists | string                              |
| `format@@0 stack.updateTag(IData tag)`           | A new IItemStack with the added NBT tag                           | [IData](/Vanilla/Data/IData/)       |
| `stack.updateTag(tag IData, bool matchTagExact)` | A new IItemStack with the added NBT tag                           | [IData](/Vanilla/Data/IData/), bool |
