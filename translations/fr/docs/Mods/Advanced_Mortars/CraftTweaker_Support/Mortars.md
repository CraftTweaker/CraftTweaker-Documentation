...
Vous pouvez appeler le paquet Mortar en utilisant `mods.advancedmortars.Mortar`.
...
<table>
  ...
  <tr>
    ...
    <td>
      <a href="/Vanilla/Variable_Types/IIngredient/">Ingrédient</a>
    </td>
