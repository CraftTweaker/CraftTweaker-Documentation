...
| -------------------------- | --------------------------------------------------------------------------------------------------------------- | -------- | ------------- | ------------------------------------------------------------------------------------ |
| beaconPayment              | boolean                                                                                                         | No       | Faux          | Can be given to a beacon to enable bonuses                                           |
...
| glowing                    | boolean                                                                                                         | No       | Faux          | Can be used to give your item the glowing effect (as if it were enchanted).          |
...
| itemDestroyedBlock         | [IItemDestroyedBlock](/Mods/ContentTweaker/Vanilla/Advanced_Functionality/Functions/IItemDestroyedBlock/)       | No       | Faux          | What happens when the item just destroyed a block?                                   |
...
| maxDamage                  | Indice                                                                                                          | No       | -1            | How many uses does the item have? Less than 0 means it cannot be damaged             |
| maxStackSize               | Indice                                                                                                          | No       | 64            | How many items can fit in one Stack? Less than 0 means standart stack size (64)      |
...
| smeltingExprerience        | flottant                                                                                                        | No       | -1            | How much experienve the player earns for smelting that item in a furnace?            |
| Localisation de la texture | [format@@0 CTResourceLocation](/Mods/ContentTweaker/Vanilla/Types/Resources/CTResourceLocation/)                | No       | null          | The item's resource location, used for textures etc.                                 |
| toolClass                  | chaîne de caractères                                                                                            | No       |               | What block types the tool can break                                                  |
| toolLevel                  | Indice                                                                                                          | No       | -1            | The level of blocks can be broken                                                    |
