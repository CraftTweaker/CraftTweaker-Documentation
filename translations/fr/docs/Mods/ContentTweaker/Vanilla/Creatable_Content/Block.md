...
| Nom                        | Type de texte                                                                                             | Required | Default Value                                                                                                  | Notes                                                                                               |
| -------------------------- | --------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
...
| beaconBase                 | boolean                                                                                                   | No       | Faux                                                                                                           | Can this block be used as part of a beacon's base?                                                  |
...
| blockHardness              | flottant                                                                                                  | No       | 5.0                                                                                                            | How long it takes to break                                                                          |
...
| blockResistance            | flottant                                                                                                  | No       | 5.0                                                                                                            | Explosion resistance                                                                                |
...
| entitySpawnable            | boolean                                                                                                   | No       | vrai                                                                                                           | Can be used to prevent any entities from spawning on this block                                     |
...
| gravity                    | boolean                                                                                                   | No       | Faux                                                                                                           | Is this block affected by gravity                                                                   |
...
| lightOpacity               | Indice                                                                                                    | No       | 255 if fullBlock is true or 0                                                                                  | Does Light pass through                                                                             |
| lightValue                 | Indice                                                                                                    | No       | 0                                                                                                              | Light level of block, ranges from 0-1. This value is multiplied by 15 to determine the final value. |
...
| slipperiness               | flottant                                                                                                  | No       | 0.6f                                                                                                           | Ice blocks are 0.98f                                                                                |
| Localisation de la texture | [format@@0 CTResourceLocation](/Mods/ContentTweaker/Vanilla/Types/Resources/CTResourceLocation/)          | No       | null                                                                                                           | The block's resource location, used for textures etc.                                               |
| toolClass                  | String                                                                                                    | No       | pickaxe                                                                                                        | Tool required to Break Block                                                                        |
| toolLevel                  | Indice                                                                                                    | No       | 2                                                                                                              | Tool Level required to Break Block                                                                  |
| translucent                | boolean                                                                                                   | No       | Faux                                                                                                           | Is see through                                                                                      |
| unlocalizedName            | String                                                                                                    | Yes      |                                                                                                                | Name, should be all lowercase                                                                       |
| witherProof                | boolean                                                                                                   | No       | Faux                                                                                                           | Can Wither's destroy this block                                                                     |
