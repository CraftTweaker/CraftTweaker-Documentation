...
| ------------------- | ---------------------------------------- | ----------------------------------------------------- |
| `Nom`               | [`NameSpacedString`](/Mods/Boson/Names/) | Name that uniquely identifies this tag                |
| `Type de type`      | [`TagType`](/Mods/Boson/Tags/TagType/)   | The type of this tag                                  |
...
| Opérateur | Syntaxe | Method equivalent | Notes |
| --------- | ------- | ----------------- | ----- |
| `-`       | `-TAG`  | `clear`           | \-   |
...
| Opérateur | Argument Type                            | Syntaxe          | Method Equivalent | Notes                                                                 |
| --------- | ---------------------------------------- | ---------------- | ----------------- | --------------------------------------------------------------------- |
...
| `+`       | `n'importe quel`                         | `TAG + ARG1`     | `addAll`          | Shorthand for a single element: same rules as the array version apply |
| `~`       | `Tag`                                    | `TAG ~ ARG1`     | `addFrom`         | \-                                                                   |
| `~`       | `any[]`                                  | `TAG ~ ARG1`     | `addAll`          | The array type must be the same as the tag's contents                 |
| `~`       | [`NameSpacedString`](/Mods/Boson/Names/) | `TAG ~ ARG1`     | `add`             | The overload only accepts one argument                                |
| `~`       | `n'importe quel`                         | `TAG ~ ARG1`     | `addAll`          | Shorthand for a single element: same rules as the array version apply |
...
| `-`       | `n'importe quel`                         | `TAG - ARG1`     | `removeAll`       | Shorthand for a single element: same rules as the array version apply |
