...
| ------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `directoryName`     | `chaîne de caractères`                                                 | Name of the directory where tag JSONs are in a data-pack                  |
| `Nom`               | `chaîne de caractères`                                                 | Mnemonic that identifies the given tag type; used in tag bracket handlers |
