...
```zenscript
format@@0 crafttweaker.api.event.entity.player.MCAdvancementEvent
```
...
| --------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.MCAdvancementEvent](/vanilla/api/event/entity/player/MCAdvancementEvent)> | Aucune description fournie |
...
```zenscript
monMCAdvancementEvent.est annulé();
```

### setAnnulé

```zenscript
myMCAdvancementEvent.setCancled(cancel as boolean);
```
