# format@@0 MCSleepingTimeCheckEvent
...
```zenscript
format@@0 crafttweaker.api.event.entity.player.MCSleepingTimeCheckEvent
```
...
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.MCSleepingTimeCheckEvent](/vanilla/api/event/entity/player/MCSleepingTimeCheckEvent)> | Aucune description fournie |
...
```zenscript
monMCSleepingTimeCheckEvent.hasResult();
```
...
```zenscript
myMCSleepingTimeCheckEvent.isCancled();
```

### setAnnulé

```zenscript
myMCSleepingTimeCheckEvent.setCancled(cancel as boolean);
```
