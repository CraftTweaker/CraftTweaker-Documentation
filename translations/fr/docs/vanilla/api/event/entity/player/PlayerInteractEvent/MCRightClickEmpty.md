# Le bouton droit de la souris est vide
...
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.PlayerInteractEvent.MCRightClickEmpty](/vanilla/api/event/entity/player/PlayerInteractEvent/MCRightClickEmpty)> | Aucune description fournie |
...
```zenscript
myMCRightClickVide.isCancelable();
```
...
```zenscript
myMCRightClickVide.isCancled();
```

### setAnnulé

```zenscript
myMCRightClickEmpty.setCancled(cancel as boolean);
```
