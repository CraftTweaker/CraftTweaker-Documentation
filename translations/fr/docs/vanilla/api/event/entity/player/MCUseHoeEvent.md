...
| --------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| handler   | function.Consumer<[crafttweaker.api.event.entity.player.MCUseHoeEvent](/vanilla/api/event/entity/player/MCUseHoeEvent)> | Aucune description fournie |
...
```zenscript
myMCUseHoeEvent.isCancled();
```

### setAnnulé

```zenscript
myMCUseHoeEvent.setCancled(cancel as boolean);
```
