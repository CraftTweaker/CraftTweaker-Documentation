...
| ---------- | ---------------------------------------- | -------------------------------------------------------- |
| definition | Renvoie la définition du bloc            | [Définition IBlock](/Vanilla/Blocks/IBlockDefinition/)   |
| meta       | Renvoie les métadonnées du bloc          | int                                                      |
| données    | Retourne les données de la tuile du bloc | [IData](/Vanilla/Data/IData/)                            |
| fluid      | Renvoie le fluide du bloc                | [ILiquidDefinition](/Vanilla/Liquids/ILiquidDefinition/) |
