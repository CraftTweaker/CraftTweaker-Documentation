...
| ------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------ | ---------------------- |
| id            | returns the player's id                                                                    | chaîne de caractères                       | `player.id`            |
| Nom           | returns the player's name                                                                  | chaîne de caractères                       | `player.name`          |
| data          | returns the player's data                                                                  | [IData](/Vanilla/Data/IData/)              | `player.data`          |
| xp            | returns the player's experience level. Can also be used to set a player's experience level | Indice                                     | `player.xp`            |
| hotbarSize    | returns the player's hotbar size                                                           | Indice                                     | `player.hotbarSize`    |
| inventorySize | returns the player's inventory size                                                        | Indice                                     | `player.inventorySize` |
| currentItem   | returns the item the player is currently holding                                           | [IItemStack](/Vanilla/Items/IItemStack/)   | `player.currentItem`   |
| creative      | returns if the player is currently in creative mode (a.k.a gamemode 1)                     | booléen                                    | `player.creative`      |
| adventure     | returns if the player is currently in adventure mode (a.k.a gamemode 2)                    | booléen                                    | `player.adventure`     |
...
| Méthode Zen              | Parameter Type(s)                        | What does it do                                                     | Exemple                                     |
| ------------------------ | ---------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------- |
| removeXP(XPtoRemove)     | Indice                                   | Removes the given experience levels from the player.                | `player.removeXP(1)`                        |
...
| getHotbarStack(index)    | Indice                                   | Returns the item at the given index within the player's hotbar.     | `player.getHotbarStack(3)`                  |
| getInventoryStack(index) | Indice                                   | Returns the item at the given index within the player's inventory.  | `player.getInventoryStack(3)`               |
...
| executeCommand(raw)      | chaîne de caractères                     | Executes the command as the player                                  | `player.executeCommand("kill")`             |