...
| Index and Members                 | `[i]` | `[i]=v` | `Membre` | `.member=v` | `.length`   | `.immutable` | `.update(v)` |
| --------------------------------- | ----- | ------- | -------- | ----------- | ----------- | ------------ | ------------ |
| DataBool                          | ✘     | ✘       | ✘        | ✘           | returns `0` | ✔            | ✔            |
| DataByte                          | ✘     | ✘       | ✘        | ✘           | returns `0` | ✔            | ✔            |
| DataByte[]                        | ✔     | ✔       | ✘        | ✘           | ✔           | ✔            | ✔            |
...
| Casts from ↓ to →                 | booléen | octet | byte[] | double | flottant | Indice | int[]  | list   | long | [Carte](/AdvancedFunctions/Associative_Arrays/) | court | chaîne de caractères |
| --------------------------------- | ------- | ----- | ------ | ------ | -------- | ------ | ------ | ------ | ---- | ----------------------------------------------- | ----- | -------------------- |
