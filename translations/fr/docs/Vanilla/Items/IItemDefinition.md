...
| ------------------ | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| id                 | Returns the item ID                                                                                  | chaîne de caractères                                           |
| Nom                | Returns the unlocalized item Name                                                                    | chaîne de caractères                                           |
...
| owner              | Returns the mod name that this item belongs to.                                                      | chaîne de caractères                                           |
