...
| --------- | ------------------------------------------------------------ | --------------------------- | ---------- | ------------------ |
| elenco    | List<[crafttweaker.api.data.IData](/vanilla/api/data/IData)> | Nessuna descrizione fornita | vero       | null               |
...
| ------------------------------------------------------------ | --------- |
| List<[crafttweaker.api.data.IData](/vanilla/api/data/IData)> | vero      |
