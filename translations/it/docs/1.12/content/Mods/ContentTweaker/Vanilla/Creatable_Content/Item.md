...
| Property Name            | Tipo                                                                                                                  | Required | Default Value | Description/Notes                                                                    |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------- | -------- | ------------- | ------------------------------------------------------------------------------------ |
| beaconPayment            | boolean                                                                                                               | No       | no            | Can be given to a beacon to enable bonuses                                           |
...
| glowing                  | boolean                                                                                                               | No       | no            | Can be used to give your item the glowing effect (as if it were enchanted).          |
...
| itemDestroyedBlock       | [IItemDestroyedBlock](/Mods/ContentTweaker/Vanilla/Advanced_Functionality/Functions/IItemDestroyedBlock/)             | No       | no            | What happens when the item just destroyed a block?                                   |
