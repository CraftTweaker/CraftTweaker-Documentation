...
| gaseous         | boolean                                                                                  | No       | no                               | Is the fluid gaseous (flows upwards instead of downwards)?                           |
...
| colorize        | boolean                                                                                  | No       | sì                               | Is the fluid's color-code applied?                                                   |
...
| vaporize        | boolean                                                                                  | No       | no                               | Does vaporize when placed in the Nether?                                             |
