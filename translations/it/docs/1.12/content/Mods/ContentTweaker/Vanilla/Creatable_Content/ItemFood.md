...
| Property        | Tipo                                                                                            | Required | Default Value | Description/Notes                                           |
| --------------- | ----------------------------------------------------------------------------------------------- | -------- | ------------- | ----------------------------------------------------------- |
| healAmount      | int                                                                                             | Yes      |               | How many food points are restored when eaten?               |
| alwaysEdible    | bool                                                                                            | No       | no            | Can the food still be eaten if the user's food bar is full? |
| wolfFood        | bool                                                                                            | No       | no            | Can the food be used to tame woves?                         |
