...
IntArrayData implements the following interfaces. Ciò significa che ogni metodo presente nell'interfaccia può essere usato anche per questa classe.
...
| --------- | ----- | --------------------------- |
| internal  | int[] | Nessuna descrizione fornita |
