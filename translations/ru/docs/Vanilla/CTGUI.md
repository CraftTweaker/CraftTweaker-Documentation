...
<details><summary>Предыстория</summary> Некоторые люди не оценивают текстовые редакторы. Даже использование подсветки синтаксиса их не удовлетворяет. They want a GUI (Graphical User Interface).  
