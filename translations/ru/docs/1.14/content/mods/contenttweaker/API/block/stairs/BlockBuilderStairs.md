...
| Параметр      | Тип                              | Описание                                   |
| ------------- | -------------------------------- | ------------------------------------------ |
| bottomTexture | Расположение MCResource-ресурсов | The texture to be used for the bottom side |
...
| Параметр   | Тип                              | Описание                                |
| ---------- | -------------------------------- | --------------------------------------- |
| topTexture | Расположение MCResource-ресурсов | The texture to be used for the top side |
