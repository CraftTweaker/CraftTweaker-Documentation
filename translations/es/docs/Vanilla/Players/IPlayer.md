...
| Zengetter     | ¿Qué hace                                                                                  | Tipo de devolución                         | Usage                  |
| ------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------ | ---------------------- |
| id            | returns the player's id                                                                    | cadena                                     | `player.id`            |
| nombre        | returns the player's name                                                                  | cadena                                     | `player.name`          |
...
| creative      | returns if the player is currently in creative mode (a.k.a gamemode 1)                     | pluma                                      | `player.creative`      |
| adventure     | returns if the player is currently in adventure mode (a.k.a gamemode 2)                    | pluma                                      | `player.adventure`     |
| x             | returns the player's current X position in the world                                       | doble                                      | `player.x`             |
| y             | returns the player's current y position in the world                                       | doble                                      | `player.y`             |
| z             | returns the player's current z position in the world                                       | doble                                      | `player.z`             |
...
| Método                   | Parameter Type(s)                        | ¿Qué hace                                                           | Ejemplo                                     |
| ------------------------ | ---------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------- |
...
| executeCommand(raw)      | cadena                                   | Executes the command as the player                                  | `player.executeCommand("kill")`             |