...
| ------------------- | -------- | ----------------------------------------------------------------------- |
| `nameSpace`         | `cadena` | Gets the namespace portion of the `NameSpacedString` (e.g. `minecraft`) |
| `ruta`              | `cadena` | Gets the path portion of the `NameSpacedString` (e.g. `iron_ingot`)     |
