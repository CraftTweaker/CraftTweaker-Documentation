...
| Parameter     | Type                 | Description                                |
| ------------- | -------------------- | ------------------------------------------ |
| bottomTexture | Ubicación MCResource | The texture to be used for the bottom side |
...
| Parameter    | Type                 | Description                          |
| ------------ | -------------------- | ------------------------------------ |
| sidesTexture | Ubicación MCResource | The texture to be used for the sides |
...
| Parameter  | Type                 | Description                             |
| ---------- | -------------------- | --------------------------------------- |
| topTexture | Ubicación MCResource | The texture to be used for the top side |
