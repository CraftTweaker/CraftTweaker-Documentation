...
El constructor de objetos es... construye objetos (¡sorpresa!) <p> Le permite establecer varias propiedades que cambiarán cómo se comporta el objeto y qué puede hacer. También puedes usar [mods.contenttweaker.item.ItemBuilder#withType](/mods/contenttweaker/API/item/ItemBuilder/#withtype) para cambiar a un constructor más especializado, si existe ninguno. <p> Para decirle a CoT que quieres que el objeto aparezca en el juego, necesitas llamar a [mods.contenttweaker.item.ItemBuilder#build(String)](/mods/contenttweaker/API/item/ItemBuilder/#build) y especificar una ruta de ubicación de recurso válida.
...
```zenscript
mods.contenttweaker.item.Constructor de objetos
```
...
```zenscript
nuevo elemento mods.contenttweaker.item.Constructor();
```
...
Tipo de retorno: [mods.contenttweaker.item.Constructor de objetos](/mods/contenttweaker/API/item/ItemBuilder)
...
Te permite establecer el daño máximo para este objeto.<br/> Ten en cuenta que esto no puede utilizarse en combinación con [mods.contenttweaker.item.ItemBuilder#withMaxStackSize](/mods/contenttweaker/API/item/ItemBuilder/#withmaxstacksize)!
...
Te permite establecer el tamaño máximo de la pila para este elemento.<br/> Ten en cuenta que esto no puede utilizarse en combinación con [mods.contenttweaker.item.¡Constructor de objetos#con el máximo daño](/mods/contenttweaker/API/item/ItemBuilder/#withmaxdamage)!
