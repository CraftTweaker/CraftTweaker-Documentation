...
```zenscript
crafttweaker.api.receta.Arreglo de función de receta
```
...
```zenscript
myRecipeFunctionArray.process(usualOut as crafttweaker.api.item.ItemStack, entradas como crafttweaker.api.item.IItemStack[]);
```
