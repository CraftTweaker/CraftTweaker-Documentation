...
| Parámetro | Tipo  | Descripción    |
| --------- | ----- | -------------- |
| x         | doble | x value to add |
| y         | doble | y value to add |
| z         | doble | z value to add |
...
| Parámetro | Tipo                                                         | Descripción               |
| --------- | ------------------------------------------------------------ | ------------------------- |
| a         | [crafttweaker.api.util.BlockPos](/vanilla/api/util/BlockPos) | BlockPos to check against |
...
| Parámetro | Tipo    | Descripción                                                           |
| --------- | ------- | --------------------------------------------------------------------- |
| x         | doble   | x position to check against                                           |
| y         | doble   | y position to check against                                           |
| z         | doble   | z position to check against                                           |
| useCenter | boolean | should the center of the coordinate be used? (adds 0.5 to each value) |
...
| distance  | doble                                                        | distance to check within                       |
