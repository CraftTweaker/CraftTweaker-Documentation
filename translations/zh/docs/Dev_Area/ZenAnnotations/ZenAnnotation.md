...
| 注解                                                                       | 值                                                               | 目标 | 信息                                                                        |
| ------------------------------------------------------------------------ | --------------------------------------------------------------- | -- | ------------------------------------------------------------------------- |
| [`@ZenClass`](/Dev_Area/ZenAnnotations/Annotation_ZenClass/)             | ZenClass 名称 (e.g. `craftminstrer.item.IItemStack`), 可能不同于类的正式名称 | 类  | 名称必须唯一                                                                    |
...
| [`@可选的`](/Dev_Area/ZenAnnotations/Annotation_Optional/) | 参数 | 表示参数是可选的。 可选参数在方法被调用时可以省略 |
...
| [`@ZenMethod@ZenMethods`](/Dev_Area/ZenAnnotations/Annotation_ZenMethod/)  |                                       | 方法 |
| [`@ZenMethods 静态模式`](/Dev_Area/ZenAnnotations/Annotation_ZenMethodStatic/) |                                       | 方法 |
