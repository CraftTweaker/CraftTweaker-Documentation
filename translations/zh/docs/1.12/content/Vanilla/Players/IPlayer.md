...
| name（名称）      | returns the player's name                                                                  | string                                                    | `player.name`          |
| data          | returns the player's data                                                                  | [IData #数据](/Vanilla/Data/IData/)                         | `player.data`          |
...
| x             | returns the player's current X position in the world                                       | 双精度                                                       | `player.x`             |
| y             | returns the player's current y position in the world                                       | 双精度                                                       | `player.y`             |
| z             | returns the player's current z position in the world                                       | 双精度                                                       | `player.z`             |
...
| update(IData)                              | [IData #数据](/Vanilla/Data/IData/)                          | Updates the playerdata to the provided IData.                                                                                                  |                                                        |
