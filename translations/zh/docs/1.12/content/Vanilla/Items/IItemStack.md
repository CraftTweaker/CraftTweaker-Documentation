...
| hardness            | hardness            | 浮点数                                                         |
| damage              |                     | int                                                         |
| maxDamage           | maxDamage           | int                                                         |
| hasTag              |                     | bool                                                        |
| tag #标签             | withTag(tag)        | [IData #数据](/Vanilla/Data/IData/)                           |
...
| capNBT              |                     | [IData #数据](/Vanilla/Data/IData/)                           |
...
| `stack.withTag(IData tag)`                       | A new IItemStack with the specified NBT tag                       | [IData #数据](/Vanilla/Data/IData/)   |
| `stack.withTag(IData tag, bool matchTagExact)`   | A new IItemStack with the specified NBT tag                       | [IData](/Vanilla/Data/IData/), bool |
| `移除标签(名称)`                                       | A new IItemStack with the specified NBT tag removed, if it exists | string                              |
| `更新标签(IData标签)`                                  | A new IItemStack with the added NBT tag                           | [IData #数据](/Vanilla/Data/IData/)   |
...
| Method call                    | Returns                                            |
| ------------------------------ | -------------------------------------------------- |
| `stack.getCapNBT()`            | [IData #数据](/Vanilla/Data/IData/)                  |
