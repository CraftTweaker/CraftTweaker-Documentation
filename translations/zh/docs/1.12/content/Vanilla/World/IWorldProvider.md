...
| cloudHeight            | getCloudHeight()            | 浮点数                                    |
| currentMoonPhaseFactor | getCurrentMoonPhaseFactor() | 浮点数                                    |
| dimensionID            | getDimensionID()            | int                                    |
| height #实体高度           | getHeight()                 | int                                    |
| horizon                | getHorizon()                | 双精度                                    |
| lightBrightnesTable    | getLightBrightnesTable()    | float[]                                |
| movementFactor         | getMovementFactor()         | 双精度                                    |
