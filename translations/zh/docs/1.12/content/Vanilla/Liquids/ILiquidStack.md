...
| gaseous     | This returns whether the referred liquid is gaseous       | 布尔值                                                       | `test = <liquid:lava>.gaseous;`     |
| tag #标签     | This returns the ILiquidObject's tag                      | [IData #数据](/Vanilla/Data/IData/)                         | `test = <liquid:lava>.tag;`         |
