...
`@ModOnly` 注解和名称一样简单：  
只在加载 mod 时注册 ZenClass。

## 例子

[CraftTweaker 测试项目 ModOnly](https://github.com/jaredlll08/CraftTweaker/tree/1.12/CraftTweaker2-MC1120-Tests/src/main/java/crafttweaker/tests/wiki/ModOnlyWiki.java)
```java
@ModOnly(value = "mcp")
