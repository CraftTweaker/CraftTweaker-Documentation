...
静态方法可以被通过 [ZenClass 类名](/Dev_Area/ZenAnnotations/Annotation_ZenClass/)使用，非静态的方法使用 `object.methodName(参数……);`。  
ZenMethod 注解可以与其他[注解](/Dev_Area/ZenAnnotations/ZenAnnotation/)同时存在，如 [ZenOperator 注解](/Dev_Area/ZenAnnotations/Annotation_ZenOperator/)。
