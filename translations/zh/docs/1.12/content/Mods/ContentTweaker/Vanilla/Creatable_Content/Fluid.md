...
| gaseous         | 布尔值                                                                                      | No       | false                            | Is the fluid gaseous (flows upwards instead of downwards)?                           |
...
| colorize        | 布尔值                                                                                      | No       | true                             | Is the fluid's color-code applied?                                                   |
...
| vaporize        | 布尔值                                                                                      | No       | false                            | Does vaporize when placed in the Nether?                                             |
