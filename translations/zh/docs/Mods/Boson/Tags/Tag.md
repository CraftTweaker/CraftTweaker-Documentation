...
| 属性名称       | 返回值类型                                    | 描述                                                    |
| ---------- | ---------------------------------------- | ----------------------------------------------------- |
| `名称`       | [`NameSpacedString`](/Mods/Boson/Names/) | Name that uniquely identifies this tag                |
...
| 运算符     | Argument Type                            | 语句               | Method Equivalent | 注                                                                     |
| ------- | ---------------------------------------- | ---------------- | ----------------- | --------------------------------------------------------------------- |
| `+`     | `标签`                                     | `TAG + ARG1`     | `addFrom`         | \-                                                                   |
| `+`     | `any[]`                                  | `TAG + ARG1`     | `addAll`          | The array type must be the same as the tag's contents                 |
| `+`     | [`NameSpacedString`](/Mods/Boson/Names/) | `TAG + ARG1`     | `添加`              | The overload only accepts one argument                                |
| `+`     | `任意一个`                                   | `TAG + ARG1`     | `addAll`          | Shorthand for a single element: same rules as the array version apply |
| `~`     | `标签`                                     | `TAG ~ ARG1`     | `addFrom`         | \-                                                                   |
| `~`     | `any[]`                                  | `TAG ~ ARG1`     | `addAll`          | The array type must be the same as the tag's contents                 |
| `~`     | [`NameSpacedString`](/Mods/Boson/Names/) | `TAG ~ ARG1`     | `添加`              | The overload only accepts one argument                                |
| `~`     | `任意一个`                                   | `TAG ~ ARG1`     | `addAll`          | Shorthand for a single element: same rules as the array version apply |
...
| `&` | [`NameSpacedString`](/Mods/Boson/Names/) | `TAG & ARG1` | `添加`              | The overload only accepts one argument                                |
| `&` | `任意一个`                                   | `TAG & ARG1` | `addAll`          | Shorthand for a single element: same rules as the array version apply |
| `-`     | `标签`                                     | `TAG - ARG1`     | `removeFrom`      | \-                                                                   |
| `-`     | `any[]`                                  | `TAG - ARG1`     | `全部移除`            | The array type must be the same as the tag's contents                 |
| `-`     | [`NameSpacedString`](/Mods/Boson/Names/) | `TAG - ARG1`     | `remove #移除`      | The overload only accepts one argument                                |
| `-`     | `任意一个`                                   | `TAG - ARG1`     | `全部移除`            | Shorthand for a single element: same rules as the array version apply |
| `==`    | `标签`                                     | `TAG == ARG1`    | \-               | Acts as an equality check, matching contents; does not mutate `TAG`   |
| `()`    | \-                                      | `TAG()`          | `elements`        | \-                                                                   |
