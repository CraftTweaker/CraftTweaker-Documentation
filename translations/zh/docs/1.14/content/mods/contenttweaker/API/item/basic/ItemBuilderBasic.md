...
项目的基本生成器，也由 [mods.contenttweeper.item.basicItemBuilderBasic#build](/mods/contenttweaker/API/item/basic/ItemBuilderBasic/#build) 调用。 Does not have any special properties, it exists.
