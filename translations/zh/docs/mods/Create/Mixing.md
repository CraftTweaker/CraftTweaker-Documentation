...
1) Output an Arrow when a Diamond and an Apple are Mixed with no heat. 2) Output a Brick when a Diamond, Dirt and Lava (fluid) are Mixed with "heated" heat. 3) Output Paper when Glass, Dirt and Lava (fluid) are Mixed with "superheated" heat.
