...
```zenscript
craftminstrer.api.event.entity.player.MCPlayerDestroyItemEvent
```

## Constructor #构造函数
```zenscript
新 craftminstrer.api.event.entity.player.MCPlayerDestemEvent(处理程序作为函数。消费者<crafttweaker.api.event.entity.player.MCPlayerDestroyItemEvent>);
```
| 参数      | 类型                                                                                                                                   | 描述                      |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| handler | Consumer<[craftmiliter.api.event.entity.player.MCPlayerDestroyItemEvent](/vanilla/api/event/entity/player/MCPlayerDestroyItemEvent)> | No description provided |
