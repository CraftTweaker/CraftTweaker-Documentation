...
```zenscript
craftminstrer.api.event.entity.player.PlayerXpEvent.MCLevelChange
```

## Constructor #构造函数
```zenscript
新 craftminstrer.api.event.entity.player.PlayerXpEvent.MCLevelChange(处理程序作为函数。消费者<crafttweaker.api.event.entity.player.PlayerXpEvent.MCLevelChange>);
```
| 参数      | 类型                                                                                                                                    | 描述                      |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| handler | 消费者<[craftmiliter.api.event.entity.player.PlayerXpEvent.MCLevelChange](/vanilla/api/event/entity/player/PlayerXpEvent/MCLevelChange)> | No description provided |
...
```zenscript
myMCLevelChange.setLevels(含有级别)；
```
