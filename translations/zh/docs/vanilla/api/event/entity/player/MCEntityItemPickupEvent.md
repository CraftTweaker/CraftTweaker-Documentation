...
```zenscript
craftminstrer.api.event.entity.player.MCEntityItemPickupEvent
```

## Constructor #构造函数
```zenscript
新 craftminstrer.api.event.entity.player.MCEntityItemPickupEvent(处理程序作为函数。消费者<crafttweaker.api.event.entity.player.MCEntityItemPickupEvent>);
```
| 参数      | 类型                                                                                                                            | 描述                      |
| ------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| handler | 消费者<[craftmiliter.api.event.entity.player.MCEntityItemPickupEvent](/vanilla/api/event/entity/player/MCEntityItemPickupEvent)> | No description provided |
...
```zenscript
myMCEntityItemPickupEvent.isCancelled();
```
