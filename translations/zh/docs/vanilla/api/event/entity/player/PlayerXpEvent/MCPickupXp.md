...
```zenscript
craftminstrer.api.event.entity.player.PlayerXpEvent.MCPickupXp
```

## Constructor #构造函数
```zenscript
新 craftminstrer.api.event.entity.player.PlayerXpEvent.MCPickupXp(处理函数。消费者<crafttweaker.api.event.entity.player.PlayerXpEvent.MCPickupXp>)；
```
| 参数      | 类型                                                                                                                              | 描述                      |
| ------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| handler | 消费者<[craftmiliter.api.event.entity.player.PlayerXpEvent.MCPickupXp](/vanilla/api/event/entity/player/PlayerXpEvent/MCPickupXp)> | No description provided |
