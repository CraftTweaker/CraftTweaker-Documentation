...
```zenscript
craftbinstruer.api.recipe.RecipeFunctionArray
```
...
```zenscript
myRecipeFunctionArray.process(usualOut as craftbiner.api.item.IItemStack, input as craftbiner.api.item.IItemStack[]);
```
