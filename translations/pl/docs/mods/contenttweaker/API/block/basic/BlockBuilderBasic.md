...
Ten konstruktor buduje typ bloku, który jest domyślnie używany w [mods.contenttweaker.block.basic.BlockBuilderBasic#build](/mods/contenttweaker/API/block/basic/BlockBuilderBasic/#build) Ten konstruktor nie oferuje żadnych specjalnych właściwości, możesz go tylko zbudować.
...
```zenscript
[PLACEHOLDER] mods.contenttweaker.block.basic.BlockBuilderBasic
```
