...
Konstruktor przedmiotów jest... budować przedmioty (zaskoczenie!) <p> Pozwala ustawić różne właściwości, które zmienią sposób zachowania przedmiotu i co może zrobić. Możesz również użyć [mods.contenttweaker.itemem.ItemBuilder#withType](/mods/contenttweaker/API/item/ItemBuilder/#withtype) , aby przełączyć się na bardziej wyspecjalizowanego budowlanego budowlanego jeśli istnieje taki budownictwo. <p> Aby powiedzieć CoT, że chcesz aby element pojawiał się w nazwie, musisz wywołać [mods.contenttweaker.itemem.ItemBuilder#build(String)](/mods/contenttweaker/API/item/ItemBuilder/#build) i określ prawidłową ścieżkę lokalizacji zasobów.
...
```zenscript
mods.contenttweaker.item.Konstruktor przedmiotów
```
...
## Konstruktorzy
Tworzy nowy Konstruktor Elementów. Pamiętaj, że to _nie_ utworzy nowego bloku w grze, musisz wywołać [mods.contenttweaker.itemem.ElementBuilder#build(String)](/mods/contenttweaker/API/item/ItemBuilder/#build) dla tego.
```zenscript
nowy mods.contenttweaker.itemem.Konstruktor przedmiotu();
```
...
Typ zwracania: [mods.contenttweaker.itemem.Konstruktor przedmiotów](/mods/contenttweaker/API/item/ItemBuilder)
...
Pozwala ustawić maksymalne obrażenia dla tego przedmiotu.<br/> Należy ostrzec, że nie można tego użyć w połączeniu z [mods.contenttweaker.itemem.Konstruktor przedmiotów#withMaxStackSize](/mods/contenttweaker/API/item/ItemBuilder/#withmaxstacksize)!
...
Pozwala ustawić maksymalny rozmiar stosu dla tego elementu.<br/> Należy ostrzec, że nie można tego użyć w połączeniu z [mods.contenttweaker.itemem.ItemBuilder#withMaxDamage](/mods/contenttweaker/API/item/ItemBuilder/#withmaxdamage)!
