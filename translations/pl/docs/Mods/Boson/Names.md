...
| ----------------- | ------------- | ----------------------------------------------------------------------- |
| `nameSpace`       | `ciąg znaków` | Gets the namespace portion of the `NameSpacedString` (e.g. `minecraft`) |
| `ścieżka`         | `ciąg znaków` | Gets the path portion of the `NameSpacedString` (e.g. `iron_ingot`)     |
