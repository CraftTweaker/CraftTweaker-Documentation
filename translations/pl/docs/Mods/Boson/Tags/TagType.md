...
| ------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `directoryName`     | `ciąg znaków`                                                          | Name of the directory where tag JSONs are in a data-pack                  |
| `Nazwa`             | `ciąg znaków`                                                          | Mnemonic that identifies the given tag type; used in tag bracket handlers |
| `classType`         | [`Klasa`](/Mods/Boson/Reflection/Class/)                               | Type of objects stored in the tag                                         |
