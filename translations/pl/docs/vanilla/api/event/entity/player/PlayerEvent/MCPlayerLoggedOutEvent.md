...
## Konstruktorzy
```zenscript
nowy crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedOutEvent(handler jako funkcja.Consumer<crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedOutEvent>);
```
| Parametr | Typ                                                                                                                                                                | Opis             |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedOutEvent](/vanilla/api/event/entity/player/PlayerEvent/MCPlayerLoggedOutEvent)> | Nie podano opisu |
...
```zenscript
myMCPlayerLoggedOutEvent.setCanceled(anuluj jako boolean);
```
