...
## Konstruktorzy
```zenscript
nowe crafttweaker.api.event.entity.player.MCArrowNockEvent(handler jako funkcja.Consumer<crafttweaker.api.event.entity.player.MCArrowNockEvent>);
```
| Parametr | Typ                                                                                                                            | Opis             |
| -------- | ------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.MCArrowNockEvent](/vanilla/api/event/entity/player/MCArrowNockEvent)> | Nie podano opisu |
...
```zenscript
myMCArrowNockEvent.setCanceled(anuluj jako boolean);
```
