...
## Konstruktorzy
```zenscript
nowe crafttweaker.api.event.entity.player.MCUseHoeEvent(handler jako funkcja.Consumer<crafttweaker.api.event.entity.player.MCUseHoeEvent>);
```
| Parametr | Typ                                                                                                                      | Opis             |
| -------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.MCUseHoeEvent](/vanilla/api/event/entity/player/MCUseHoeEvent)> | Nie podano opisu |
...
```zenscript
myMCUseHoeEvent.setCanceled(Anuluj jako boolean);
```
