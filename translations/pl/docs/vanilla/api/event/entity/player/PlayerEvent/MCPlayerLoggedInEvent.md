...
## Konstruktorzy
```zenscript
nowy crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInvent(handler jako function.Consumer<crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInEvent>);
```
| Parametr | Typ                                                                                                                                                              | Opis             |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.PlayerEvent.MCPlayerLoggedInEvent](/vanilla/api/event/entity/player/PlayerEvent/MCPlayerLoggedInEvent)> | Nie podano opisu |
...
```zenscript
myMCPlayerLoggedInEvent.setCanceled(anuluj jako boolean);
```
