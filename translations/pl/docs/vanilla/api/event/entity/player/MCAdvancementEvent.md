...
## Konstruktorzy
```zenscript
nowe crafttweaker.api.event.entity.player.MCAdvancementEvent(handler jako funkcja.Consumer<crafttweaker.api.event.entity.player.MCAdvancementEvent>);
```
| Parametr | Typ                                                                                                                                | Opis             |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.MCAdvancementEvent](/vanilla/api/event/entity/player/MCAdvancementEvent)> | Nie podano opisu |
...
```zenscript
myMCAdvancementEvent.setCanceled(anuluj jako boolean);
```
