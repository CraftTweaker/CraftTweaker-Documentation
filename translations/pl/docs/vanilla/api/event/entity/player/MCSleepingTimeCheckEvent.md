...
## Konstruktorzy
```zenscript
nowy crafttweaker.api.event.entity.player.MCSleepingTimeCheckEvent(handler jako function.Consumer<crafttweaker.api.event.entity.player.MCSleepingTimeCheckEvent>);
```
| Parametr | Typ                                                                                                                                            | Opis             |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| handler  | Funkcja Konsumenta<[crafttweaker.api.event.entity.player.MCSleepingTimeCheckEvent](/vanilla/api/event/entity/player/MCSleepingTimeCheckEvent)> | Nie podano opisu |
...
```zenscript
myMCSleepingTimeCheckEvent.setCanceled(anuluj jako boolean);
```
