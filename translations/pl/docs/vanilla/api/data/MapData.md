...
| Parametr | Typ         | Opis                  |
| -------- | ----------- | --------------------- |
| key      | Ciąg znaków | The key to search for |
...
| Parametr | Typ                                                    | Opis                          |
| -------- | ------------------------------------------------------ | ----------------------------- |
| key      | Ciąg znaków                                            | The key to set the value for. |
| wartość  | [crafttweaker.api.data.IData](/vanilla/api/data/IData) | The value to set.             |
...
| Parametr | Typ         | Opis                           |
| -------- | ----------- | ------------------------------ |
| key      | Ciąg znaków | The key of the entry to remove |
...
| Parametr | Typ                                                    | Opis                    |
| -------- | ------------------------------------------------------ | ----------------------- |
| dane     | [crafttweaker.api.data.IData](/vanilla/api/data/IData) | No description provided |
