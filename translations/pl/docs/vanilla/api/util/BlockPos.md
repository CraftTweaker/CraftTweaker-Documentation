...
| Parametr | Typ    | Opis                    |
| -------- | ------ | ----------------------- |
| x        | odcień | No description provided |
| y        | odcień | No description provided |
| z        | odcień | No description provided |
...
| Parametr | Typ      | Opis           |
| -------- | -------- | -------------- |
| x        | podwójne | x value to add |
| y        | podwójne | y value to add |
| z        | podwójne | z value to add |
...
| Parametr | Typ                                                          | Opis                      |
| -------- | ------------------------------------------------------------ | ------------------------- |
| do       | [crafttweaker.api.util.BlockPos](/vanilla/api/util/BlockPos) | BlockPos to check against |
...
| Parametr  | Typ      | Opis                                                                  |
| --------- | -------- | --------------------------------------------------------------------- |
| x         | podwójne | x position to check against                                           |
| y         | podwójne | y position to check against                                           |
| z         | podwójne | z position to check against                                           |
| useCenter | boolean  | should the center of the coordinate be used? (adds 0.5 to each value) |
...
| Parametr | Typ    | Opis                    |
| -------- | ------ | ----------------------- |
| n        | odcień | No description provided |
...
| distance | podwójne                                                     | distance to check within                       |
