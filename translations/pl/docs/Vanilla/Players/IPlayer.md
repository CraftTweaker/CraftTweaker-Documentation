...
| ------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------ | ---------------------- |
| id            | returns the player's id                                                                    | ciąg znaków                                | `player.id`            |
| Nazwa         | returns the player's name                                                                  | ciąg znaków                                | `player.name`          |
| dane          | returns the player's data                                                                  | [IData](/Vanilla/Data/IData/)              | `player.data`          |
| xp            | returns the player's experience level. Can also be used to set a player's experience level | odcień                                     | `player.xp`            |
| hotbarSize    | returns the player's hotbar size                                                           | odcień                                     | `player.hotbarSize`    |
| inventorySize | returns the player's inventory size                                                        | odcień                                     | `player.inventorySize` |
...
| x             | returns the player's current X position in the world                                       | podwójne                                   | `player.x`             |
| y             | returns the player's current y position in the world                                       | podwójne                                   | `player.y`             |
| z             | returns the player's current z position in the world                                       | podwójne                                   | `player.z`             |
| pozycja       | returns the player's current position. Can also be used to set a player's position         | [Position3f](/Vanilla/Utils/Position3f/)   | `player.position`      |
...
| Metoda ZenMethod         | Parameter Type(s)                        | Co to robi                                                          | Przykład                                    |
| ------------------------ | ---------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------- |
| removeXP(XPtoRemove)     | odcień                                   | Removes the given experience levels from the player.                | `player.removeXP(1)`                        |
...
| getHotbarStack(index)    | odcień                                   | Returns the item at the given index within the player's hotbar.     | `player.getHotbarStack(3)`                  |
| getInventoryStack(index) | odcień                                   | Returns the item at the given index within the player's inventory.  | `player.getInventoryStack(3)`               |
...
| executeCommand(raw)      | ciąg znaków                              | Executes the command as the player                                  | `player.executeCommand("kill")`             |