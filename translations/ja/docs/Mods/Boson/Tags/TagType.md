...
| プロパティ名              | タイプ                                                                    | 説明                                                                        |
| ------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `directoryName`     | `文字列`                                                                  | Name of the directory where tag JSONs are in a data-pack                  |
| `名前`                | `文字列`                                                                  | Mnemonic that identifies the given tag type; used in tag bracket handlers |
| `classType`         | [`クラス`](/Mods/Boson/Reflection/Class/)                                 | Type of objects stored in the tag                                         |
