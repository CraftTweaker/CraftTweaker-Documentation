...
| --------- | ---------------------------------- | ------------------------------------------ | ----------------- |
| id        | Returns the mod's id               | 文字列                                        | `mod.id`          |
| 名前        | Returns the mod's internal name    | 文字列                                        | `mod.name`        |
| バージョン     | Returns the mod's version          | 文字列                                        | `mod.version`     |
| 説明        | Returns the mod description        | 文字列                                        | `mod.description` |
