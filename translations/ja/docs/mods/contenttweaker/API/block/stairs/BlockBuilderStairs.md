...
戻り値の型: [mods.contenttweaker.block.stores.BlockBuilder階段](/mods/contenttweaker/API/block/stairs/BlockBuilderStairs)
...
```zenscript
new BlockBuilder().withType<BlockBuilderStairs>().withBottomTexture(bottomTexture)Function<crafttweaker.api.util.MCResourceLocation, crafttweaker.api.util.MCResourceLocation>);
new BlockBuilder().withType<BlockBuilderStairs>().withBottomTexture((MCResourceLocationとしてblockName ) => new MCResourceLocation(blockName.namespace, blockName.path + "_bottom"));
```

| パラメータ    | タイプ                                                                                                                                                                                               | 説明     |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| ボトムテクスチャ | 関数を使用します。関数&lt;[crafttweaker.api.util.MCResourceLocation](/vanilla/api/util/MCResourceLocation), [crafttweaker.api.util.MCResourceLocation](/vanilla/api/util/MCResourceLocation)&gt; | 使用する関数 |
...
```zenscript
new BlockBuilder().withType<BlockBuilderStairs>().withSidesTexture(side as function.Function<crafttweaker.api.util.MCResourceLocation, crafttweaker.api.util.MCResourceLocation>);
new BlockBuilder().withType<BlockBuilderStairs>().withSidesTexture((MCResourceLocationとしてblockName ) => new MCResourceLocation(blockName.namespace, blockName.path + "_sides"));
```
...
| パラメータ    | タイプ                                                                                                                                                                                               | 説明     |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| トップテクスチャ | 関数を使用します。関数&lt;[crafttweaker.api.util.MCResourceLocation](/vanilla/api/util/MCResourceLocation), [crafttweaker.api.util.MCResourceLocation](/vanilla/api/util/MCResourceLocation)&gt; | 使用する関数 |
