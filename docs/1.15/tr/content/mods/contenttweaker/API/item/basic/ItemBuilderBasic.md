...
Eşyalar için oluşturulan basit bir builder. Ayrıca bu builder [mods.contenttweaker.item.basic.ItemBuilderBasic#build](/mods/contenttweaker/API/item/basic/ItemBuilderBasic/#build) olarak da geçer. Does not have any special properties, it exists.
