...
Der Basis-Builder für Items, auch von [mods.contenttweaker.item.basic.ItemBuilderBasic#build](/mods/contenttweaker/API/item/basic/ItemBuilderBasic/#build) genannt. Does not have any special properties, it exists.
