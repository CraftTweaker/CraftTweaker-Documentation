...
Denotes a special builder that is used for building special block types. Utilisé dans [mods.contenttweaker.block.BlockTypeBuilder#withType](/mods/contenttweaker/API/block/BlockTypeBuilder/#withtype)
