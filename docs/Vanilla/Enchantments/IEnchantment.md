...
An IEnchantment essentially is an [IEnchantmentDefinition](IEnchantmentDefinition) and an enchantment level.  
...
|-------------|-------------|--------------------------------------------------|
| definition  |             | [IEnchantmentDefinition](IEnchantmentDefinition) |
| level       |             | int                                              |
