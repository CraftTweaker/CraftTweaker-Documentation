...
Denotes a special builder that is used for builing special item types. Utilisé dans [mods.contenttweaker.item.ItemTypeBuilder#withType](/mods/contenttweaker/API/item/ItemTypeBuilder/#withtype)
