...
Denotes a special builder that is used for builing special item types. Utilizado en [mods.contenttweaker.item.ItemTypeBuilder#withType](/mods/contenttweaker/API/item/ItemTypeBuilder/#withtype)
