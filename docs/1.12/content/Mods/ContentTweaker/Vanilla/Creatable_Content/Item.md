...
| itemInteractionForEntity    | [IItemInteractionForEntity](/Mods/ContentTweaker/Vanilla/Advanced_Functionality/Functions/IItemInteractionForEntity/) | No       | null          | Called when the player right clicks on an entity with the item (NOTE: not available until version after 4.10.0 is released) |
