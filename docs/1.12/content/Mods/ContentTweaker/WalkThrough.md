...
The other part for this will be the language file. ContentTweaker will have already generated the en_us.lang file for you.
Then, you will need to add a line that will look like `tile.contenttweaker.<block_name>.name=Block name`, or in our case,
`tile.contenttweaker.anti_ice.name=Anti Ice`. With both lang and texture filed in, you should be able to load up the 
game and see your block will have a model, a texture, and a name.
