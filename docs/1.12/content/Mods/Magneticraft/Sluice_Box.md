...
//mods.magneticraft.SluiceBox.addRecipe(IItemStack input, float output1Probability, IItemStack output1, float output2Probability, IItemStack output2, float output3Probability, IItemStack output3);
