...
This function removes the first recipe it finds with the given [IItemStack](/Vanilla/Variable_Types/IItemStack) `output` array:

```
mods.pneumaticcraft.pressurechamber.removeRecipe(IItemStack[] output);
// Example
