...
```zenscript
addStringMeshRecipe(IIngredient, IItemStack, Float);
...
```zenscript
addFlintMeshRecipe(IIngredient, IItemStack, Float);
...
```zenscript
addIronMeshRecipe(IIngredient, IItemStack, Float);
...
```zenscript
addDiamondMeshRecipe(IIngredient, IItemStack, Float);
