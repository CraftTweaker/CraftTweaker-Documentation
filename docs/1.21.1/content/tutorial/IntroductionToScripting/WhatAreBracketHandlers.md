...
```zenscript
<tag:item:minecraft:white_wool> // References the White Wool Item Tag.
<tag:block:minecraft:white_wool> // References the White Wool Block Tag.
<tag:fluid:minecraft:water> // References the Water Fluid Tag.
```
