...
- While all variables should be accessible from every script, even if the script that declares the variables hasn't been executed yet, you should try to declare your variables as soon as possible. You can use the [Priority Preprocessor](/AdvancedFunctions/Preprocessors/PriorityPreprocessor) to make sure these scripts are executed first.
