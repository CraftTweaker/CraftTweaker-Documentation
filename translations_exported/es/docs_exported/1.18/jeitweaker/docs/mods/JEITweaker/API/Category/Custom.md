...
| texto     | [Component](/vanilla/api/text/Component) | The text that should appear.                   |
...
| texto     | [Component](/vanilla/api/text/Component)[] | A list of [Component](/vanilla/api/text/Component)s indicating the text that should be present in the tooltip. |
