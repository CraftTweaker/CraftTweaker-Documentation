...
| Parameter | Type                                            |
| --------- | ----------------------------------------------- |
| fuente    | [DamageSource](/vanilla/api/world/DamageSource) |
...
| mainHandItem                   | [Pila de objetos](/vanilla/api/item/ItemStack)                                                                       | true       | false      |
| maxHealth                      | float                                                                                                                | true       | false      |
| mobType                        | [MobType](/vanilla/api/entity/MobType)                                                                               | true       | false      |
| noActionTime                   | int                                                                                                                  | true       | false      |
| offHandItem                    | [Pila de objetos](/vanilla/api/item/ItemStack)                                                                       | true       | false      |
...
| useItem                        | [Pila de objetos](/vanilla/api/item/ItemStack)                                                                       | true       | false      |
