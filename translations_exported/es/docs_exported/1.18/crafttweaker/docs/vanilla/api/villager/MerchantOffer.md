...
| --------------- | ---------------------------------------------- | ----------------------- |
| baseCostA       | [Pila de objetos](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Pila de objetos](/vanilla/api/item/ItemStack) | No description provided |
...
| --------------- | ---------------------------------------------- | ----------------------- |
| baseCostA       | [Pila de objetos](/vanilla/api/item/ItemStack) | No description provided |
| costB           | [Pila de objetos](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Pila de objetos](/vanilla/api/item/ItemStack) | No description provided |
| maxUses         | int                                            | No description provided |
| xp              | int                                            | No description provided |
| priceMultiplier | float                                          | No description provided |
