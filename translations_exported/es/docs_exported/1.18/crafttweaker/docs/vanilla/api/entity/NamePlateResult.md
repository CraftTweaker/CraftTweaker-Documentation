...
| --------- | ---------------------------------------- | --------------------------- |
| contenido | [Component](/vanilla/api/text/Component) | The new nameplate contents. |
...
| --------------- | ---------------------------------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------ |
| contenido       | [Component](/vanilla/api/text/Component) | true       | true       | Gets the current content of the nameplate. <br />  This can be changed by mods.      |
