...
| pila de objetos | [Pila de objetos](/vanilla/api/item/ItemStack)                          | true       | false      | Gets the ItemStack that the tooltip is for.                                                           |
...
| descripción     | stdlib.List&lt;[Component](/vanilla/api/text/Component)&gt; | true       | false      | Gets the list of [Component](/vanilla/api/text/Component)s that make up the tooltip.                  |
