...
| fuente    | [SoundSource](/vanilla/api/sound/SoundSource) |
| volume    | float                                         |
| pitch     | float                                         |
...
| Parameter | Type                                     |
| --------- | ---------------------------------------- |
| texto     | [Component](/vanilla/api/text/Component) |
...
| inventory                      | [Inventario](/vanilla/api/entity/type/player/Inventory) | true       | false      |
