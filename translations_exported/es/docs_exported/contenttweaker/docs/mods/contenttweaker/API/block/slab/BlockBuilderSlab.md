...
| Parameter     | Type                                                         | Description                           |
| ------------- | ------------------------------------------------------------ | ------------------------------------- |
| bottomTexture | [Ubicación MCResource](/vanilla/api/util/MCResourceLocation) | The texture to be used for the sides. |
...
| Parameter  | Type                                                         | Description                           |
| ---------- | ------------------------------------------------------------ | ------------------------------------- |
| topTexture | [Ubicación MCResource](/vanilla/api/util/MCResourceLocation) | The texture to be used for the sides. |
