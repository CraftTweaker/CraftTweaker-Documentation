...
| fluid         | [MCFluido](/vanilla/api/fluid/MCFluid)                       | true       | false      | Retrieves this fluid stack's fluid.                              |
...
| registryName  | [Ubicación MCResource](/vanilla/api/util/MCResourceLocation) | true       | false      | Gets the registry name for the fluid this stack is representing. |
