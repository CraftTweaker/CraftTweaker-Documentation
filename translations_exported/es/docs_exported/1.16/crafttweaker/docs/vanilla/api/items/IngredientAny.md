...
```zenscript
IngredientAny.onlyDamagedAtLeast(minDamage as int) as MCIngredientConditioned<IIngredient>
```
...
```zenscript
IngredientAny.onlyDamagedAtMost(maxDamage as int) as MCIngredientConditioned<IIngredient>
```
