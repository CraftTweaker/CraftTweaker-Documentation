...
MCIngredientConditioned implementa las siguientes interfaces. That means all methods defined in these interfaces are also available in MCIngredientConditioned
