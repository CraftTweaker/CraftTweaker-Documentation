...
[PLACEHOLDER] ItemStack with a przypadek, zwykle used for recipe outputs.

 Ostrożnie, jeśli stos użyty do utworzenia Wagi Stack był zmienny, to ustawnik rozmiaru zmusza również oryginalny stos!
