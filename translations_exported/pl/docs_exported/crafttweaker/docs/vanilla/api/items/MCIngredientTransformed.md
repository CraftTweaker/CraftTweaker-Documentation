...
```zenscript
crafttweaker.api.item.MCIngredientTransformowane
```

## Zaimplementowane interfejsy
MCIngredientTransformowane implementuje następujące interfejsy. Oznacza to, że każda dostępna dla nich metoda może być również stosowana w tej klasie.
...
```zenscript
myMCIngredientTransformed.matches(stack jako crafttweaker.api.item.IItemStack, zignoruj obrażenia jako boolean);
```

| Parametr              | Typ                                                               | Opis             |
| --------------------- | ----------------------------------------------------------------- | ---------------- |
| stos                  | [crafttweaker.api.item.IItemStack](/vanilla/api/items/IItemStack) | Nie podano opisu |
| zignorowano obrażenia | boolean                                                           | Nie podano opisu |
...
| --------------- | -------------------------------------------------------------------------------------------------------------- | -------------- | ------------- |
| bazowy Składnik | T                                                                                                              | prawda         | fałszywy      |
...
| transformator   | [crafttweaker.api.item.IIngredientTransformer](/vanilla/api/items/IIngredientTransformer)&lt;T&gt; | prawda         | fałszywy      |
