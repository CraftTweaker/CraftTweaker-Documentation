...
MCIngredientTransformowane implementuje następujące interfejsy. That means all methods defined in these interfaces are also available in MCIngredientTransformed
