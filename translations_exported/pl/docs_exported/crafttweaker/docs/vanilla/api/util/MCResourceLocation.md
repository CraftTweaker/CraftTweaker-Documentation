...
MCResourceLocation implementuje następujące interfejsy. That means all methods defined in these interfaces are also available in MCResourceLocation
...
| --------------- | ------ | -------------------------------------------------------------------- |
| przestrzeń nazw | string | Usually a ModId                                                      |
