...
| wyjście         | [crafttweaker.api.item.IItemStack](/vanilla/api/items/IItemStack) | output [crafttweaker.api.item.IItemStack](/vanilla/api/items/IItemStack)    |
| input           | [crafttweaker.api.item.Składnik](/vanilla/api/items/IIngredient)  | wejścia [crafttweaker.api.item.IIngredient](/vanilla/api/items/IIngredient) |
