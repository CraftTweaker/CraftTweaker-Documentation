...
| --------- | ---------------------------------------------------------- | --------------------------- |
| contents  | [Komponent MCText](/vanilla/api/util/text/MCTextComponent) | The new nameplate contents. |
...
| --------------- | ---------------------------------------------------------------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------ |
| zawartość       | [RenderNameplateEvent](/vanilla/api/event/client/RenderNameplateEvent) | true       | true       | Sets the new content of the nameplate.                                                     |
