...
| Parameter | Type                             |
| --------- | -------------------------------- |
| styl      | [Style](/vanilla/api/text/Style) |
...
| Parameter    | Type                                                |
| ------------ | --------------------------------------------------- |
| formatowanie | [ChatFormatting](/vanilla/api/text/ChatFormatting)? |
