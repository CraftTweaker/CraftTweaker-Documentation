...
| Parameter       | Type                                            |
| --------------- | ----------------------------------------------- |
| baseCostA       | [Stos przedmiotów](/vanilla/api/item/ItemStack) |
| result          | [Stos przedmiotów](/vanilla/api/item/ItemStack) |
| maxUses         | int                                             |
| xp              | int                                             |
...
| --------------- | ----------------------------------------------- |
| baseCostA       | [Stos przedmiotów](/vanilla/api/item/ItemStack) |
| costB           | [Stos przedmiotów](/vanilla/api/item/ItemStack) |
| result          | [Stos przedmiotów](/vanilla/api/item/ItemStack) |
| maxUses         | int                                             |
| xp              | int                                             |
| priceMultiplier | float                                           |
...
| Parameter | Type                                       |
| --------- | ------------------------------------------ |
| ob z      | [IItemStack](/vanilla/api/item/IItemStack) |
