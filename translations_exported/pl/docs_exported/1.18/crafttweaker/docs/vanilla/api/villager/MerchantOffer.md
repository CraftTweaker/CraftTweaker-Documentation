...
| --------------- | ----------------------------------------------- | ----------------------- |
| baseCostA       | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No description provided |
...
| --------------- | ----------------------------------------------- | ----------------------- |
| baseCostA       | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No description provided |
| costB           | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No description provided |
| maxUses         | int                                             | No description provided |
| xp              | int                                             | No description provided |
| priceMultiplier | float                                           | No description provided |
...
| Parameter | Type                                       | Description             |
| --------- | ------------------------------------------ | ----------------------- |
| ob z      | [IItemStack](/vanilla/api/item/IItemStack) | No Description Provided |
