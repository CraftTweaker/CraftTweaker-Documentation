...
| Parameter | Type                                            | Description             |
| --------- | ----------------------------------------------- | ----------------------- |
| stack     | [Stos przedmiotów](/vanilla/api/item/ItemStack) | No Description Provided |
...
| Parameter | Type                                            | Description             |
| --------- | ----------------------------------------------- | ----------------------- |
| źródło    | [DamageSource](/vanilla/api/world/DamageSource) | No Description Provided |
...
| mainHandItem                   | [Stos przedmiotów](/vanilla/api/item/ItemStack)                                                                      | true       | false      | No Description Provided |
...
| offHandItem                    | [Stos przedmiotów](/vanilla/api/item/ItemStack)                                                                      | true       | false      | No Description Provided |
...
| useItem                        | [Stos przedmiotów](/vanilla/api/item/ItemStack)                                                                      | true       | false      | No Description Provided |
