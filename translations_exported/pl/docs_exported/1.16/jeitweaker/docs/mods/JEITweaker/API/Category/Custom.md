...
| tekst     | [Komponent MCText](/vanilla/api/util/text/MCTextComponent) | The text that should appear.                   |
...
| tekst     | [MCTextComponent](/vanilla/api/util/text/MCTextComponent)[] | A list of [MCTextComponent](/vanilla/api/util/text/MCTextComponent)s indicating the text that should be present in the tooltip. |
