...
| name      | [Komponent MCText](/vanilla/api/util/text/MCTextComponent)      | A [MCTextComponent](/vanilla/api/util/text/MCTextComponent) representing the name of the category.                                    |
...
| name       | [Komponent MCText](/vanilla/api/util/text/MCTextComponent)      | true       | false      | Gets the name of the category.                                                                                                 |
