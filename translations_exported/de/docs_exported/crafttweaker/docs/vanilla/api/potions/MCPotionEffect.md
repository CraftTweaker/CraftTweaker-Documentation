...
Rückgabetyp: [crafttweaker.api.potion.MCPotionEffectInstanz](/vanilla/api/potions/MCPotionEffectInstance)
...
| kurativeItems  | Liste&lt;[craftweaker.api.item.IItemStack](/vanilla/api/items/IItemStack)&gt; | true       | false      |
