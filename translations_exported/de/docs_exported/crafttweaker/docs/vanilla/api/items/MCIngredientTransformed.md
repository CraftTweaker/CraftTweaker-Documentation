...
MCIngredientTransformed implementiert die folgenden Schnittstellen. That means all methods defined in these interfaces are also available in MCIngredientTransformed
