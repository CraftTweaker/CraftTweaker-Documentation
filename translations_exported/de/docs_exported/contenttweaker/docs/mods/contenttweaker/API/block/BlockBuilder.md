...
Instructs CoT that this block will does not block movement. Setzt den Block auch als [mods.contenttweaker.block.BlockBuilder#notSolid()](/mods/contenttweaker/API/block/BlockBuilder/#notsolid)
