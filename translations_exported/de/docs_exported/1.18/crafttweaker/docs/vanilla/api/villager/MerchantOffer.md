...
| --------------- | -------------------------------------------- | ----------------------- |
| baseCostA       | [Artikel-Stack](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Artikel-Stack](/vanilla/api/item/ItemStack) | No description provided |
...
| --------------- | -------------------------------------------- | ----------------------- |
| baseCostA       | [Artikel-Stack](/vanilla/api/item/ItemStack) | No description provided |
| costB           | [Artikel-Stack](/vanilla/api/item/ItemStack) | No description provided |
| result          | [Artikel-Stack](/vanilla/api/item/ItemStack) | No description provided |
| maxUses         | int                                          | No description provided |
| xp              | int                                          | No description provided |
| priceMultiplier | float                                        | No description provided |
