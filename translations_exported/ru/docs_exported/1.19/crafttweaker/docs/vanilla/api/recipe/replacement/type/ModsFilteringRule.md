...
Filters recipes that have been created by the given set of mods.
 ...
 Every mod is identified according to its mod id. Recipes have been created by a mod if their name as determined by [Recipe](/vanilla/api/recipe/type/Recipe)&lt;C&gt;#getId() has that mod id as the namespace.
...
| Параметр | Тип                           | Описание               |
| -------- | ----------------------------- | ---------------------- |
| моды     | [Mod](/vanilla/api/mod/Mod)[] | The mods to check for. |
