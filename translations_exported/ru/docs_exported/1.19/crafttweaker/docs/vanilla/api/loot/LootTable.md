...
| контекст  | [LootContext](/vanilla/api/loot/LootContext) | The context that will generate the loot. |
...
| Параметр | Тип                                          | Описание                                  |
| -------- | -------------------------------------------- | ----------------------------------------- |
| контекст | [LootContext](/vanilla/api/loot/LootContext) | The context that this loot was generated. |
