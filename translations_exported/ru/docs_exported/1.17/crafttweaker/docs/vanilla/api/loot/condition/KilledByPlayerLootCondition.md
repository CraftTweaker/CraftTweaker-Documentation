...
KilledByPlayerLootCondition implements the following interfaces. That means all methods defined in these interfaces are also available in KilledByPlayerLootCondition
...
```zenscript
// KilledByPlayerLootCondition.create() as LootConditionBuilder
