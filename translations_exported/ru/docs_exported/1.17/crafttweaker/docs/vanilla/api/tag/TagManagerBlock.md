...
- [ITagManager](/vanilla/api/tag/ITagManager)&lt;[Block](/vanilla/api/block/Block)&gt;
...
```zenscript
TagManagerBlock.exists(location as ResourceLocation) as boolean
```

| Параметр       | Тип                                                        | Описание                           |
| -------------- | ---------------------------------------------------------- | ---------------------------------- |
| местоположение | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | The resource location to check for |
...
```zenscript
TagManagerBlock.getTag(location as ResourceLocation) as MCTag<T>
```

| Параметр       | Тип                                                        | Описание                         |
| -------------- | ---------------------------------------------------------- | -------------------------------- |
| местоположение | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | The Resource location of the tag |
