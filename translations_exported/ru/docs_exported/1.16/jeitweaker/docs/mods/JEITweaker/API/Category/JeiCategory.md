...
| name      | [Компонент MCTextcomponent](/vanilla/api/util/text/MCTextComponent) | A [MCTextComponent](/vanilla/api/util/text/MCTextComponent) representing the name of the category.                                    |
...
| id         | [Расположение MCResource-ресурсов](/vanilla/api/util/MCResourceLocation) | true         | false        | Gets the ID of the category.                                                                                                   |
| name       | [Компонент MCTextcomponent](/vanilla/api/util/text/MCTextComponent)      | true         | false        | Gets the name of the category.                                                                                                 |
