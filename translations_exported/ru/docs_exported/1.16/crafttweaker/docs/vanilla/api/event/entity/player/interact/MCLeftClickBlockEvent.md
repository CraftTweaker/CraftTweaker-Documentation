...
This event is fired when a player left clicks while targeting a block. This event controls which of [MCBlock](/vanilla/api/block/MCBlock)#onBlockClicked and/or the item harvesting methods will be called.
