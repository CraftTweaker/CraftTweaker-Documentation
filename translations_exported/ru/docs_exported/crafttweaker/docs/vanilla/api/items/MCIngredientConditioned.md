...
MCIngredientConditioned реализует следующие интерфейсы. That means all methods defined in these interfaces are also available in MCIngredientConditioned
