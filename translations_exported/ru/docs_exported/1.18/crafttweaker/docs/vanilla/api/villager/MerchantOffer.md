...
| --------------- | ---------------------------------------- | -------------------- |
| baseCostA       | [ItemStack](/vanilla/api/item/ItemStack) | Описание отсутствует |
| result          | [ItemStack](/vanilla/api/item/ItemStack) | Описание отсутствует |
| maxUses         | int                                      | Описание отсутствует |
| xp              | int                                      | Описание отсутствует |
| priceMultiplier | float                                    | Описание отсутствует |
...
| --------------- | ---------------------------------------- | -------------------- |
| baseCostA       | [ItemStack](/vanilla/api/item/ItemStack) | Описание отсутствует |
| costB           | [ItemStack](/vanilla/api/item/ItemStack) | Описание отсутствует |
| result          | [ItemStack](/vanilla/api/item/ItemStack) | Описание отсутствует |
| maxUses         | int                                      | Описание отсутствует |
| xp              | int                                      | Описание отсутствует |
| priceMultiplier | float                                    | Описание отсутствует |
...
| xp              | int                                      | Описание отсутствует |
| priceMultiplier | float                                    | Описание отсутствует |
| demand          | int                                      | Описание отсутствует |
...
| Параметр | Тип                                        | Описание                |
| -------- | ------------------------------------------ | ----------------------- |
| а        | [IItemStack](/vanilla/api/item/IItemStack) | No Description Provided |
| т        | [IItemStack](/vanilla/api/item/IItemStack) | No Description Provided |
