...
```zenscript
MCEquipmentSlotType.MAINHAND
MCEquipmentSlotType.OFFHAND
MCEquipmentSlotType.FEET
MCEquipmentSlotType.LEGS
MCEquipmentSlotType.CHEST
MCEquipmentSlotType.HEAD
```
## Methods
