...
Instructs CoT that this block will does not block movement. Will also set the block as [mods.contenttweaker.block.BlockBuilder#notSolid()](/mods/contenttweaker/API/block/BlockBuilder/#notsolid)
