...
| 参数   | 类型 | 描述                      |
| ---- | -- | ----------------------- |
| 持续时间 | 整数 | No description provided |
| 放大器  | 整数 | No description provided |


### newInstance

返回类型： [craftminstruer.api.potion.MCPotionEffect实例](/vanilla/api/potions/MCPotionEffectInstance)
...
| 治疗项目                 | 列表&lt;[craftmiliter.api.IItemStack](/vanilla/api/items/IItemStack)&gt; | true | false |
