...
| x          | 双精度                                                                       | No Description Provided | false |              |
| y          | 双精度                                                                       | No Description Provided | false |              |
| z          | 双精度                                                                       | No Description Provided | false |              |
| size #大小   | 浮点数                                                                       | No Description Provided | false |              |
| causesFire | 布尔值                                                                       | No Description Provided | false |              |
...
| 来源         | [DamageSource](/vanilla/api/world/DamageSource)                           | No Description Provided | true  |              |
...
| 参数             | 类型  | 描述                           |
| -------------- | --- | ---------------------------- |
| spawnParticles | 布尔值 | Should particles be spawned. |
