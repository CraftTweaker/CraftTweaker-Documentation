...
| attackable #可攻击的               | 布尔值                                                                                                                  | true | false |
| bedOrientation                 | [Direction](/vanilla/api/util/direction/Direction)?                                                                  | true | false |
| canBeSeenAsEnemy               | 布尔值                                                                                                                  | true | false |
| canBeSeenByAnyone              | 布尔值                                                                                                                  | true | false |
| canBreatheUnderwater #可以水下呼吸   | 布尔值                                                                                                                  | true | false |
| fallFlyingTicks                | int                                                                                                                  | true | false |
| health                         | float                                                                                                                | true | false |
| isAffectedByPotions            | 布尔值                                                                                                                  | true | false |
| isAutoSpinAttack               | 布尔值                                                                                                                  | true | false |
| isBaby                         | 布尔值                                                                                                                  | true | false |
| isBlocking                     | 布尔值                                                                                                                  | true | false |
| isCurrentlyGlowing             | 布尔值                                                                                                                  | true | false |
| isDeadOrDying                  | 布尔值                                                                                                                  | true | false |
| isFallFlying                   | 布尔值                                                                                                                  | true | false |
| isInvertedHealAndHarm          | 布尔值                                                                                                                  | true | false |
| isSensitiveToWater             | 布尔值                                                                                                                  | true | false |
| isSleeping                     | 布尔值                                                                                                                  | true | false |
| isSuppressingSlidingDownLadder | 布尔值                                                                                                                  | true | false |
| isUsingItem                    | 布尔值                                                                                                                  | true | false |
...
| useItem                        | [物品应用](/vanilla/api/item/ItemStack)                                                                                  | true | false |
