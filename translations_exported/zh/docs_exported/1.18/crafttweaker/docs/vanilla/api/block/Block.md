...
| 参数       | 类型  | 描述                              |
| -------- | --- | ------------------------------- |
| friction | 浮点数 | The new friction of this Block. |
...
| explosionResistance  | 浮点数                                                                        | true  | true  | Gets the blast resistance of this Block.                                                                                     |
| friction             | 浮点数                                                                        | true  | true  | Gets the friction of this Block.                                                                                             |
