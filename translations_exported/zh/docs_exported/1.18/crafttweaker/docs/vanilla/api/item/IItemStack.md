...
| 参数         | 类型  | 描述                      |
| ---------- | --- | ----------------------- |
| percentage | 双精度 | No Description Provided |
...
| 参数 | 类型                                       | 描述                     |
| -- | ---------------------------------------- | ---------------------- |
| 文本 | [Component](/vanilla/api/text/Component) | New name of the stack. |
...
| getOrCreate          | [MapData #地图数据](/vanilla/api/data/MapData)                     | true | false | Returns the NBT tag attached to this ItemStack or makes a new tag.                                                                                                |
...
| isMutable            | 布尔值                                                            | true | false | No Description Provided                                                                                                                                           |
...
| tag #标签              | [MapData #地图数据](/vanilla/api/data/MapData)                     | true | false | Returns the NBT tag attached to this ItemStack.                                                                                                                   |
