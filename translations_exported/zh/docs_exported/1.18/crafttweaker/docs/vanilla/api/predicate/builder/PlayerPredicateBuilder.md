...
| --------- | ---------------------------------------------- | ----------------------- | ----- | ------------ |
| name（名称）  | [资源位置](/vanilla/api/resource/ResourceLocation) | No Description Provided | false |              |
| completed | 布尔值                                            | No Description Provided | true  | true         |
...
| 参数        | 类型     | 描述                      | 可选    | DefaultValue |
| --------- | ------ | ----------------------- | ----- | ------------ |
| name（名称）  | string | No Description Provided | false |              |
| completed | 布尔值    | No Description Provided | true  | true         |
...
| 参数       | 类型                                             | 描述                      |
| -------- | ---------------------------------------------- | ----------------------- |
| name（名称） | [资源位置](/vanilla/api/resource/ResourceLocation) | No Description Provided |
...
| 参数 | 类型                                      | 描述                      |
| -- | --------------------------------------- | ----------------------- |
| 类型 | [GameType](/vanilla/api/world/GameType) | No Description Provided |
...
| -------- | ---------------------------------------------- | ----------------------- | ----- | ------------ |
| name（名称） | [资源位置](/vanilla/api/resource/ResourceLocation) | No Description Provided | false |              |
| unlocked | 布尔值                                            | No Description Provided | true  | true         |
...
| 参数       | 类型                                                                          | 描述                      |
| -------- | --------------------------------------------------------------------------- | ----------------------- |
| 类型       | [资源位置](/vanilla/api/resource/ResourceLocation)                              | No Description Provided |
| name（名称） | [资源位置](/vanilla/api/resource/ResourceLocation)                              | No Description Provided |
| 值        | [IntMinMaxBoundsPredicate](/vanilla/api/predicate/IntMinMaxBoundsPredicate) | No Description Provided |
...
| 参数       | 类型                                                                          | 描述                      |
| -------- | --------------------------------------------------------------------------- | ----------------------- |
| 类型       | string                                                                      | No Description Provided |
| name（名称） | [资源位置](/vanilla/api/resource/ResourceLocation)                              | No Description Provided |
| 值        | [IntMinMaxBoundsPredicate](/vanilla/api/predicate/IntMinMaxBoundsPredicate) | No Description Provided |
