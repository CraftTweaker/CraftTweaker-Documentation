...
| 参数 | 类型                                           | 描述                      |
| -- | -------------------------------------------- | ----------------------- |
| 类型 | [EntityType](/vanilla/api/entity/EntityType) | No Description Provided |
...
| 参数 | 类型                                                                                              | 描述                      |
| -- | ----------------------------------------------------------------------------------------------- | ----------------------- |
| 类型 | [MCTag](/vanilla/api/tag/MCTag)&lt;[EntityType](/vanilla/api/entity/EntityType)&gt; | No Description Provided |
