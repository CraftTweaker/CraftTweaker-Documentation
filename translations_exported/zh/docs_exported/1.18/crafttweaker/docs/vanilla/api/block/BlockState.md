...
| commandString #命令字符串 | string                                    | true | false | Gets the blockstate bracket handler syntax for this BlockState. <br />  <br />  E.G. <br />  `<blockstate:minecraft:grass:snowy=true>`                                   |
...
| isRandomlyTicking    | 布尔值                                       | true | false | Checks whether this BlockState ticks randomly.                                                                                                                                                   |
| isSignalSource       | 布尔值                                       | true | false | Checks whether this BlockState can provide Redstone Power                                                                                                                                        |
