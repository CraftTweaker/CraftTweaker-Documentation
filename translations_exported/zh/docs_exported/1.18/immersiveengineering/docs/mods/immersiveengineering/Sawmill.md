...
| input（输入）         | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The item input                                                     |
| energy            | int                                                    | The total energy required                                          |
| output（输出）        | [IItemstack](/vanilla/api/item/IItemStack)             | The item that is returned                                          |
...
| output（输出）                | [IItemstack](/vanilla/api/item/IItemStack)             | The output that is returned when a sawblade is present                                                        |
| outputSecondaries         | [IItemStack](/vanilla/api/item/IItemStack)[]           | The secondary outputs that are created alongside the `output` item                                            |
