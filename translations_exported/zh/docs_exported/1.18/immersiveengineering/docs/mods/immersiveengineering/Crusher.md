...
| input（输入）         | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient)                                                              | The input ingredient                           |
...
| 参数         | 类型                                                     | 描述                                         |
| ---------- | ------------------------------------------------------ | ------------------------------------------ |
| output（输出） | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The output whose recipes should be removed |
