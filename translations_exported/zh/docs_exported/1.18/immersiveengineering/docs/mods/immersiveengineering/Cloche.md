...
| seed        | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The seed that needs to be inserted in the Cloche's gui                 | false |           |
| soil        | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The soil that this seeds need to grow on                               | false |           |
...
| 参数         | 类型                                                     | 描述                      |
| ---------- | ------------------------------------------------------ | ----------------------- |
| output（输出） | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The output to match for |
