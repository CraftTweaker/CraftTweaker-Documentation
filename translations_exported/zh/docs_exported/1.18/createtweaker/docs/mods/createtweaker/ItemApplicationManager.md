...
| block #方块    | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient)                                                              | The block to be applied on         | false |              |
| heldItem     | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient)                                                              | The item that needs to be held     | false |              |
| keepHeldItem | 布尔值                                                                                                                 | Should the item be consumed or not | true  | false        |
