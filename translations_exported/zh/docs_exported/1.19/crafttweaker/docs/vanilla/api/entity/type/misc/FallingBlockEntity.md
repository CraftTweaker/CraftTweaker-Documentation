...
| 点     | [BlockPos](/vanilla/api/util/math/BlockPos) | The position to spawn the entity at. |
...
| 参数 | 类型                                          | 描述                                           |
| -- | ------------------------------------------- | -------------------------------------------- |
| 点  | [BlockPos](/vanilla/api/util/math/BlockPos) | the position that the entity was spawned at. |
