...
| isFlammable #是否为可燃物  | 布尔值                                                        | true | false |                                           |
| isLiquid #是否为液体      | 布尔值                                                        | true | false |                                           |
| isReplaceable #是否可替换 | 布尔值                                                        | true | false |                                           |
| isSolid #是否为固体       | 布尔值                                                        | true | false |                                           |
| isSolidBlocking      | 布尔值                                                        | true | false |                                           |
