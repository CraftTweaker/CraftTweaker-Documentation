...
| 参数   | 类型                                             |
| ---- | ---------------------------------------------- |
| stat | [资源位置](/vanilla/api/resource/ResourceLocation) |
...
| 参数   | 类型                                         | 可选    | 默认值 |
| ---- | ------------------------------------------ | ----- | --- |
| 堆叠   | [IItemstack](/vanilla/api/item/IItemStack) | false |     |
| slot | int                                        | true  | -1  |
...
| 来源     | [SoundSource](/vanilla/api/sound/SoundSource) |
| volume | float                                         |
| pitch  | float                                         |
...
| 参数 | 类型                                       |
| -- | ---------------------------------------- |
| 文本 | [Component](/vanilla/api/text/Component) |
...
| 参数         | 类型                                         |
| ---------- | ------------------------------------------ |
| entityData | [MapData #地图数据](/vanilla/api/data/MapData) |
...
| canUseGameMasterBlocks         | 布尔值                                                    | true | false |
...
| isHurt                         | 布尔值                                                    | true | false |
| isLocalPlayer                  | 布尔值                                                    | true | false |
| isReducedDebugInfo             | 布尔值                                                    | true | false |
| isScoping                      | 布尔值                                                    | true | false |
| isSecondaryUseActive           | 布尔值                                                    | true | false |
| isSleepingLongEnough           | 布尔值                                                    | true | false |
| luck                           | float                                                  | true | false |
| mainArm                        | [HumanoidArm](/vanilla/api/entity/HumanoidArm)         | true | false |
| mayBuild                       | 布尔值                                                    | true | false |
| score                          | int                                                    | true | false |
| shoulderEntityLeft             | [MapData #地图数据](/vanilla/api/data/MapData)             | true | false |
| shoulderEntityRight            | [MapData #地图数据](/vanilla/api/data/MapData)             | true | false |
