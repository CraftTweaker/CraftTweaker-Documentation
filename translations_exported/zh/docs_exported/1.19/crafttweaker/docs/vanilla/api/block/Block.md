...
| 名称                        | 类型                                                                         | 可获得  | 可设置   | 描述                                                                                                                                        |
| ------------------------- | -------------------------------------------------------------------------- | ---- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| commandString #命令字符串      | string                                                                     | true | false | Gets the block bracket handler syntax for this Block. <br />  <br />  E.G. <br />  `<block:minecraft:dirt>`       |
...
| hasCollision              | 布尔值                                                                        | true | true  | Checks if entities can collide with this Block.                                                                                           |
| isPossibleToRespawnInThis | 布尔值                                                                        | true | false | Checks if an entity can be spawned inside this Block. <br />  <br />  This is used to find valid spawn locations for players. |
...
| name（名称）                  | [MutableComponent](/vanilla/api/text/MutableComponent)                     | true | false | Gets the name of this Block                                                                                                               |
