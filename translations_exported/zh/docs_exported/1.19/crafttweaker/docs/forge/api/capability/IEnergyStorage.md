...
| simulate   | 布尔值 | If the energy should actually be extracted or not. |
...
| simulate   | 布尔值 | If the energy should actually be inserted or not. |
...
| 名称              | 类型  | 可获得  | 可设置   | 描述                                                   |
| --------------- | --- | ---- | ----- | ---------------------------------------------------- |
| canExtract      | 布尔值 | true | false | Checks if energy can be extracted from this storage. |
| canReceive      | 布尔值 | true | false | Checks if this storage can receive energy.           |
