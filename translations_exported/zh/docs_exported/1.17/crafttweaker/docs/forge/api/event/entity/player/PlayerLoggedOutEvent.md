...
The playerLoggedOut event does not add any new Properties. Since it is a [PlayerEvent](/forge/api/event/entity/player/PlayerEvent), you can already access the player getter
