...
| 参数         | 类型  | 描述                      |
| ---------- | --- | ----------------------- |
| absorption | 浮点数 | No Description Provided |
...
| 参数    | 类型  | 描述                      |
| ----- | --- | ----------------------- |
| speed | 浮点数 | No Description Provided |
...
| 名称                             | 类型                                                                                                                   | 可获得  | 可设置   | 描述                      |
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------- | ---- | ----- | ----------------------- |
| absorptionAmount               | 浮点数                                                                                                                  | true | false | No Description Provided |
...
| armorCoverPercentage           | 浮点数                                                                                                                  | true | false | No Description Provided |
...
| health                         | 浮点数                                                                                                                  | true | false | No Description Provided |
...
| jumpBoostPower                 | 双精度                                                                                                                  | true | false | No Description Provided |
...
| maxHealth                      | 浮点数                                                                                                                  | true | false | No Description Provided |
...
| speed                          | 浮点数                                                                                                                  | true | false | No Description Provided |
...
| voicePitch                     | 浮点数                                                                                                                  | true | false | No Description Provided |
