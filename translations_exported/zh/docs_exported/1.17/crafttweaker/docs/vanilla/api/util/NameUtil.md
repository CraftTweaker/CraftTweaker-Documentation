...
| 参数        | 类型     | 描述                                                                                                                 |
| --------- | ------ | ------------------------------------------------------------------------------------------------------------------ |
| input（输入） | string | The string that should be fixed to a [ResourceLocation](/vanilla/api/resource/ResourceLocation)-compatible format. |
...
| 参数        | 类型     | 描述                                                                                                             |
| --------- | ------ | -------------------------------------------------------------------------------------------------------------- |
| input（输入） | string | The string that should be fixed and converted to a [ResourceLocation](/vanilla/api/resource/ResourceLocation). |
...
| 参数       | 类型                                             | 描述                  |
| -------- | ---------------------------------------------- | ------------------- |
| name（名称） | [资源位置](/vanilla/api/resource/ResourceLocation) | The name to verify. |
