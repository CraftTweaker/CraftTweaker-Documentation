...
| 参数 | 类型  | 描述                      |
| -- | --- | ----------------------- |
| i  | 浮点数 | No Description Provided |
| j  | 浮点数 | No Description Provided |
| k  | 浮点数 | No Description Provided |
| r  | 浮点数 | No Description Provided |
...
| 名称         | 类型                                          | 可获得  | 可设置   | 描述                      |
| ---------- | ------------------------------------------- | ---- | ----- | ----------------------- |
| i          | 浮点数                                         | true | false | No Description Provided |
| j          | 浮点数                                         | true | false | No Description Provided |
| k          | 浮点数                                         | true | false | No Description Provided |
| r          | 浮点数                                         | true | false | No Description Provided |
