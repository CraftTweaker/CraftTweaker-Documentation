...
| 参数   | 类型  | 描述                      |
| ---- | --- | ----------------------- |
| minX | 双精度 | No Description Provided |
| minY | 双精度 | No Description Provided |
| minZ | 双精度 | No Description Provided |
| maxX | 双精度 | No Description Provided |
| maxY | 双精度 | No Description Provided |
| maxZ | 双精度 | No Description Provided |
...
| size #大小 | 双精度                                 | true | false | No Description Provided |
| xSize    | 双精度                                 | true | false | No Description Provided |
| ySize    | 双精度                                 | true | false | No Description Provided |
| zSize    | 双精度                                 | true | false | No Description Provided |
