...
| 参数 | 类型       | 描述                                                                                  |
| -- | -------- | ----------------------------------------------------------------------------------- |
| 模组 | string[] | The mods whose recipes should be targeted by the replacer. It must be at least one. |
...
| 参数         | 类型                                                             | 描述                                                                          |
| ---------- | -------------------------------------------------------------- | --------------------------------------------------------------------------- |
| output（输出） | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient)         | The output that should be matched.                                          |
...
| 参数      | 类型                                             | 描述                                                                                                               |
| ------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| oldName | [资源位置](/vanilla/api/resource/ResourceLocation) | The [ResourceLocation](/vanilla/api/resource/ResourceLocation) of the name of the recipe that should be renamed. |
...
| 参数   | 类型                                                     | 描述                                                                                                                |
| ---- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| from | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | An [IIngredient](/vanilla/api/ingredient/IIngredient) that will be used to match stacks that need to be replaced. |
| to   | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The replacement [IIngredient](/vanilla/api/ingredient/IIngredient).                                               |
...
| 参数   | 类型                                                     | 描述                                                                                                                     |
| ---- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| from | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | An [IIngredient](/vanilla/api/ingredient/IIngredient) that will be used to match to specify the ingredient to replace. |
| to   | [材料（IIngredient）](/vanilla/api/ingredient/IIngredient) | The replacement [IIngredient](/vanilla/api/ingredient/IIngredient).                                                    |
