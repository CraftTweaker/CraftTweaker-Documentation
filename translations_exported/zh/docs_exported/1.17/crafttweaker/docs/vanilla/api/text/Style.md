...
| 参数 | 类型          | 描述                      |
| -- | ----------- | ----------------------- |
| 值  | **invalid** | No Description Provided |
...
| 参数     | 类型                                             | 描述                      |
| ------ | ---------------------------------------------- | ----------------------- |
| fontId | [资源位置](/vanilla/api/resource/ResourceLocation) | No Description Provided |
...
| 参数 | 类型          | 描述                      |
| -- | ----------- | ----------------------- |
| 内容 | **invalid** | No Description Provided |
...
| 参数 | 类型    | 描述                      |
| -- | ----- | ----------------------- |
| 值  | bool? | No Description Provided |
...
| 名称            | 类型                                             | 可获得  | 可设置   | 描述                      |
| ------------- | ---------------------------------------------- | ---- | ----- | ----------------------- |
| bold          | 布尔值                                            | true | false | No Description Provided |
...
| font          | [资源位置](/vanilla/api/resource/ResourceLocation) | true | false | No Description Provided |
| 插入            | **invalid**                                    | true | false | No Description Provided |
| italic        | 布尔值                                            | true | false | No Description Provided |
| obfucated     | 布尔值                                            | true | false | No Description Provided |
| strikethrough | 布尔值                                            | true | false | No Description Provided |
| 下划线           | 布尔值                                            | true | false | No Description Provided |
