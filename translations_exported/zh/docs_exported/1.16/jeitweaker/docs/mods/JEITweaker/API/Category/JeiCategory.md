...
| name（名称）  | [MCText组件](/vanilla/api/util/text/MCTextComponent)              | A [MCTextComponent](/vanilla/api/util/text/MCTextComponent) representing the name of the category.                                    |
...
| name（名称）   | [MCText组件](/vanilla/api/util/text/MCTextComponent)              | true | false | Gets the name of the category.                                                                                                 |
