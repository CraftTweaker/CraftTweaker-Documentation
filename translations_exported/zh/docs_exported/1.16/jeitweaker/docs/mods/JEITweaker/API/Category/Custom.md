...
| isInput | 布尔值 | Whether the slot is an input (`true`) or an output (`false`) slot. |
...
| 文本 | [MCText组件](/vanilla/api/util/text/MCTextComponent) | The text that should appear.                   |
...
| 文本 | [MCTextComponent](/vanilla/api/util/text/MCTextComponent)[] | A list of [MCTextComponent](/vanilla/api/util/text/MCTextComponent)s indicating the text that should be present in the tooltip. |
