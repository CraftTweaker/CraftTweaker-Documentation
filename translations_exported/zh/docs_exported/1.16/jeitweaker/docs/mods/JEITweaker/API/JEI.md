...
| 参数          | 类型                                            | 描述                                                                                                                            |
| ----------- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 堆叠          | [IFluidStack](/vanilla/api/fluid/IFluidStack) | The stack to which the information box should be added to.                                                                    |
...
| 参数          | 类型                                          | 描述                                                                                                                            |
| ----------- | ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 堆叠          | [IItemstack](/vanilla/api/items/IItemStack) | The stack to which the information box should be added to.                                                                    |
| description | string[]                                    | A series of strings that represent the description. These information boxes are treated as <br />                     { |
...
| 参数 | 类型                                          | 描述                            |
| -- | ------------------------------------------- | ----------------------------- |
| 堆叠 | [IItemstack](/vanilla/api/items/IItemStack) | The stack to be added to JEI. |
...
| 参数 | 类型                                            | 描述                                        |
| -- | --------------------------------------------- | ----------------------------------------- |
| 堆叠 | [IFluidStack](/vanilla/api/fluid/IFluidStack) | The stack that should be hidden from JEI. |
...
| 参数 | 类型                                          | 描述                                        |
| -- | ------------------------------------------- | ----------------------------------------- |
| 堆叠 | [IItemstack](/vanilla/api/items/IItemStack) | The stack that should be hidden from JEI. |
...
| 不包含   | [RecipeFilter](/vanilla/api/recipe/RecipeFilter) | An optional exclusion filter.                        | true  | (name as string) => {return false;} |
