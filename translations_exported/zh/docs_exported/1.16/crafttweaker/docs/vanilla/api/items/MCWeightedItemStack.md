...
| weight | 双精度                                         | 机会介于 0 (0%) 和 1 (100%) 之间 |
...
| 名称     | 类型                                          | 可获得  | 可设置   | 描述                                        |
| ------ | ------------------------------------------- | ---- | ----- | ----------------------------------------- |
| 堆叠     | [IItemStack](/vanilla/api/items/IItemStack) | true | false | Gets the original (unweighted) stack      |
| weight | 双精度                                         | true | false | Gets the weight (usually between 0 and 1) |
