...
| groupName                | [MCText组件](/vanilla/api/util/text/MCTextComponent)                         | true | false | Gets the translated ItemGroup name.                                                                                                                           |
...
| searchBar                | 布尔值                                                                        | true | false | Checks if this ItemGroup has a search bar.                                                                                                                    |
