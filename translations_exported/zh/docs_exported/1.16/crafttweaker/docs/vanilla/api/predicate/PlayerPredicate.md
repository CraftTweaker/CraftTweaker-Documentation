...
| name（名称） | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's unique identifier.         |
...
| 类型       | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's base type.               |
| name（名称） | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's unique identifier.       |
| 值        | int                                                        | The exact value the statistic should be. |
...
| 参数       | 类型     | 描述                                              |
| -------- | ------ | ----------------------------------------------- |
| name（名称） | string | The name of the recipe that needs to be locked. |
...
| 参数       | 类型     | 描述                                                |
| -------- | ------ | ------------------------------------------------- |
| name（名称） | string | The name of the recipe that needs to be unlocked. |
