...
| priceMult     | 浮点数                                                                | When this trade is discounted, how much should it be discounted by. | true  | 1.0          |
...
| villagerLevel | int                                                                | The level the Villager needs to be.                                                       | false |                      |
| buying        | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The first item that you are giving to the villager.                                       | false |                      |
| selling       | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The item that the villager is selling to you.                                             | false |                      |
| secondBuying  | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The second item that you are giving to the villager. Will default to air if not provided. | true  | <item:minecraft:air> |
...
| villagerLevel | int                                                                | The level the Villager needs to be.                 |
| buying        | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The first item that you are giving to the villager. |
...
| villagerLevel | int                                                                | The level the Villager needs to be.                                                       |
| buying        | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The first item that you are giving to the villager.                                       |
| secondBuying  | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The second item that you are giving to the villager. Will default to air if not provided. |
...
| profession    | [MCVillagerProfession](/vanilla/api/villager/MCVillagerProfession) | That profession to remove from.               |
| villagerLevel | int                                                                | The level the Villager needs to be.           |
| selling       | [材料（IIngredient）](/vanilla/api/items/IIngredient)                  | The item that the villager is selling to you. |
...
| -------- | ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| rarity   | int                                               | The rarity of the Trade. Valid options are `1` or `2`. A Wandering Trader can only spawn with a single trade of rarity `2`. |
| tradeFor | [材料（IIngredient）](/vanilla/api/items/IIngredient) | What ItemStack is being sold (by the Villager).                                                                             |
