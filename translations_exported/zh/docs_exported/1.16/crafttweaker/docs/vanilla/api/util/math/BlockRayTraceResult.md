...
| 参数 | 类型                                     | 描述                |
| -- | -------------------------------------- | ----------------- |
| 点  | [BlockPos](/vanilla/api/util/BlockPos) | The new position. |
...
| inside | 布尔值                                      | true | false | Results if the result is inside of a block. <br />  <br />  This is used for scaffolding. |
| 点      | [BlockPos](/vanilla/api/util/BlockPos)   | true | false | Gets the position that was hit.                                                                       |
