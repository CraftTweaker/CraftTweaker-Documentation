...
| 参数 | 类型                                     | 描述                    |
| -- | -------------------------------------- | --------------------- |
| 点  | [BlockPos](/vanilla/api/util/BlockPos) | other position to add |
...
| 参数 | 类型                                     | 描述                        |
| -- | -------------------------------------- | ------------------------- |
| 点  | [BlockPos](/vanilla/api/util/BlockPos) | BlockPos to cross product |
...
| 参数 | 类型                                     | 描述                       |
| -- | -------------------------------------- | ------------------------ |
| 点  | [BlockPos](/vanilla/api/util/BlockPos) | other position to remove |
...
| 参数       | 类型                                     | 描述                                             |
| -------- | -------------------------------------- | ---------------------------------------------- |
| 点        | [BlockPos](/vanilla/api/util/BlockPos) | BlockPos to check if it is within the distance |
