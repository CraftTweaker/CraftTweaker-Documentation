...
| 参数            | 类型  | 描述                      |
| ------------- | --- | ----------------------- |
| p_225609_1_ | 布尔值 | No Description Provided |
...
| 名称              | 类型                                                        | 可获得  | 可设置   | 描述                      |
| --------------- | --------------------------------------------------------- | ---- | ----- | ----------------------- |
| fake            | 布尔值                                                       | true | false | No Description Provided |
...
| name（名称）        | [MCText组件](/vanilla/api/util/text/MCTextComponent)        | true | false | No Description Provided |
| saturationLevel | 浮点数                                                       | true | false | No Description Provided |
