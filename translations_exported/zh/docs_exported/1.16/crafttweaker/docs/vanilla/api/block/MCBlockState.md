...
| occupied | 布尔值                                                  | If the bed is occupied or not.              |
...
| 参数       | 类型  | 描述                                  |
| -------- | --- | ----------------------------------- |
| hardness | 浮点数 | the new hardness of this BlockState |
...
| 值        | string | The new value of the property.   |
...
| 名称                                | 类型                                          | 可获得  | 可设置   | 描述                                                                                                                                                                                                                                       |
| --------------------------------- | ------------------------------------------- | ---- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| block #方块                         | [MCBlock #MC方块](/vanilla/api/block/MCBlock) | true | false | Gets the base [MCBlock](/vanilla/api/block/MCBlock) of this BlockState. <br />  <br />  The [MCBlock](/vanilla/api/block/MCBlock) will not contain any of the properties of this BlockState.                                 |
| canProvidePower #可提供能量(应该是指红石之类的) | 布尔值                                         | true | false | Checks whether this BlockState can provide Redstone Power                                                                                                                                                                                |
...
| hardness                          | 浮点数                                         | true | true  | Gets the hardness of this BlockState.                                                                                                                                                                                                    |
...
| hasTileEntity #具有方块实体             | 布尔值                                         | true | false | Checks whether this BlockState has a [MCTileEntity](/vanilla/api/tileentity/MCTileEntity).                                                                                                                                               |
| isSlime                           | 布尔值                                         | true | false | Checks if this BlockState is a Slime Block.                                                                                                                                                                                              |
| isSolid #是否为固体                    | 布尔值                                         | true | false | Checks whether this BlockState is solid.                                                                                                                                                                                                 |
| isSticky #是否具有粘性                  | 布尔值                                         | true | false | Checks if this BlockState is sticky. <br />  <br />  This is used to determine if the block should pull or push adjacent blocks when pushed / pulled by a piston. <br />  For example, Slime Blocks are sticky blocks. |
| lightLevel #光照级别                  | int                                         | true | false | Gets the light level of this BlockState                                                                                                                                                                                                  |
| propertyNames                     | stdlib.List&lt;string&gt;       | true | false | Gets the names of the properties of this BlockState.                                                                                                                                                                                     |
| ticksRandomly #是否具有随机刻            | 布尔值                                         | true | false | Checks whether this BlockState ticks randomly.                                                                                                                                                                                           |
