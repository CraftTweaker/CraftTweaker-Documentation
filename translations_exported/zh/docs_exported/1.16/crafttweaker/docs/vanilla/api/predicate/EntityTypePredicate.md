...
| 参数      | 类型                                                                                                     | 描述                                             |
| ------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------- |
| tag #标签 | [MCTag](/vanilla/api/tags/MCTag)&lt;[MCEntityType](/vanilla/api/entities/MCEntityType)&gt; | The tag the predicate should use for matching. |
...
| 参数 | 类型                                                         | 描述                                           |
| -- | ---------------------------------------------------------- | -------------------------------------------- |
| 类型 | [MCEntityType #MC实体类型](/vanilla/api/entities/MCEntityType) | The entity type this predicate should match. |
