...
| 参数 | 类型  | 描述                        |
| -- | --- | ------------------------- |
| 值  | 双精度 | The given value to clamp. |
...
| defaultValue         | 双精度    | true | false | Gets the default value for this Attribute.                                                                                           |
| shouldWatch          | 布尔值    | true | false | Should this attribute be synced to the client.                                                                                       |
