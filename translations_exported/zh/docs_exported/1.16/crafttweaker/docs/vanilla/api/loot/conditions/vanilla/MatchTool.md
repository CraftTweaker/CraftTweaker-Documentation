...
| ----------- | ------------------------------------------- | ---------------------------------------------------------- |
| tool        | [IItemstack](/vanilla/api/items/IItemStack) | The tool that should be matched.                           |
| matchDamage | 布尔值                                         | Whether damage should be taken into account when matching. |
...
| tool        | [IItemstack](/vanilla/api/items/IItemStack) | The tool that should be matched                                |
| matchDamage | 布尔值                                         | Whether damage should be taken into account when matching.     |
| matchCount  | 布尔值                                         | Whether the amount should be taken into account when matching. |
...
| matchDamage | 布尔值                                         | Whether damage should be taken into account when matching.       |
| matchCount  | 布尔值                                         | Whether the amount should be taken into account when matching.   |
| matchNbt    | 布尔值                                         | Whether the NBT data should be taken into account when matching. |
