...
| 参数       | 类型     | 描述                     |
| -------- | ------ | ---------------------- |
| name（名称） | string | New name of the stack. |
...
| 参数                 | 类型  | 描述                                 |
| ------------------ | --- | ---------------------------------- |
| immuneToFire #免疫火焰 | 布尔值 | Should the item be immune to fire. |
...
| 参数     | 类型  | 描述                      |
| ------ | --- | ----------------------- |
| weight | 双精度 | No Description Provided |
...
| 值                | 双精度                                                            | The value of the modifier.                                                          | false |              |
...
| 参数      | 类型                                   | 描述              |
| ------- | ------------------------------------ | --------------- |
| tag #标签 | [IData #数据](/vanilla/api/data/IData) | The tag to set. |
...
| damageable           | 布尔值                                                           | true | false | Returns if the ItemStack is damageable <br />  I.E Swords and tools are damageable, sticks are not.                                    |
...
| empty                | 布尔值                                                           | true | false | Returns if the ItemStack is empty                                                                                                            |
...
| getOrCreate          | [IData #数据](/vanilla/api/data/IData)                          | true | false | Returns the NBT tag attached to this ItemStack or makes a new tag.                                                                           |
| getRepairCost        | int                                                           | true | false | Gets the repair cost of the ItemStack, or 0 if no repair is defined.                                                                         |
| hasDisplayName       | 布尔值                                                           | true | false | Returns true if the ItemStack has a display name.                                                                                            |
| hasEffect            | 布尔值                                                           | true | false | Returns true if this ItemStack has an effect.                                                                                                |
| hasTag               | 布尔值                                                           | true | false | Returns true if this ItemStack has a Tag                                                                                                     |
| immuneToFire #免疫火焰   | void                                                          | true | true  | Sets if this IItemStack is immune to fire / lava. <br />  <br />  If true, the item will not burn when thrown into fire or lava. |
| isCrossbow           | 布尔值                                                           | true | false | Returns true if this stack is considered a crossbow item                                                                                     |
...
| tag #标签              | [IData #数据](/vanilla/api/data/IData)                          | true | false | Returns the NBT tag attached to this ItemStack.                                                                                              |
