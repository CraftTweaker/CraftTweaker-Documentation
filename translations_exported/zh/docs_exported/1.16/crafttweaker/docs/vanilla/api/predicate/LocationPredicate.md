...
| 参数  | 类型                                                                                  | 描述                                                                                                     |
| --- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 生成器 | Consumer&lt;[BlockPredicate](/vanilla/api/predicate/BlockPredicate)&gt; | A consumer that will be used to configure the [BlockPredicate](/vanilla/api/predicate/BlockPredicate). |
...
| 参数 | 类型  | 描述                                            |
| -- | --- | --------------------------------------------- |
| x  | 浮点数 | The exact value the X position should assume. |
...
| 参数  | 类型                                                                                  | 描述                                                                                                     |
| --- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 生成器 | Consumer&lt;[FluidPredicate](/vanilla/api/predicate/FluidPredicate)&gt; | A consumer that will be used to configure the [FluidPredicate](/vanilla/api/predicate/FluidPredicate). |
...
| 参数  | 类型                                                                                  | 描述                                                                                                     |
| --- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 生成器 | Consumer&lt;[LightPredicate](/vanilla/api/predicate/LightPredicate)&gt; | A consumer that will be used to configure the [LightPredicate](/vanilla/api/predicate/LightPredicate). |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| max | 浮点数 | The maximum value the X position can assume. |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| max | 浮点数 | The maximum value the Y position can assume. |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| max | 浮点数 | The maximum value the Z position can assume. |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| min | 浮点数 | The minimum value the X position can assume. |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| min | 浮点数 | The minimum value the Y position can assume. |
...
| 参数  | 类型  | 描述                                           |
| --- | --- | -------------------------------------------- |
| min | 浮点数 | The minimum value the Z position can assume. |
