...
| 参数      | 类型     | 描述                          |
| ------- | ------ | --------------------------- |
| tag #标签 | string | The name of the tag to add. |
...
| 参数 | 类型  | 描述                               |
| -- | --- | -------------------------------- |
| x  | 双精度 | The amount of X velocity to add. |
| y  | 双精度 | The amount of Y velocity to add. |
| z  | 双精度 | The amount of Z velocity to add. |
...
| 参数 | 类型  | 描述               |
| -- | --- | ---------------- |
| x  | 双精度 | The new X value. |
| y  | 双精度 | The new Y value. |
| z  | 双精度 | The new Z value. |
...
| 参数 | 类型  | 描述                                            |
| -- | --- | --------------------------------------------- |
| x  | 双精度 | The X value of the position to check against. |
| y  | 双精度 | The Y value of the position to check against. |
| z  | 双精度 | The Z value of the position to check against. |
...
| distance | 双精度                                      | The distance to check for.             |
...
| 参数               | 类型  | 描述                                  |
| ---------------- | --- | ----------------------------------- |
| distance         | 浮点数 | The distance the Entity has fallen. |
| damageMultiplier | 浮点数 | The damage multiplier.              |
...
| 参数      | 类型     | 描述                             |
| ------- | ------ | ------------------------------ |
| tag #标签 | string | The name of the tag to remove. |
...
| 参数    | 类型  | 描述                   |
| ----- | --- | -------------------- |
| x     | 双精度 | The new x position.  |
| y     | 双精度 | The new y position.  |
| z     | 双精度 | The new z position.  |
| yaw   | 浮点数 | The new yaw value.   |
| pitch | 浮点数 | The new pitch value. |
...
| 参数        | 类型  | 描述                     |
| --------- | --- | ---------------------- |
| noGravity | 布尔值 | The new gravity value. |
...
| 参数       | 类型  | 描述                                     |
| -------- | --- | -------------------------------------- |
| grounded | 布尔值 | If the Entity is on the ground or not. |
...
| 参数 | 类型  | 描述                                |
| -- | --- | --------------------------------- |
| x  | 双精度 | The new X position of the Entity. |
| y  | 双精度 | The new Y position of the Entity. |
| z  | 双精度 | The new Z position of the Entity. |
...
| 参数       | 类型  | 描述                                     |
| -------- | --- | -------------------------------------- |
| isSilent | 布尔值 | If the Entity should be silent or not. |
...
| forced | 布尔值                                      | No Description Provided | true  | false        |
...
| canSwim #是否可以游泳  | 布尔值                                                        | true | false | Checks if this Entity can swim.                                                                                                        |
...
| inLava           | 布尔值                                                        | true | false | Checks if this Entity is in lava or not.                                                                                               |
| inWater          | 布尔值                                                        | true | false | Checks if this Entity is in water.                                                                                                     |
| isWet            | 布尔值                                                        | true | false | Checks if this Entity is wet.                                                                                                          |
| name（名称）         | string                                                     | true | false | Gets the name of the Entity.                                                                                                           |
| onGround         | [MCEntity](/vanilla/api/entity/MCEntity)                   | true | true  | Sets if the Entity should be considered on the ground or not.                                                                          |
| persistedData    | [MapData #地图数据](/vanilla/api/data/MapData)                 | true | false | Gets the persisted NBT tag.                                                                                                            |
...
| silent           | 布尔值                                                        | true | true  | Checks if this Entity is silent. <br />  <br />  Silent Entities do not play sounds.                                       |
| sneaking         | 布尔值                                                        | true | true  | Checks if this Entity is sneaking or not.                                                                                              |
| spectator        | 布尔值                                                        | true | false | Checks if this Entity is in spectator mode.                                                                                            |
