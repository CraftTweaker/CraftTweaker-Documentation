...
| 名称               | 类型                                          | 可获得  | 可设置   | 描述                                                                                                            |
| ---------------- | ------------------------------------------- | ---- | ----- | ------------------------------------------------------------------------------------------------------------- |
| absolute         | 布尔值                                         | true | false | Checks if the damage is absolute.                                                                             |
| bypassCreative   | 布尔值                                         | true | false | Checks if the damage can bypass creative mode.                                                                |
| creativePlayer   | 布尔值                                         | true | false | Gets whether the damage was inflicted by a creative player.                                                   |
| difficultyScaled | 布尔值                                         | true | false | Gets whether the damage changes strength based on the current difficulty.                                     |
| explosion        | 布尔值                                         | true | false | Checks if the damage is caused by an explosion.                                                               |
| fire             | 布尔值                                         | true | false | Checks if the damage is caused by fire or burning.                                                            |
| hungerDamage     | 浮点数                                         | true | false | Gets the amount of exhaustion to add to the player's hunger bar if they <br />  get hit by this damage. |
| immediateSource  | [MCEntity](/vanilla/api/entity/MCEntity)    | true | false | Gets the immediate source of the damage, like an arrow.                                                       |
| 位置               | [MCVector3d](/vanilla/api/util/MCVector3d)? | true | false | Gets the location where the damage occurred.                                                                  |
| magic            | 布尔值                                         | true | false | Checks if the damage is caused by magic.                                                                      |
| projectile       | 布尔值                                         | true | false | Checks if the damage is caused by a projectile.                                                               |
...
| 类型               | string                                      | true | false | Gets the type of damage.                                                                                      |
| unblockable      | 布尔值                                         | true | false | Checks if the damage can be blocked.                                                                          |
