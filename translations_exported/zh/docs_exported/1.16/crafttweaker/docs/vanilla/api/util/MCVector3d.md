...
| 参数 | 类型  | 描述                                   |
| -- | --- | ------------------------------------ |
| x  | 双精度 | The x component of the other vector. |
| y  | 双精度 | The y component of the other vector. |
| z  | 双精度 | The z component of the other vector. |
...
| magnitude        | 双精度                                        | true | false | Gets the length, also known as magnitude, of the vector.                                                                                                                                                       |
| magnitudeSquared | 双精度                                        | true | false | Gets the squared length, also known as squared magnitude, of the vector. <br />  <br />  This method is faster and less error-prone than calling <code>magnitude</code> and squaring the result. |
| x                | 双精度                                        | true | false | Gets the X coordinate of this vector.                                                                                                                                                                          |
| y                | 双精度                                        | true | false | Gets the Y coordinate of this vector.                                                                                                                                                                          |
| z                | 双精度                                        | true | false | Gets the Z coordinate of this vector.                                                                                                                                                                          |
