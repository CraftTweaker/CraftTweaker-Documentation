...
| 参数     | 类型                                          | 描述                                                                              |
| ------ | ------------------------------------------- | ------------------------------------------------------------------------------- |
| 堆叠     | [IItemStack](/vanilla/api/items/IItemStack) | The stack to be compostable                                                     |
| amount | 浮点数                                         | The amount of Compost that should be added when the item is put in a Composter. |
