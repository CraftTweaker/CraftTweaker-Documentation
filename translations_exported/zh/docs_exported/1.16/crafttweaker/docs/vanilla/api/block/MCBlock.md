...
| 参数      | 类型                                                                                        | 描述                                                                          |
| ------- | ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| tag #标签 | [MCTag](/vanilla/api/tags/MCTag)&lt;[MCBlock](/vanilla/api/block/MCBlock)&gt; | The [MCTag](/vanilla/api/tags/MCTag)&lt;T&gt; to check against. |
...
| 参数         | 类型  | 描述                                      |
| ---------- | --- | --------------------------------------- |
| resistance | 浮点数 | The new blast resistance of this Block. |
...
| 参数         | 类型  | 描述                                 |
| ---------- | --- | ---------------------------------- |
| jumpFactor | 浮点数 | The new jump factor of this Block. |
...
| 参数           | 类型  | 描述                                  |
| ------------ | --- | ----------------------------------- |
| slipperiness | 浮点数 | The new slipperiness of this Block. |
...
| 参数          | 类型  | 描述                                  |
| ----------- | --- | ----------------------------------- |
| speedFactor | 浮点数 | The new speed factor of this Block. |
...
| 名称                   | 类型                                                                                                                       | 可获得  | 可设置   | 描述                                                                                                                                                                                                                   |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| blastResistance      | 浮点数                                                                                                                      | true | true  | Gets the blast resistance of this Block.                                                                                                                                                                             |
| canCollide           | 布尔值                                                                                                                      | true | true  | Checks if entities can collide with this Block.                                                                                                                                                                      |
...
| jumpFactor           | 浮点数                                                                                                                      | true | true  | Gets the jump factor of this Block.                                                                                                                                                                                  |
...
| slipperiness         | 浮点数                                                                                                                      | true | true  | Gets the slipperiness of this Block.                                                                                                                                                                                 |
| speedFactor          | 浮点数                                                                                                                      | true | true  | Gets the speed factor of this Block.                                                                                                                                                                                 |
...
| variableOpacity      | 布尔值                                                                                                                      | true | false | Checks if the opacity of this block is different in different areas of the Block.                                                                                                                                    |
