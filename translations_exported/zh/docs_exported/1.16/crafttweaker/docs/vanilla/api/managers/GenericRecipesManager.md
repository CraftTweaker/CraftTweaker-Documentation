...
| 参数       | 类型                                   | 描述                         |
| -------- | ------------------------------------ | -------------------------- |
| name（名称） | string                               | The recipe's resource path |
| data     | [IData #数据](/vanilla/api/data/IData) | The recipe in JSON format  |
...
| ----- | ------------------------------------------------ | ------------------------------------------------------------------------- |
| modId | string                                           | The mod's modid                                                           |
| 不包含   | [RecipeFilter](/vanilla/api/recipe/RecipeFilter) | Function that returns `true` if the recipe should remain in the registry. |
...
| 参数       | 类型     | 描述                        |
| -------- | ------ | ------------------------- |
| name（名称） | string | The recipe name to remove |
...
| 参数         | 类型                                                | 描述                |
| ---------- | ------------------------------------------------- | ----------------- |
| output（输出） | [材料（IIngredient）](/vanilla/api/items/IIngredient) | The recipe result |
