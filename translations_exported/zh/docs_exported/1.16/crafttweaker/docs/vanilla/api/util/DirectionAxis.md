...
| 参数 | 类型  | 描述                        |
| -- | --- | ------------------------- |
| x  | 双精度 | x value of the coordinate |
| y  | 双精度 | y value of the coordinate |
| z  | 双精度 | z value of the coordinate |
...
| name（名称）             | string | true | false | Get the name of this Axis ("X", "Y" or "Z") |
