...
| ------------- | ------------------------------------------------- | --------- | --------- |
| left          | [IItemStack](/vanilla/api/item/IItemStack)        | sì        | no        |
| levelCost     | int                                               | sì        | sì        |
| materialCosto | int                                               | sì        | sì        |
| nome          | string?                                           | sì        | no        |
| output        | [IItemStack](/vanilla/api/item/IItemStack)        | sì        | sì        |
| player        | [Player](/vanilla/api/entity/type/player/Player)? | sì        | no        |
| right         | [IItemStack](/vanilla/api/item/IItemStack)        | sì        | no        |
