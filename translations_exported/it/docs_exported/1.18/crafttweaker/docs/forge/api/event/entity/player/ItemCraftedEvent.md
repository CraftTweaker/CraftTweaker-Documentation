...
| --------- | ------------------------------------------ | --------- | --------- | ----------------------- |
| crafting  | [IItemStack](/vanilla/api/item/IItemStack) | sì        | no        | No Description Provided |
| inventory | [Container](/vanilla/api/world/Container)  | sì        | no        | No Description Provided |
