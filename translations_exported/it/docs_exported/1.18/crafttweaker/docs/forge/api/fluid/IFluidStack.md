...
| --------------------------------------------------- | --------- |
| [Fluid](/vanilla/api/fluid/Fluid)                   | sì        |
...
| fluid         | [Fluid](/vanilla/api/fluid/Fluid)                          | sì        | no        | Retrieves this fluid stack's fluid.                              |
| hasTag        | boolean                                                    | sì        | no        | Returns true if this FluidStack has a Tag                        |
| isImmutable   | boolean                                                    | sì        | no        |                                                                  |
| registryName  | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | sì        | no        | Gets the registry name for the fluid this stack is representing. |
| tag           | [MapData](/vanilla/api/data/MapData)                       | sì        | no        | Returns the NBT tag attached to this FluidStack.                 |
