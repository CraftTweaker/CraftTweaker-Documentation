...
| --------------- | ------------------------------------------ | --------- | --------- |
| breakChance     | float                                      | sì        | sì        |
| ingredientInput | [IItemStack](/vanilla/api/item/IItemStack) | sì        | no        |
| itemInput       | [IItemStack](/vanilla/api/item/IItemStack) | sì        | no        |
| itemResult      | [IItemStack](/vanilla/api/item/IItemStack) | sì        | no        |
