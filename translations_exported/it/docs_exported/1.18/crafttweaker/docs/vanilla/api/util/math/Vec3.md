...
| --------------------- | ----------------------------------- | --------- | --------- |
| horizontalDistance    | double                              | sì        | no        |
| horizontalDistanceSqr | double                              | sì        | no        |
| length                | double                              | sì        | no        |
| lengthSqr             | double                              | sì        | no        |
| normalize             | [Vec3](/vanilla/api/util/math/Vec3) | sì        | no        |
| reverse               | [Vec3](/vanilla/api/util/math/Vec3) | sì        | no        |
