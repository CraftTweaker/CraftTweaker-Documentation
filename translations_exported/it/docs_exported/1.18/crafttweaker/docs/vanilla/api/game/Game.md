...
| ------------------- | -------------------------------------------------------------------------------------------- | --------- | --------- |
| blockStates         | Collection&lt;[BlockState](/vanilla/api/block/BlockState)&gt;                    | sì        | no        |
| blocks              | Collection&lt;[Block](/vanilla/api/block/Block)&gt;                              | sì        | no        |
| effects             | Collection&lt;[MobEffect](/vanilla/api/entity/effect/MobEffect)&gt;              | sì        | no        |
| enchantments        | Collection&lt;[Enchantment](/vanilla/api/item/enchantment/Enchantment)&gt;       | sì        | no        |
| entityTypes         | Collection&lt;[EntityType](/vanilla/api/entity/EntityType)&gt;                   | sì        | no        |
| fluids              | Collection&lt;[Fluid](/vanilla/api/fluid/Fluid)&gt;                              | sì        | no        |
| items               | Collection&lt;[IItemStack](/vanilla/api/item/IItemStack)&gt;                     | sì        | no        |
| potions             | Collection&lt;[Potion](/vanilla/api/item/alchemy/Potion)&gt;                     | sì        | no        |
| recipeTypes         | Collection&lt;[IRecipeManager](/vanilla/api/recipe/manager/IRecipeManager)&gt;   | sì        | no        |
| villagerProfessions | Collection&lt;[VillagerProfession](/vanilla/api/villager/VillagerProfession)&gt; | sì        | no        |
