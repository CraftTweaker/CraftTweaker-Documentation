...
| ingredients  | stdlib.List&lt;[IIngredient](/vanilla/api/ingredient/IIngredient)&gt; | sì        | no        |
| isIncomplete | boolean                                                                           | sì        | no        |
| isSpecial    | boolean                                                                           | sì        | no        |
| resultItem   | [IItemStack](/vanilla/api/item/IItemStack)                                        | sì        | no        |
| toastSymbol  | [ItemStack](/vanilla/api/item/ItemStack)                                          | sì        | no        |
