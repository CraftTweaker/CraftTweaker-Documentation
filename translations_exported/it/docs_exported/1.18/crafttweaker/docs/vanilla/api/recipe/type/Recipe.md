...
| ingredients  | stdlib.List&lt;[IIngredient](/vanilla/api/ingredient/IIngredient)&gt; | sì        | no        | No Description Provided |
| isIncomplete | boolean                                                                           | sì        | no        | No Description Provided |
| isSpecial    | boolean                                                                           | sì        | no        | No Description Provided |
| resultItem   | [IItemStack](/vanilla/api/item/IItemStack)                                        | sì        | no        | No Description Provided |
| toastSymbol  | [ItemStack](/vanilla/api/item/ItemStack)                                          | sì        | no        | No Description Provided |
