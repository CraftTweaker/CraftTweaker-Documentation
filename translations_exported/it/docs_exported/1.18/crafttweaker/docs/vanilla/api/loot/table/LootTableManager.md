...
| --------- | ---------------------------------------------------------- | ----------------------------- |
| nome      | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | The name of the table to get. |
...
| ---- | --------------------------------------------------------------------------------- | --------- | --------- | ------------------------------------------- |
| ids  | Set&lt;[ResourceLocation](/vanilla/api/resource/ResourceLocation)&gt; | sì        | no        | Gets the ids of all registered loot tables. |
