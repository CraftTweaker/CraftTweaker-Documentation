...
| tagKeys   | stdlib.List&lt;[ResourceLocation](/vanilla/api/resource/ResourceLocation)&gt; | sì        | no        | Gets the keys of the tags that this manager knows about.                                                                                                                                                             |
| tagMap    | T[[ResourceLocation](/vanilla/api/resource/ResourceLocation)]                             | sì        | no        | Gets a map of id to tag that this manager knows about.                                                                                                                                                               |
