...
| --------------- | ---------------------------------------------------------- | --------- | --------- | ----------------------------------------- |
| blocksMotion    | boolean                                                    | sì        | no        |                                           |
| color           | [MaterialColor](/vanilla/api/block/material/MaterialColor) | sì        | no        |                                           |
| commandString   | string                                                     | sì        | no        | Gets the bracket syntax for this Material |
| isFlammable     | boolean                                                    | sì        | no        |                                           |
| isLiquid        | boolean                                                    | sì        | no        |                                           |
| isReplaceable   | boolean                                                    | sì        | no        |                                           |
| isSolid         | boolean                                                    | sì        | no        |                                           |
| isSolidBlocking | boolean                                                    | sì        | no        |                                           |
| pushReaction    | [PushReaction](/vanilla/api/block/material/PushReaction)   | sì        | no        |                                           |
