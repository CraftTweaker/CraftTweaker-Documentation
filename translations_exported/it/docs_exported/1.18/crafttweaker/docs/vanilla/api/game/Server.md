...
| --------- | ------------------------------------------------ | ----------------------- | -------- | ------------ |
| command   | string                                           | No Description Provided | no       |              |
| player    | [Player](/vanilla/api/entity/type/player/Player) | No Description Provided | no       |              |
| silent    | boolean                                          | No Description Provided | sì       | no           |
...
| --------- | ---------------------------------------------------------- | ----------------------- |
| posizione | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | No Description Provided |
...
| --------------------------- | ----------------------------------------------------------------------------------------- | --------- | --------- | ----------------------- |
| absoluteMaxWorldSize        | int                                                                                       | sì        | no        | No Description Provided |
| allLevels                   | stdlib.Iterable&lt;[ServerLevel](/vanilla/api/world/ServerLevel)&gt;          | sì        | no        | No Description Provided |
| areNpcsEnabled              | boolean                                                                                   | sì        | no        | No Description Provided |
| averageTickTime             | float                                                                                     | sì        | no        | No Description Provided |
| defaultGameTime             | [GameType](/vanilla/api/world/GameType)                                                   | sì        | no        | No Description Provided |
| forcedGameType              | [GameType](/vanilla/api/world/GameType)                                                   | sì        | no        | No Description Provided |
| isCommandBlockEnabled       | boolean                                                                                   | sì        | no        | No Description Provided |
| isDedicatedServer           | boolean                                                                                   | sì        | no        | No Description Provided |
| isEnforceWhitelist          | boolean                                                                                   | sì        | no        | No Description Provided |
| isFlightAllowed             | boolean                                                                                   | sì        | no        | No Description Provided |
| isHardcore                  | boolean                                                                                   | sì        | no        | No Description Provided |
| isNetherEnabled             | boolean                                                                                   | sì        | no        | No Description Provided |
| isPvpAllowed                | boolean                                                                                   | sì        | no        | No Description Provided |
| isReady                     | boolean                                                                                   | sì        | no        | No Description Provided |
| isRunning                   | boolean                                                                                   | sì        | no        | No Description Provided |
| isShutdown                  | boolean                                                                                   | sì        | no        | No Description Provided |
| isSingleplayer              | boolean                                                                                   | sì        | no        | No Description Provided |
| isSpawningAnimals           | boolean                                                                                   | sì        | no        | No Description Provided |
| isSpawningMonsters          | boolean                                                                                   | sì        | no        | No Description Provided |
| isStopped                   | boolean                                                                                   | sì        | no        | No Description Provided |
| levelKeys                   | stdlib.List&lt;[ResourceLocation](/vanilla/api/resource/ResourceLocation)&gt; | sì        | no        | No Description Provided |
| maxPlayer                   | int                                                                                       | sì        | no        | No Description Provided |
| moddeStatus                 | **invalid**                                                                               | sì        | no        | No Description Provided |
| motd                        | string                                                                                    | sì        | no        | No Description Provided |
| operatorUserPermissionLevel | int                                                                                       | sì        | no        | No Description Provided |
| overworld                   | [ServerLevel](/vanilla/api/world/ServerLevel)                                             | sì        | no        | No Description Provided |
| playerCount                 | int                                                                                       | sì        | no        | No Description Provided |
| playerNames                 | string[]                                                                                  | sì        | no        | No Description Provided |
| serverModName               | string                                                                                    | sì        | no        | No Description Provided |
| serverVersion               | string                                                                                    | sì        | no        | No Description Provided |
| spawnProtectionRadius       | int                                                                                       | sì        | no        | No Description Provided |
| tickCount                   | int                                                                                       | sì        | no        | No Description Provided |
