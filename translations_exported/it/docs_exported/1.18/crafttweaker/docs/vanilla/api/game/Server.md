...
| --------- | ------------------------------------------------ | -------- | ------------- |
| command   | string                                           | no       |               |
| player    | [Player](/vanilla/api/entity/type/player/Player) | no       |               |
| silent    | boolean                                          | sì       | no            |
...
| Parametro | Tipo                                                       |
| --------- | ---------------------------------------------------------- |
| posizione | [ResourceLocation](/vanilla/api/resource/ResourceLocation) |
...
| --------------------------- | ----------------------------------------------------------------------------------------- | --------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| absoluteMaxWorldSize        | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
| allLevels                   | stdlib.Iterable&lt;[ServerLevel](/vanilla/api/world/ServerLevel)&gt;          | sì        | no        |                                                                                                                                                                                          |
| areNpcsEnabled              | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| averageTickTime             | float                                                                                     | sì        | no        |                                                                                                                                                                                          |
| defaultGameTime             | [GameType](/vanilla/api/world/GameType)                                                   | sì        | no        |                                                                                                                                                                                          |
| forcedGameType              | [GameType](/vanilla/api/world/GameType)?                                                  | sì        | no        |                                                                                                                                                                                          |
| isCommandBlockEnabled       | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isDedicatedServer           | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isEnforceWhitelist          | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isFlightAllowed             | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isHardcore                  | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isNetherEnabled             | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isPvpAllowed                | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isReady                     | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isRunning                   | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isShutdown                  | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isSingleplayer              | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isSpawningAnimals           | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isSpawningMonsters          | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| isStopped                   | boolean                                                                                   | sì        | no        |                                                                                                                                                                                          |
| levelKeys                   | stdlib.List&lt;[ResourceLocation](/vanilla/api/resource/ResourceLocation)&gt; | sì        | no        |                                                                                                                                                                                          |
| maxPlayer                   | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
| moddeStatus                 | string?                                                                                   | sì        | no        |                                                                                                                                                                                          |
| motd                        | string                                                                                    | sì        | no        |                                                                                                                                                                                          |
| operatorUserPermissionLevel | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
| overworld                   | [ServerLevel](/vanilla/api/world/ServerLevel)                                             | sì        | no        |                                                                                                                                                                                          |
| overworldData               | [CraftTweakerSavedData](/vanilla/api/world/CraftTweakerSavedData)                         | sì        | no        | Gets the custom data of the overworld. <br />  <br />  The overworld is always loaded, so this can be used to store and access data no matter what level a player may be in. |
| playerCount                 | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
| playerNames                 | string[]                                                                                  | sì        | no        |                                                                                                                                                                                          |
| serverModName               | string                                                                                    | sì        | no        |                                                                                                                                                                                          |
| serverVersion               | string                                                                                    | sì        | no        |                                                                                                                                                                                          |
| spawnProtectionRadius       | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
| tickCount                   | int                                                                                       | sì        | no        |                                                                                                                                                                                          |
