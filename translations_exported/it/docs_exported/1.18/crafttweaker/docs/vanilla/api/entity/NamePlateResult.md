...
| --------- | ---------------------------------------- | --------------------------- |
| contenuto | [Component](/vanilla/api/text/Component) | The new nameplate contents. |
...
| --------------- | ---------------------------------------- | --------- | --------- | ------------------------------------------------------------------------------------------ |
| contenuto       | [Component](/vanilla/api/text/Component) | sì        | sì        | Gets the current content of the nameplate. <br />  This can be changed by mods.      |
| originalContent | [Component](/vanilla/api/text/Component) | sì        | no        | Gets the original content of the nameplate. <br />  This can not be changed by mods. |
