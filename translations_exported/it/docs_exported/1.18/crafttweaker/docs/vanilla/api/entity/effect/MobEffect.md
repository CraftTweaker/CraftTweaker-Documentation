...
| Parametro      | Tipo                                             |
| -------------- | ------------------------------------------------ |
| sorgente       | [Entity](/vanilla/api/entity/Entity)             |
...
| ------------- | ----------------------------------------------------------------- | --------- | --------- |
| beneficial    | boolean                                                           | sì        | no        |
| category      | [MobEffectCategory](/vanilla/api/entity/effect/MobEffectCategory) | sì        | no        |
| color         | int                                                               | sì        | no        |
| commandString | string                                                            | sì        | no        |
| descriptionId | string                                                            | sì        | no        |
| displayName   | [Component](/vanilla/api/text/Component)                          | sì        | no        |
| instantenous  | boolean                                                           | sì        | no        |
