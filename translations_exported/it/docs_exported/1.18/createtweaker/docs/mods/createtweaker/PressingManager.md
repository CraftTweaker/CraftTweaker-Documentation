...
| outputs   | [Percentaged](/vanilla/api/util/random/Percentaged)&lt;[IItemStack](/vanilla/api/item/IItemStack)&gt;[] | The outputs of the recipe.                      | no       |              |
| input     | [IIngredientWithAmount](/vanilla/api/ingredient/IIngredientWithAmount)                                              | The input of the recipe.                        | no       |              |
