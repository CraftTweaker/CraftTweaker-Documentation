...
| ------------------ | -------------------------------------------------- | --------- | --------- | ------------------------------------- |
| processedItem      | [IIngredient](/vanilla/api/ingredient/IIngredient) | sì        | no        | Gets the processed Item.              |
| requiredHeldItem   | [IIngredient](/vanilla/api/ingredient/IIngredient) | sì        | no        | Gets the required held item.          |
| shouldKeepHeldItem | boolean                                            | sì        | no        | Should the recipe keep the held item? |
