...
| outputs      | [Percentaged](/vanilla/api/util/random/Percentaged)&lt;[IItemStack](/vanilla/api/item/IItemStack)&gt;[] | The recipe outputs                 | no       |              |
| block        | [IIngredient](/vanilla/api/ingredient/IIngredient)                                                                  | The block to be applied on         | no       |              |
| heldItem     | [IIngredient](/vanilla/api/ingredient/IIngredient)                                                                  | The item that needs to be held     | no       |              |
| keepHeldItem | boolean                                                                                                             | Should the item be consumed or not | sì       | no           |
