...
| nome      | [Component](/vanilla/api/text/Component)                        | A [Component](/vanilla/api/text/Component) representing the name of the category.                                                     |
...
| id         | [ResourceLocation](/vanilla/api/resource/ResourceLocation)      | sì        | no        | Gets the ID of the category.                                                                                                   |
| nome       | [Component](/vanilla/api/text/Component)                        | sì        | no        | Gets the name of the category.                                                                                                 |
