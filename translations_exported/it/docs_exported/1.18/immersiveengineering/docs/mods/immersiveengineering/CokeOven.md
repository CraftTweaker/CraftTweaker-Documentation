...
| ingredient       | [IIngredientWithAmount](/vanilla/api/ingredient/IIngredientWithAmount) | The recipe's input                                        | no       |               |
| time             | int                                                                    | The time the recipe requires, in ticks                    | no       |               |
| output           | [IItemStack](/vanilla/api/item/IItemStack)                             | The produced item                                         | no       |               |
| creosoteProduced | int                                                                    | The amount of creosote produced                           | sì       | 0             |
