...
| --------------- | ------- | --------- | --------- | ---------------------------------------------------- |
| canExtract      | boolean | sì        | no        | Checks if energy can be extracted from this storage. |
| canReceive      | boolean | sì        | no        | Checks if this storage can receive energy.           |
| energyStored    | int     | sì        | no        | Gets the amount of energy stored.                    |
| maxEnergyStored | int     | sì        | no        | Gets the max energy that can be stored.              |
