...
| placedAgainst | [BlockState](/vanilla/api/block/BlockState) | sì        | no        |
| placedBlock   | [BlockState](/vanilla/api/block/BlockState) | sì        | no        |
| replacedBlock | [BlockState](/vanilla/api/block/BlockState) | sì        | no        |
