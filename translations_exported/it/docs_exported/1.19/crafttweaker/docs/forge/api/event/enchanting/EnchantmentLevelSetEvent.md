...
```zenscript
// EnchantmentLevelSetEvent.getEnchantLevel() as int

myEnchantmentLevelSetEvent.getEnchantLevel();
```
...
```zenscript
// EnchantmentLevelSetEvent.getLevel() as Level
...
| ------------- | ------------------------------------------- | --------- | --------- | ----------------------------------------------------------------------------------------------------------------------------- |
| enchantLevel  | int                                         | sì        | sì        | Gets the current level of the enchantment for this row. <br />   <br />  This value can be changed by other mods. |
| enchantRow    | int                                         | sì        | no        | Gets the row in the Enchanting Table that this event is fired for.                                                            |
| item          | [IItemStack](/vanilla/api/item/IItemStack)  | sì        | no        | Gets the ItemStack that is being enchanted.                                                                                   |
| level         | [Level](/vanilla/api/world/Level)           | sì        | no        | Gets the Level where the Enchanting Table is.                                                                                 |
| originalLevel | int                                         | sì        | no        | Gets the original level of the enchantment for this row.                                                                      |
| pos           | [BlockPos](/vanilla/api/util/math/BlockPos) | sì        | no        | Gets the position of the Enchanting Table firing this event.                                                                  |
| power         | int                                         | sì        | no        | Gets the Enchanting Power of the Enchanting Table.                                                                            |
