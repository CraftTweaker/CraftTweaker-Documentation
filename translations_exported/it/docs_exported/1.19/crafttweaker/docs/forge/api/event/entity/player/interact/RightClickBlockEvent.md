...
| hitVec   | [BlockHitResult](/vanilla/api/util/BlockHitResult) | sì        | no        |                                                                                                                                                                                |
| useBlock | [EventResult](/forge/api/event/EventResult)        | sì        | sì        |                                                                                                                                                                                |
| useItem  | [EventResult](/forge/api/event/EventResult)        | sì        | sì        |                                                                                                                                                                                |
