...
| commandString     | string                                    | sì        | no        | Gets the blockstate bracket handler syntax for this BlockState. <br />  <br />  E.G. <br />  `<blockstate:minecraft:grass:snowy=true>`                                   |
...
| isRandomlyTicking | boolean                                   | sì        | no        | Checks whether this BlockState ticks randomly.                                                                                                                                                   |
| isSignalSource    | boolean                                   | sì        | no        | Checks whether this BlockState can provide Redstone Power                                                                                                                                        |
| lightEmission     | int                                       | sì        | no        | Gets the light level of this BlockState                                                                                                                                                          |
| properties        | string[string]                            | sì        | no        | Gets the properties of this BlockState.                                                                                                                                                          |
| propertyNames     | stdlib.List&lt;string&gt;     | sì        | no        | Gets the names of the properties of this BlockState.                                                                                                                                             |
| soundType         | [SoundType](/vanilla/api/sound/SoundType) | sì        | no        |                                                                                                                                                                                                  |
