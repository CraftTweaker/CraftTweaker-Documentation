...
| recipeFunction | [RecipeFunction2D](/vanilla/api/recipe/fun/RecipeFunction2D) | sì       |
...
| recipeFunction | [RecipeFunction2D](/vanilla/api/recipe/fun/RecipeFunction2D) | optional [RecipeFunction2D](/vanilla/api/recipe/fun/RecipeFunction2D) for more advanced conditions | sì       |
...
| output         | [IItemStack](/vanilla/api/item/IItemStack)                   | no       |
| ingredients    | [IIngredient](/vanilla/api/ingredient/IIngredient)[]         | no       |
| recipeFunction | [RecipeFunction1D](/vanilla/api/recipe/fun/RecipeFunction1D) | sì       |
