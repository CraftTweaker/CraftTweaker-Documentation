...
| [ItemDefinition](/vanilla/api/item/ItemDefinition)    | no        |
| string                                                | no        |
...
| ------------------------- | -------------------------------------------------------------------------- | --------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| commandString             | string                                                                     | sì        | no        | Gets the block bracket handler syntax for this Block. <br />  <br />  E.G. <br />  `<block:minecraft:dirt>`       |
| defaultState              | [BlockState](/vanilla/api/block/BlockState)                                | sì        | no        | Gets the default [BlockState](/vanilla/api/block/BlockState) of this Block.                                                               |
| descriptionId             | string                                                                     | sì        | no        | Gets the translation key that is used to localize this Block.                                                                             |
| dynamicShape              | boolean                                                                    | sì        | no        | Checks if the opacity of this block is different in different areas of the Block.                                                         |
| explosionResistance       | float                                                                      | sì        | sì        | Gets the blast resistance of this Block.                                                                                                  |
| friction                  | float                                                                      | sì        | sì        | Gets the friction of this Block.                                                                                                          |
| hasCollision              | boolean                                                                    | sì        | sì        | Checks if entities can collide with this Block.                                                                                           |
| isPossibleToRespawnInThis | boolean                                                                    | sì        | no        | Checks if an entity can be spawned inside this Block. <br />  <br />  This is used to find valid spawn locations for players. |
| jumpFactor                | float                                                                      | sì        | sì        | Gets the jump factor of this Block.                                                                                                       |
| lootTable                 | string                                                                     | sì        | no        | Gets the loot table id for this Block.                                                                                                    |
| material                  | [Material](/vanilla/api/block/material/Material)                           | sì        | sì        | Gets the material of this Block.                                                                                                          |
| nome                      | [MutableComponent](/vanilla/api/text/MutableComponent)                     | sì        | no        | Gets the name of this Block                                                                                                               |
| possibleStates            | stdlib.List&lt;[BlockState](/vanilla/api/block/BlockState)&gt; | sì        | no        | Gets a list of valid [BlockState](/vanilla/api/block/BlockState)s for this Block.                                                         |
| registryName              | [ResourceLocation](/vanilla/api/resource/ResourceLocation)                 | sì        | no        | Gets the registry name of this block.                                                                                                     |
