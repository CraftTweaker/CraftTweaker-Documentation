...
| int[]                                                           | no        |
| long[]                                                          | no        |
| stdlib.List&lt;[IData](/vanilla/api/data/IData)&gt; | no        |
| string                                                          | no        |
...
| Parametro | Tipo                              | Descrizione                  |
| --------- | --------------------------------- | ---------------------------- |
| indice    | string                            | The key to store the data at |
| valore    | [IData](/vanilla/api/data/IData)? | The data to store.           |
...
| Parametro | Tipo | Descrizione          |
| --------- | ---- | -------------------- |
| indice    | int  | The index to remove. |
...
| length  | int                           | sì        | no        | Gets the length of this IData. |
