...
| --------------------- | -------------------------------------------------------------------------- | --------- | --------- |
| backgroundSuffic      | string                                                                     | sì        | no        |
| canScroll             | boolean                                                                    | sì        | no        |
| column                | int                                                                        | sì        | no        |
| commandString         | string                                                                     | sì        | no        |
| displayName           | [Component](/vanilla/api/text/Component)                                   | sì        | no        |
| enchantmentCategories | [EnchantmentCategory](/vanilla/api/item/enchantment/EnchantmentCategory)[] | sì        | no        |
| iconItem              | [IItemStack](/vanilla/api/item/IItemStack)                                 | sì        | no        |
| id                    | int                                                                        | sì        | no        |
| isAlignedRight        | boolean                                                                    | sì        | no        |
| isTopRow              | boolean                                                                    | sì        | no        |
| recipeFolderName      | string                                                                     | sì        | no        |
| showTitle             | boolean                                                                    | sì        | no        |
