...
| ---------- | ------------------------------------------- | --------- | --------- |
| breakSound | [SoundEvent](/vanilla/api/sound/SoundEvent) | sì        | no        |
| fallSound  | [SoundEvent](/vanilla/api/sound/SoundEvent) | sì        | no        |
| hitSound   | [SoundEvent](/vanilla/api/sound/SoundEvent) | sì        | no        |
| pitch      | float                                       | sì        | no        |
| placeSound | [SoundEvent](/vanilla/api/sound/SoundEvent) | sì        | no        |
| stepSound  | [SoundEvent](/vanilla/api/sound/SoundEvent) | sì        | no        |
| volume     | float                                       | sì        | no        |
