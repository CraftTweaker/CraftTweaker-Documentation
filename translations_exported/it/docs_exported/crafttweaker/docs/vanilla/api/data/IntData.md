...
IntData implementa le seguenti interfacce. Ciò significa che ogni metodo presente nell'interfaccia può essere usato anche per questa classe.
...
```zenscript
8192.contiene(dati come crafttweaker.api.data.IData);
8192.contiene("Display");
```
