...
| ------ | -------------------------------- | --------- | --------- | -------------------------------------------------- |
| main   | [Orechid](/mods/Botania/Orechid) | sì        | no        | The manager for the standard Orechid.              |
| nether | [Orechid](/mods/Botania/Orechid) | sì        | no        | The manager for the nether variant, Orechid Ignem. |
