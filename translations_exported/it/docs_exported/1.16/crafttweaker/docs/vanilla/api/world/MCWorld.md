...
| --------------------------------------------------------------- | --------- |
| [MCBlockDisplayReader](/vanilla/api/world/MCBlockDisplayReader) | sì        |
| [MCServerWorld](/vanilla/api/world/MCServerWorld)               | no        |
...
| --------- | -------------------------------------- | ----------------------- | -------- | ------------ |
| pos1      | [BlockPos](/vanilla/api/util/BlockPos) | No Description Provided | no       |              |
| pos2      | [BlockPos](/vanilla/api/util/BlockPos) | No Description Provided | sì       |              |
...
| Parametro       | Tipo                                                                  | Descrizione             | Optional | DefaultValue |
| --------------- | --------------------------------------------------------------------- | ----------------------- | -------- | ------------ |
| excludingEntity | [MCEntity](/vanilla/api/entity/MCEntity)?                             | No Description Provided | no       |              |
| predicate       | Predicate&lt;[MCEntity](/vanilla/api/entity/MCEntity)&gt; | No Description Provided | no       |              |
| pos1            | [BlockPos](/vanilla/api/util/BlockPos)                                | No Description Provided | no       |              |
| pos2            | [BlockPos](/vanilla/api/util/BlockPos)                                | No Description Provided | sì       |              |
...
| Parametro | Tipo                                                          | Descrizione                                                           | Optional | DefaultValue |
| --------- | ------------------------------------------------------------- | --------------------------------------------------------------------- | -------- | ------------ |
| startVec  | [MCVector3d](/vanilla/api/util/MCVector3d)                    | a vector which describes the starting point                           | no       |              |
| endVec    | [MCVector3d](/vanilla/api/util/MCVector3d)                    | a vector which describes the direction and length we are searching in | no       |              |
| blockMode | [RayTraceBlockMode](/vanilla/api/util/math/RayTraceBlockMode) | the type of block that the ray trace would stop at.                   | no       |              |
| fluidMode | [RayTraceFluidMode](/vanilla/api/util/math/RayTraceFluidMode) | the type of fluid that the ray trace would stop at.                   | no       |              |
| entity    | [MCEntity](/vanilla/api/entity/MCEntity)                      | the entity for selection context                                      | sì       |              |
...
| ---------------- | ---------------------------------- | --------- | --------- | --------------------------------------------------------------------------------------------------------------------------------- |
| dayTime          | boolean                            | sì        | no        | Checks if it is day time in the world. Different dimensions will have <br />  different logic for how this is determined.   |
...
| dimension        | string                             | sì        | no        | Gets the registry name of the dimension this world represents.                                                                    |
| gameTime         | long                               | sì        | no        | Gets the current game time in ticks.                                                                                              |
| hardcore         | boolean                            | sì        | no        | Checks if hardcore mode is enabled.                                                                                               |
| nightTime        | boolean                            | sì        | no        | Checks if it is night time in the world. Different dimensions will have <br />  different logic for how this is determined. |
| raining          | boolean                            | sì        | no        | Checks if it is raining.                                                                                                          |
| random           | [Random](/vanilla/api/util/Random) | sì        | no        | No Description Provided                                                                                                           |
| remote           | boolean                            | sì        | no        | Checks if the world is remote. This is always true on the rendering <br />  thread.                                         |
| seaLevel         | int                                | sì        | no        | Gets the height of the sea level.                                                                                                 |
| thundering       | boolean                            | sì        | no        | Checks if there is a thunder storm.                                                                                               |
| timeOfDay        | long                               | sì        | no        | Gets the current time of the day in ticks.                                                                                        |
