...
| ----------------- | --------------------------------------------------------------- | --------- | --------- | ----------------------------------------------------- |
| allowedOnBook     | boolean                                                         | sì        | no        | Check if this Enchantment is allowed on books.        |
| canGenerateInLoot | boolean                                                         | sì        | no        | Checks if this Enchantment can generate in loot.      |
| canVillagerTrade  | boolean                                                         | sì        | no        | Checks if a villager can sell this Enchantment.       |
| curse             | boolean                                                         | sì        | no        | Checks if this Enchantment is a curse Enchantment.    |
| maxLevel          | int                                                             | sì        | no        | Gets the maximum level for this Enchantment.          |
| minLevel          | int                                                             | sì        | no        | Gets the minimum level for this Enchantment.          |
| nome              | string                                                          | sì        | no        | Gets the name of this Enchantment                     |
| rarity            | [EnchantmentRarity](/vanilla/api/enchantment/EnchantmentRarity) | sì        | no        | Gets the Rarity of this Enchantment                   |
| treasure          | boolean                                                         | sì        | no        | Checks if this Enchantment is a treasure Enchantment. |
