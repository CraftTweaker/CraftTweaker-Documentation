...
| ------- | ------------------------------------------------- | --------- | --------- | ----------------------- |
| HIGH    | [EventPriority](/vanilla/api/event/EventPriority) | sì        | no        | No Description Provided |
| HIGHEST | [EventPriority](/vanilla/api/event/EventPriority) | sì        | no        | No Description Provided |
| LOW     | [EventPriority](/vanilla/api/event/EventPriority) | sì        | no        | No Description Provided |
| LOWEST  | [EventPriority](/vanilla/api/event/EventPriority) | sì        | no        | No Description Provided |
| NORMAL  | [EventPriority](/vanilla/api/event/EventPriority) | sì        | no        | No Description Provided |
