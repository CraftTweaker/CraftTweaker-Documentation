...
| ---- | ------------------------------------------------------------ | --------- | --------- | ----------------------- |
| from | [IItemStack](/vanilla/api/items/IItemStack)                  | sì        | no        | No Description Provided |
| slot | [MCEquipmentSlotType](/vanilla/api/util/MCEquipmentSlotType) | sì        | no        | No Description Provided |
| to   | [IItemStack](/vanilla/api/items/IItemStack)                  | sì        | no        | No Description Provided |
