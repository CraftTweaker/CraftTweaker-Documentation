...
| experienceLevel | int                                                       | sì        | no        | No Description Provided |
| experienceTotal | int                                                       | sì        | no        | No Description Provided |
| fake            | boolean                                                   | sì        | no        | No Description Provided |
| foodLevel       | int                                                       | sì        | sì        | No Description Provided |
| inventory       | [PlayerInventory](/vanilla/api/inventory/PlayerInventory) | sì        | no        | No Description Provided |
| nome            | [MCTextComponent](/vanilla/api/util/text/MCTextComponent) | sì        | no        | No Description Provided |
| saturationLevel | float                                                     | sì        | no        | No Description Provided |
