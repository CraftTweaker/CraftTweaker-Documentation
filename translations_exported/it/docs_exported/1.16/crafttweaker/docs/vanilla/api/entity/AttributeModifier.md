...
| operation | [AttributeOperation](/vanilla/api/entity/AttributeOperation) | the operation of this attribute modifier.                                  | no       |              |
...
| operation | [AttributeOperation](/vanilla/api/entity/AttributeOperation) | sì        | no        | Gets the operation of this AttributeModifier. |
