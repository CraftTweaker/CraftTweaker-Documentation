...
| ---------------- | ------------------------------------------- | --------- | --------- | ------------------------------------------------------------------------------------------------------------- |
| absolute         | boolean                                     | sì        | no        | Checks if the damage is absolute.                                                                             |
| bypassCreative   | boolean                                     | sì        | no        | Checks if the damage can bypass creative mode.                                                                |
| creativePlayer   | boolean                                     | sì        | no        | Gets whether the damage was inflicted by a creative player.                                                   |
| difficultyScaled | boolean                                     | sì        | no        | Gets whether the damage changes strength based on the current difficulty.                                     |
| explosion        | boolean                                     | sì        | no        | Checks if the damage is caused by an explosion.                                                               |
| fire             | boolean                                     | sì        | no        | Checks if the damage is caused by fire or burning.                                                            |
| hungerDamage     | float                                       | sì        | no        | Gets the amount of exhaustion to add to the player's hunger bar if they <br />  get hit by this damage. |
| immediateSource  | [MCEntity](/vanilla/api/entity/MCEntity)?   | sì        | no        | Gets the immediate source of the damage, like an arrow.                                                       |
| posizione        | [MCVector3d](/vanilla/api/util/MCVector3d)? | sì        | no        | Gets the location where the damage occurred.                                                                  |
| magic            | boolean                                     | sì        | no        | Checks if the damage is caused by magic.                                                                      |
| projectile       | boolean                                     | sì        | no        | Checks if the damage is caused by a projectile.                                                               |
| trueSource       | [MCEntity](/vanilla/api/entity/MCEntity)?   | sì        | no        | Gets the true source of the damage, like the player who shot the arrow.                                       |
| type             | string                                      | sì        | no        | Gets the type of damage.                                                                                      |
| unblockable      | boolean                                     | sì        | no        | Checks if the damage can be blocked.                                                                          |
