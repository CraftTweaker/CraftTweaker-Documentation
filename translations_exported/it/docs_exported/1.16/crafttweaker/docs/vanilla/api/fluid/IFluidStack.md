...
| ----------------------------------------------------- | --------- |
| [FluidIngredient](/vanilla/api/fluid/FluidIngredient) | sì        |
| [MCFluid](/vanilla/api/fluid/MCFluid)                 | sì        |
...
| ------------- | ---------------------------------------------------------- | --------- | --------- | ---------------------------------------------------------------- |
| amount        | int                                                        | sì        | no        | Gets the fluid amount in MilliBuckets (mB).                      |
| commandString | string                                                     | sì        | no        | Returns the BEP to get this thingy                               |
| empty         | boolean                                                    | sì        | no        | Gets whether or not this fluid stack is empty.                   |
| fluid         | [MCFluid](/vanilla/api/fluid/MCFluid)                      | sì        | no        | Retrieves this fluid stack's fluid.                              |
| hasTag        | boolean                                                    | sì        | no        | Returns true if this FluidStack has a Tag                        |
| isImmutable   | boolean                                                    | sì        | no        | No Description Provided                                          |
| registryName  | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | sì        | no        | Gets the registry name for the fluid this stack is representing. |
| tag           | [IData](/vanilla/api/data/IData)                           | sì        | no        | Returns the NBT tag attached to this FluidStack.                 |
