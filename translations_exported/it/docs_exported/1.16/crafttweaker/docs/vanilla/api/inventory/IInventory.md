...
| --------- | ---- | ---------------------------- | -------- | ------------ |
| indice    | int  | The slot index to decrement. | no       |              |
| count     | int  | How much should be removed.  | sì       | 1            |
...
| Parametro | Tipo | Descrizione                      |
| --------- | ---- | -------------------------------- |
| indice    | int  | The index to get the stack from. |
...
| Parametro | Tipo                                        | Descrizione              |
| --------- | ------------------------------------------- | ------------------------ |
| indice    | int                                         | The slot index to check. |
...
| Parametro | Tipo | Descrizione               |
| --------- | ---- | ------------------------- |
| indice    | int  | The slot index to remove. |
...
| Parametro | Tipo                                        | Descrizione                        |
| --------- | ------------------------------------------- | ---------------------------------- |
| indice    | int                                         | The slot index to set.             |
...
| ------------------- | ------- | --------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| inventorySize       | int     | sì        | no        | Gets how many slots this inventory has. <br />  <br />  Example: <br />  A hopper will return `5`                                                                    |
| inventoryStackLimit | int     | sì        | no        | Gets the max stack size that is allowed in this inventory. <br />  <br />  This is nearly always 64, but some inventories like the Beacon and Compostor have a limit of 1. |
| isEmpty             | boolean | sì        | no        | Checks if this inventory is empty.                                                                                                                                                     |
