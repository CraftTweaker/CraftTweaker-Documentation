...
| item          | [IItemStack](/vanilla/api/items/IItemStack) | sì        | no        | Gets the ItemStack that is being enchanted.                                                                                  |
...
| pos           | [BlockPos](/vanilla/api/util/BlockPos)      | sì        | no        | Gets the position of the Enchanting Table firing this event.                                                                 |
| power         | int                                         | sì        | no        | Gets the Enchanting Power of the Enchanting Table.                                                                           |
| world         | [MCWorld](/vanilla/api/world/MCWorld)       | sì        | no        | Gets the World where the Enchanting Table is.                                                                                |
