...
| ------ | --------------------------------------------------------------- | --------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| hitVec | [MCVector3d](/vanilla/api/util/MCVector3d)                      | sì        | no        | Gets the hit vector of this result.                                                                                                                   |
| type   | [RayTraceResultType](/vanilla/api/util/math/RayTraceResultType) | sì        | no        | Gets the type of this RayTraceResult. This can be used to determine if this is a BlockRayTraceResult, an EntityRayTraceResult or if the trace missed. |
