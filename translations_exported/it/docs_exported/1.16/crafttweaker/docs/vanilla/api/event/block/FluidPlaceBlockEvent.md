...
| ------------- | ----------------------------------------------- | --------- | --------- | -------------------------------------------------------------------------------- |
| fluidPos      | [BlockPos](/vanilla/api/util/BlockPos)          | sì        | no        | Gets the position of the Fluid that fired this event.                            |
| newState      | [MCBlockState](/vanilla/api/block/MCBlockState) | sì        | sì        | Gets the new BlockState that will be placed.                                     |
| originalState | [MCBlockState](/vanilla/api/block/MCBlockState) | sì        | no        | Gets the original BlockState that would have been placed before the event fired. |
