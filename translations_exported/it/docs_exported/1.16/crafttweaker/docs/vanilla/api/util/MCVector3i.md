...
| ------------------------------------------ | --------- |
| [MCVector3d](/vanilla/api/util/MCVector3d) | no        |
...
| ---------------- | ------ | --------- | --------- | ------------------------------------- |
| coordinateString | string | sì        | no        | No Description Provided               |
| x                | int    | sì        | no        | Gets the X coordinate of this vector. |
| y                | int    | sì        | no        | Gets the Y coordinate of this vector. |
| z                | int    | sì        | no        | Gets the Y coordinate of this vector. |
