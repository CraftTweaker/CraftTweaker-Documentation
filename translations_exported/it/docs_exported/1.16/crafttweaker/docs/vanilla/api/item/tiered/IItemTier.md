...
| -------------- | ------------------------------------------ | --------- | --------- | --------------------------------- |
| attackDamage   | float                                      | sì        | no        | Gets this tier's attack damage.   |
| efficiency     | float                                      | sì        | no        | Gets this tier's efficiency.      |
| enchantability | int                                        | sì        | no        | Gets this tier's enchantability.  |
| harvestLevel   | int                                        | sì        | no        | Gets this tier's harvest level.   |
| maxUses        | int                                        | sì        | no        | Gets this tier's max uses.        |
| repairMaterial | [Ingredient](/vanilla/api/item/Ingredient) | sì        | no        | Gets this tier's repair material. |
