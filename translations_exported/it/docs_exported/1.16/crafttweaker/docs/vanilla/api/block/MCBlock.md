...
| ------------------------------------------------------ | --------- |
| [MCItemDefinition](/vanilla/api/item/MCItemDefinition) | no        |
| string                                                 | no        |
...
| --------------- | ------------------------------------------------------------------------------------------------------------------------ | --------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| blastResistance | float                                                                                                                    | sì        | sì        | Gets the blast resistance of this Block.                                                                                                                                                                             |
| canCollide      | boolean                                                                                                                  | sì        | sì        | Checks if entities can collide with this Block.                                                                                                                                                                      |
| commandString   | string                                                                                                                   | sì        | no        | Gets the block bracket handler syntax for this Block. <br />  <br />  E.G. <br />  <code> <br />  <block:minecraft:dirt> <br />  </code>                                                                                         |
| defaultState    | [MCBlockState](/vanilla/api/block/MCBlockState)                                                                          | sì        | no        | Gets the default [MCBlockState](/vanilla/api/block/MCBlockState) of this Block.                                                                                                                                      |
| harvestLevel    | int                                                                                                                      | sì        | sì        | Gets the harvest level for this Block. <br />  <br />  NOTE: <br />  This will get the level for the default blockstate, you should use the BlockState specific method for a more accurate result! |
| harvestTool     | [ToolType](/vanilla/api/tool/ToolType)?                                                                                  | sì        | sì        | Gets the harvest tool for this Block. <br />  <br />  NOTE: <br />  This will get the tool for the default blockstate, you should use the BlockState specific method for a more accurate result!   |
| jumpFactor      | float                                                                                                                    | sì        | sì        | Gets the jump factor of this Block.                                                                                                                                                                                  |
| lootTable       | string                                                                                                                   | sì        | no        | Gets the loot table id for this Block.                                                                                                                                                                               |
| material        | [MCMaterial](/vanilla/api/block/material/MCMaterial)                                                                     | sì        | sì        | Gets the material of this Block.                                                                                                                                                                                     |
| registryName    | [MCResourceLocation](/vanilla/api/util/MCResourceLocation)                                                               | sì        | no        | Gets the registry name of this block.                                                                                                                                                                                |
| slipperiness    | float                                                                                                                    | sì        | sì        | Gets the slipperiness of this Block.                                                                                                                                                                                 |
| speedFactor     | float                                                                                                                    | sì        | sì        | Gets the speed factor of this Block.                                                                                                                                                                                 |
| tags            | stdlib.List&lt;[MCTag](/vanilla/api/tags/MCTag)&lt;[MCBlock](/vanilla/api/block/MCBlock)&gt;&gt; | sì        | no        | Gets all the [MCTag](/vanilla/api/tags/MCTag)&lt;T&gt;s that contain this Block.                                                                                                                         |
| translationKey  | string                                                                                                                   | sì        | no        | Gets the translation key that is used to localize this Block.                                                                                                                                                        |
| validStates     | stdlib.List&lt;[MCBlockState](/vanilla/api/block/MCBlockState)&gt;                                           | sì        | no        | Gets a list of valid [MCBlockState](/vanilla/api/block/MCBlockState)s for this Block.                                                                                                                                |
| variableOpacity | boolean                                                                                                                  | sì        | no        | Checks if the opacity of this block is different in different areas of the Block.                                                                                                                                    |
