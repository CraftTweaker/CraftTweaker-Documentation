...
| --------------- | -------------------------------------------------- | --------- | --------- | ----------------------- |
| IN_LAVA         | [PlacementType](/vanilla/api/entity/PlacementType) | sì        | no        | No Description Provided |
| IN_WATER        | [PlacementType](/vanilla/api/entity/PlacementType) | sì        | no        | No Description Provided |
| NO_RESTRICTIONS | [PlacementType](/vanilla/api/entity/PlacementType) | sì        | no        | No Description Provided |
| ON_GROUND       | [PlacementType](/vanilla/api/entity/PlacementType) | sì        | no        | No Description Provided |
