...
| --------- | --------------------------------------------------------------------- | ------------------------------- | -------- | ------------ |
| predicate | Predicate&lt;[MCEntity](/vanilla/api/entity/MCEntity)&gt; | The predicate to check against. | no       |              |
| type      | [MCEntityType](/vanilla/api/entities/MCEntityType)                    | No Description Provided         | sì       |              |
...
| server    | [MCServer](/vanilla/api/game/MCServer)            | sì        | no        | No Description Provided             |
| timeOfDay | [MCServerWorld](/vanilla/api/world/MCServerWorld) | no        | sì        | Sets the time of the Minecraft day. |
