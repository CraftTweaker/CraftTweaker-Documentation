...
| placedAgainst | [MCBlockState](/vanilla/api/block/MCBlockState) | sì        | no        | No Description Provided |
| placedBlock   | [MCBlockState](/vanilla/api/block/MCBlockState) | sì        | no        | No Description Provided |
| replacedBlock | [MCBlockState](/vanilla/api/block/MCBlockState) | sì        | no        | No Description Provided |
