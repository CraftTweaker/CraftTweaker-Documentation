...
| valore    | boolean | The boolean value the property must have. |
...
| --------- | ------ | ----------------------------------------- |
| nome      | string | The name of the property to check.        |
| valore    | int    | The integer value the property must have. |
...
| --------- | ------ | ---------------------------------------- |
| nome      | string | The name of the property to check.       |
| valore    | string | The string value the property must have. |
