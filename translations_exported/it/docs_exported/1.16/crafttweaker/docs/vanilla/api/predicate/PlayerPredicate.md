...
| Parametro | Tipo                                                       | Descrizione                                |
| --------- | ---------------------------------------------------------- | ------------------------------------------ |
| type      | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's base type.                 |
| nome      | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's unique identifier.         |
...
| type      | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's base type.               |
| nome      | [MCResourceLocation](/vanilla/api/util/MCResourceLocation) | The statistic's unique identifier.       |
| valore    | int                                                        | The exact value the statistic should be. |
...
| Parametro | Tipo   | Descrizione                                     |
| --------- | ------ | ----------------------------------------------- |
| nome      | string | The name of the recipe that needs to be locked. |
...
| Parametro | Tipo   | Descrizione                                       |
| --------- | ------ | ------------------------------------------------- |
| nome      | string | The name of the recipe that needs to be unlocked. |
