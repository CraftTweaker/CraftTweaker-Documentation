...
| ------ | ---------------------------------------- | --------- | --------- | ----------------------------------------------------------------------------------------------------- |
| face   | [Direction](/vanilla/api/util/Direction) | sì        | no        | Gets the face that was hit.                                                                           |
| inside | boolean                                  | sì        | no        | Results if the result is inside of a block. <br />  <br />  This is used for scaffolding. |
| pos    | [BlockPos](/vanilla/api/util/BlockPos)   | sì        | no        | Gets the position that was hit.                                                                       |
