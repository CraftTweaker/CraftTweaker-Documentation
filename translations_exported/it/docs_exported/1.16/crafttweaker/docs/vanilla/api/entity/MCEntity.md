...
| Parametro | Tipo    | Descrizione            |
| --------- | ------- | ---------------------- |
| valore    | boolean | The new sneaking value |
...
| --------- | ---------------------------------------- | ----------------------- | -------- | ------------ |
| other     | [MCEntity](/vanilla/api/entity/MCEntity) | No Description Provided | no       |              |
| forced    | boolean                                  | No Description Provided | sì       | no           |
...
| ---------------- | -------------------------------------------------- | --------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| air              | int                                                | sì        | sì        | Gets the air value for the Entity. <br />  The air value is used to determine when the Entity will start drowning when swimming. |
| canSwim          | boolean                                            | sì        | no        | Checks if this Entity can swim.                                                                                                        |
| data             | [MapData](/vanilla/api/data/MapData)               | sì        | no        | Gets the NBT data of this Entity.                                                                                                      |
| facingDirections | [Direction](/vanilla/api/util/Direction)[]         | sì        | no        | Gets which directions the Entity is currently facing.                                                                                  |
| id               | int                                                | sì        | no        | Gets this Entity's id that can be used to reference this Entity.                                                                       |
| inLava           | boolean                                            | sì        | no        | Checks if this Entity is in lava or not.                                                                                               |
| inWater          | boolean                                            | sì        | no        | Checks if this Entity is in water.                                                                                                     |
| isWet            | boolean                                            | sì        | no        | Checks if this Entity is wet.                                                                                                          |
| nome             | string                                             | sì        | no        | Gets the name of the Entity.                                                                                                           |
| onGround         | [MCEntity](/vanilla/api/entity/MCEntity)           | sì        | sì        | Sets if the Entity should be considered on the ground or not.                                                                          |
| persistedData    | [MapData](/vanilla/api/data/MapData)               | sì        | no        | Gets the persisted NBT tag.                                                                                                            |
| position         | [BlockPos](/vanilla/api/util/BlockPos)             | sì        | no        | Gets this Entity's position in the world.                                                                                              |
| positionVec      | [MCVector3d](/vanilla/api/util/MCVector3d)         | sì        | no        | No Description Provided                                                                                                                |
| rotationPitch    | float                                              | sì        | sì        | No Description Provided                                                                                                                |
| rotationYaw      | float                                              | sì        | sì        | No Description Provided                                                                                                                |
| silent           | boolean                                            | sì        | sì        | Checks if this Entity is silent. <br />  <br />  Silent Entities do not play sounds.                                       |
| sneaking         | boolean                                            | sì        | sì        | Checks if this Entity is sneaking or not.                                                                                              |
| spectator        | boolean                                            | sì        | no        | Checks if this Entity is in spectator mode.                                                                                            |
| type             | [MCEntityType](/vanilla/api/entities/MCEntityType) | sì        | no        | Gets this Entity's type.                                                                                                               |
| uuid             | string                                             | sì        | no        | Gets the UUID of this Entity.                                                                                                          |
| world            | [MCWorld](/vanilla/api/world/MCWorld)              | sì        | no        | Gets the World that this Entity is in.                                                                                                 |
