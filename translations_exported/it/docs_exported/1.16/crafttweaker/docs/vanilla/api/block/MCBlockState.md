...
| ------------------------------------- | --------- |
| [MCBlock](/vanilla/api/block/MCBlock) | sì        |
| string                                | no        |
...
| --------- | ---------------------------------------- | ------------------------------- | -------- | ------------ |
| world     | [MCWorld](/vanilla/api/world/MCWorld)    | A world object.                 | no       |              |
| pos       | [BlockPos](/vanilla/api/util/BlockPos)   | The position of the BlockState. | no       |              |
| side      | [Direction](/vanilla/api/util/Direction) | The side to check for.          | sì       |              |
...
| --------- | ---------------------------------------- | ------------------------- | -------- | ------------ |
| world     | [MCWorld](/vanilla/api/world/MCWorld)    | A world object.           | no       |              |
| pos       | [BlockPos](/vanilla/api/util/BlockPos)   | The position to check at. | no       |              |
| entity    | [MCEntity](/vanilla/api/entity/MCEntity) | The entity to work with.  | sì       |              |
...
| world     | [MCWorld](/vanilla/api/world/MCWorld)                | A world object.                            | no       |              |
| pos       | [BlockPos](/vanilla/api/util/BlockPos)               | The position to check at.                  | no       |              |
| sleeper   | [MCLivingEntity](/vanilla/api/entity/MCLivingEntity) | The Living Entity that is trying to sleep. | sì       |              |
...
| --------------- | --------------------------------------- | --------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| block           | [MCBlock](/vanilla/api/block/MCBlock)   | sì        | no        | Gets the base [MCBlock](/vanilla/api/block/MCBlock) of this BlockState. <br />  <br />  The [MCBlock](/vanilla/api/block/MCBlock) will not contain any of the properties of this BlockState.                                 |
| canProvidePower | boolean                                 | sì        | no        | Checks whether this BlockState can provide Redstone Power                                                                                                                                                                                |
...
| hardness        | float                                   | sì        | sì        | Gets the hardness of this BlockState.                                                                                                                                                                                                    |
| harvestLevel    | int                                     | sì        | no        | Gets the harvest level of this BlockState.                                                                                                                                                                                               |
| harvestTool     | [ToolType](/vanilla/api/tool/ToolType)? | sì        | no        | Gets the [ToolType](/vanilla/api/tool/ToolType) of this BlockState.                                                                                                                                                                      |
| hasTileEntity   | boolean                                 | sì        | no        | Checks whether this BlockState has a [MCTileEntity](/vanilla/api/tileentity/MCTileEntity).                                                                                                                                               |
| isSlime         | boolean                                 | sì        | no        | Checks if this BlockState is a Slime Block.                                                                                                                                                                                              |
| isSolid         | boolean                                 | sì        | no        | Checks whether this BlockState is solid.                                                                                                                                                                                                 |
| isSticky        | boolean                                 | sì        | no        | Checks if this BlockState is sticky. <br />  <br />  This is used to determine if the block should pull or push adjacent blocks when pushed / pulled by a piston. <br />  For example, Slime Blocks are sticky blocks. |
| lightLevel      | int                                     | sì        | no        | Gets the light level of this BlockState                                                                                                                                                                                                  |
| propertyNames   | stdlib.List&lt;string&gt;   | sì        | no        | Gets the names of the properties of this BlockState.                                                                                                                                                                                     |
| ticksRandomly   | boolean                                 | sì        | no        | Checks whether this BlockState ticks randomly.                                                                                                                                                                                           |
