...
| --------- | ------------------------------------------------ | ---------------------------------------------------- | -------- | ----------------------------------- |
| modId     | string                                           | The mod ID of the ingredients that should be hidden. | no       |                                     |
| esclude   | [RecipeFilter](/vanilla/api/recipe/RecipeFilter) | An optional exclusion filter.                        | sì       | (name as string) => {return false;} |
