...
| nome      | [MCTextComponent](/vanilla/api/util/text/MCTextComponent)       | A [MCTextComponent](/vanilla/api/util/text/MCTextComponent) representing the name of the category.                                    |
...
| catalysts  | [JeiIngredient](/mods/JEITweaker/API/Component/JeiIngredient)[] | sì        | no        | Gets the lists of catalysts currently registered to this category.                                                             |
| icon       | [JeiDrawable](/mods/JEITweaker/API/Component/JeiDrawable)       | sì        | no        | Gets the [JeiDrawable](/mods/JEITweaker/API/Component/JeiDrawable) that acts as the icon for this category.                    |
| id         | [MCResourceLocation](/vanilla/api/util/MCResourceLocation)      | sì        | no        | Gets the ID of the category.                                                                                                   |
| nome       | [MCTextComponent](/vanilla/api/util/text/MCTextComponent)       | sì        | no        | Gets the name of the category.                                                                                                 |
