...
Istruisce il CoT che questo blocco non bloccherà il movimento. Imposterà anche il blocco come [mods.contenttweaker.block.BlockBuilder#notSolid()](/mods/contenttweaker/API/block/BlockBuilder/#notsolid)
