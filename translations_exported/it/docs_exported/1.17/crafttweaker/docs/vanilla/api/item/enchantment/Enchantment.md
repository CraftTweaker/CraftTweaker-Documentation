...
| Parametro | Tipo                                             | Descrizione             |
| --------- | ------------------------------------------------ | ----------------------- |
| sorgente  | [LivingEntity](/vanilla/api/entity/LivingEntity) | No Description Provided |
...
| isCurse        | boolean                                        | sì        | no        | No Description Provided |
| isDiscoverable | boolean                                        | sì        | no        | No Description Provided |
| isTradeable    | boolean                                        | sì        | no        | No Description Provided |
| isTreasureOnly | boolean                                        | sì        | no        | No Description Provided |
| maxLevel       | int                                            | sì        | no        | No Description Provided |
| minLevel       | int                                            | sì        | no        | No Description Provided |
| rarity         | [Rarity](/vanilla/api/item/enchantment/Rarity) | sì        | no        | No Description Provided |
