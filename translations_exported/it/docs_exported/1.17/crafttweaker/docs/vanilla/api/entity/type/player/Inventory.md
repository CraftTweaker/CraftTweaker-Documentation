...
| ------------------ | ---------------------------------------- | --------- | --------- | ----------------------- |
| freeSlot           | int                                      | sì        | no        | No Description Provided |
| selected           | [ItemStack](/vanilla/api/item/ItemStack) | sì        | no        | No Description Provided |
| suitableHotbarSlot | int                                      | sì        | no        | No Description Provided |
| timesChanged       | int                                      | sì        | no        | No Description Provided |
