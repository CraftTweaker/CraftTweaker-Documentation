...
| ------------------- | -------------------------------------------------------------------------- | --------- | --------- | ---------------------------------------------------------------------------------------------------------------------------- |
| canCollide          | [Block](/vanilla/api/block/Block)                                          | no        | sì        | Sets whether entities can collide with this Block.                                                                           |
...
| hasCollision        | boolean                                                                    | sì        | no        | Checks if entities can collide with this Block.                                                                              |
...
| validStates         | stdlib.List&lt;[BlockState](/vanilla/api/block/BlockState)&gt; | sì        | no        | Gets a list of valid [BlockState](/vanilla/api/block/BlockState)s for this Block.                                            |
