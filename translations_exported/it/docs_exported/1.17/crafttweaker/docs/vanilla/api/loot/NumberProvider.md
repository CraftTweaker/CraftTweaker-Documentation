...
| --------- | ---------------------------------------------- | ----------------------- | -------- | ------------ |
| target    | [EntityTarget](/vanilla/api/loot/EntityTarget) | No Description Provided | no       |              |
| score     | string                                         | No Description Provided | no       |              |
| scale     | float                                          | No Description Provided | sì       | 1.0          |
