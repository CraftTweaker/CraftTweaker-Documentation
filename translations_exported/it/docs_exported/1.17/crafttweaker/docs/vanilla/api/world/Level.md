...
| --------------------------------------------- | --------- |
| [ServerLevel](/vanilla/api/world/ServerLevel) | no        |
...
| --------- | ------------------------------------------- | ----------------------- | -------- | ------------ |
| pos1      | [BlockPos](/vanilla/api/util/math/BlockPos) | No Description Provided | no       |              |
| pos2      | [BlockPos](/vanilla/api/util/math/BlockPos) | No Description Provided | sì       |              |
...
| Parametro       | Tipo                                                              | Descrizione             | Optional | DefaultValue |
| --------------- | ----------------------------------------------------------------- | ----------------------- | -------- | ------------ |
| excludingEntity | [Entity](/vanilla/api/entity/Entity)                              | No Description Provided | no       |              |
| predicate       | Predicate&lt;[Entity](/vanilla/api/entity/Entity)&gt; | No Description Provided | no       |              |
| pos1            | [BlockPos](/vanilla/api/util/math/BlockPos)                       | No Description Provided | no       |              |
| pos2            | [BlockPos](/vanilla/api/util/math/BlockPos)                       | No Description Provided | sì       |              |
...
| ---------------- | ---------------------------------------------------------- | --------- | --------- | -------------------------------------------------------------- |
| daytime          | long                                                       | sì        | no        | No Description Provided                                        |
...
| gameTime         | long                                                       | sì        | no        | No Description Provided                                        |
| hardcore         | boolean                                                    | sì        | no        | Checks if hardcore mode is enabled.                            |
| isClientSide     | boolean                                                    | sì        | no        | No Description Provided                                        |
| isDay            | boolean                                                    | sì        | no        | No Description Provided                                        |
| isNight          | boolean                                                    | sì        | no        | No Description Provided                                        |
