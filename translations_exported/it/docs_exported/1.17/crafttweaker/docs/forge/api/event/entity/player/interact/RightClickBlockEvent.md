...
| -------- | -------------------------------------------------- | --------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| face     | [Direction](/vanilla/api/util/direction/Direction) | sì        | no        | The face of the block that was clicked <br />  Unlike in [PlayerInteractEvent](/forge/api/event/entity/player/interact/PlayerInteractEvent) this is known not to be null |
| hitVec   | [BlockHitResult](/vanilla/api/util/BlockHitResult) | sì        | no        | No Description Provided                                                                                                                                                        |
| useBlock | [EventResult](/forge/api/event/EventResult)        | sì        | sì        | No Description Provided                                                                                                                                                        |
| useItem  | [EventResult](/forge/api/event/EventResult)        | sì        | sì        | No Description Provided                                                                                                                                                        |
