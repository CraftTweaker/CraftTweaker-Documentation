...
| pearlEntity  | [ThrownEnderpearl](/vanilla/api/entity/type/projectile/ThrownEnderpearl) | sì        | no        | No Description Provided |
| player       | **invalid**                                                              | sì        | no        | No Description Provided |
