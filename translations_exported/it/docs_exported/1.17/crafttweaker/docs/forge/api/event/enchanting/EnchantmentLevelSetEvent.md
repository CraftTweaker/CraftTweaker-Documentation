...
| level         | int                                         | sì        | sì        | Gets the current level of the enchantment for this row. <br />  <br />  This value can be changed by other mods. |
...
| world         | [Level](/vanilla/api/world/Level)           | sì        | no        | Gets the Level where the Enchanting Table is.                                                                                |
