...
| ---- | ------------------------------------------------------------ | --------- | --------- | ----------------------- |
| from | [IItemStack](/vanilla/api/item/IItemStack)                   | sì        | no        | No Description Provided |
| slot | [EquipmentSlot](/vanilla/api/entity/equipment/EquipmentSlot) | sì        | no        | No Description Provided |
| to   | [IItemStack](/vanilla/api/item/IItemStack)                   | sì        | no        | No Description Provided |
