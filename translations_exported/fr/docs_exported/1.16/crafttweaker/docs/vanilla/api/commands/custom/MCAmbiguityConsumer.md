...
| ---------- | ------------------------------------------------------- | ----------------------- |
| parent     | [Noeud MC:](/vanilla/api/commands/custom/MCCommandNode) | No Description Provided |
| enfant     | [Noeud MC:](/vanilla/api/commands/custom/MCCommandNode) | No Description Provided |
