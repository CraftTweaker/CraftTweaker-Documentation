...
| types d'entités | stdlib.List&lt;[MCEntityType](/vanilla/api/entities/MCEntityType)&gt; | true       | false      | Finds all EntityTypes registered for that mod                                                                                                                                                               |
...
| espace de noms  | string                                                                            | true       | false      | Gets the namespace of the mod                                                                                                                                                                               |
