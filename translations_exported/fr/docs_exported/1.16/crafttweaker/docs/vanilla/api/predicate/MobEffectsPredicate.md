...
| constructeur | Consumer&lt;[EffectData](/vanilla/api/predicate/EffectData)&gt; | A consumer to configure the [EffectData](/vanilla/api/predicate/EffectData) for the given effect. |
