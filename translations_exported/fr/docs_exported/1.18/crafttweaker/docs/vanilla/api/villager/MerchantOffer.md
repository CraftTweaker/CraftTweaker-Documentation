...
| --------------- | -------------------------------------------------- | ----------------------- |
| baseCostA       | [format@@0 ItemStack](/vanilla/api/item/ItemStack) | No description provided |
| result          | [format@@0 ItemStack](/vanilla/api/item/ItemStack) | No description provided |
...
| --------------- | -------------------------------------------------- | ----------------------- |
| baseCostA       | [format@@0 ItemStack](/vanilla/api/item/ItemStack) | No description provided |
| costB           | [format@@0 ItemStack](/vanilla/api/item/ItemStack) | No description provided |
| result          | [format@@0 ItemStack](/vanilla/api/item/ItemStack) | No description provided |
| maxUses         | int                                                | No description provided |
| xp              | int                                                | No description provided |
| priceMultiplier | float                                              | No description provided |
