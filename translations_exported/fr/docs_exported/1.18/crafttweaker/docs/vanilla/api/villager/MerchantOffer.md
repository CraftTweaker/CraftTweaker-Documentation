...
| Parameter       | Type                                               |
| --------------- | -------------------------------------------------- |
| baseCostA       | [format@@0 ItemStack](/vanilla/api/item/ItemStack) |
| result          | [format@@0 ItemStack](/vanilla/api/item/ItemStack) |
| maxUses         | int                                                |
| xp              | int                                                |
...
| --------------- | -------------------------------------------------- |
| baseCostA       | [format@@0 ItemStack](/vanilla/api/item/ItemStack) |
| costB           | [format@@0 ItemStack](/vanilla/api/item/ItemStack) |
| result          | [format@@0 ItemStack](/vanilla/api/item/ItemStack) |
| maxUses         | int                                                |
| xp              | int                                                |
| priceMultiplier | float                                              |
