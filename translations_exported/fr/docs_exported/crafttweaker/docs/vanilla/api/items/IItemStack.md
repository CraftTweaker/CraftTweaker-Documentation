...
| Parameter | Type                                                                                            | Description             |
| --------- | ----------------------------------------------------------------------------------------------- | ----------------------- |
| function  | [format@@0 crafttweaker.api.item.tooltip.ITooltipFunction](/vanilla/api/items/ITooltipFunction) | No description provided |
...
| [format@@0 crafttweaker.api.item.MCWeightedItemStack](/vanilla/api/items/MCWeightedItemStack) | true        |
