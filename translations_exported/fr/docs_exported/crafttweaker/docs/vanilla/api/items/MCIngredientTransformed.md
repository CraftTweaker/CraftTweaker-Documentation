# Transformée par MCIngredientTransformé
...
```zenscript
crafttweaker.api.item.MCIngredientTransformé
```

## Interfaces implémentées
MCIngredientTransformé implémente les interfaces suivantes. Cela signifie que toutes les méthodes disponibles peuvent également être utilisées dans cette classe.
...
| transformateur     | [crafttweaker.api.item.IIngredientTransformer](/vanilla/api/items/IIngredientTransformer)&lt;T&gt; | vrai        | Faux        |
