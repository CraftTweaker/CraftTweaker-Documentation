...
MCIngredientConditioned implémente les interfaces suivantes. That means all methods defined in these interfaces are also available in MCIngredientConditioned
