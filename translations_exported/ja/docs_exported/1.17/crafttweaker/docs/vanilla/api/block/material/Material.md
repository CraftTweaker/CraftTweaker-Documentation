...
| --------------- | ---------------------------------------------------------- | ---------- | ---------- | ----------------------------------------- |
| blocksMotion    | boolean型                                                   | true       | false      | No Description Provided                   |
...
| isFlammable     | boolean型                                                   | true       | false      | No Description Provided                   |
| isLiquid        | boolean型                                                   | true       | false      | No Description Provided                   |
| isReplaceable   | boolean型                                                   | true       | false      | No Description Provided                   |
| isSolid         | boolean型                                                   | true       | false      | No Description Provided                   |
| isSolidBlocking | boolean型                                                   | true       | false      | No Description Provided                   |
