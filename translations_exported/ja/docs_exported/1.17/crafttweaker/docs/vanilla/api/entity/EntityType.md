...
| alignPosition | boolean型                                         | No Description Provided |
| invertY       | boolean型                                         | No Description Provided |
...
| --------------------- | ---------------------------------------------------------- | ---------- | ---------- | ----------------------- |
| canSpawnFarFromPlayer | boolean型                                                   | true       | false      | No Description Provided |
| canSummon             | boolean型                                                   | true       | false      | No Description Provided |
