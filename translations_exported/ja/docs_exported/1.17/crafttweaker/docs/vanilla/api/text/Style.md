...
| Parameter | Type                             | Description             |
| --------- | -------------------------------- | ----------------------- |
| スタイル      | [Style](/vanilla/api/text/Style) | No Description Provided |
...
| Parameter | Type                                               | Description             |
| --------- | -------------------------------------------------- | ----------------------- |
| 書式設定      | [ChatFormatting](/vanilla/api/text/ChatFormatting) | No Description Provided |
...
| Parameter | Type        | Description             |
| --------- | ----------- | ----------------------- |
| コンテンツ     | **invalid** | No Description Provided |
...
| ------------- | ---------------------------------------------------------- | ---------- | ---------- | ----------------------- |
| bold          | boolean型                                                   | true       | false      | No Description Provided |
| color         | [TextColor](/vanilla/api/text/TextColor)                   | true       | false      | No Description Provided |
| empty         | boolean型                                                   | true       | false      | No Description Provided |
| font          | [ResourceLocation](/vanilla/api/resource/ResourceLocation) | true       | false      | No Description Provided |
| 挿入            | **invalid**                                                | true       | false      | No Description Provided |
| italic        | boolean型                                                   | true       | false      | No Description Provided |
| obfucated     | boolean型                                                   | true       | false      | No Description Provided |
| strikethrough | boolean型                                                   | true       | false      | No Description Provided |
| 下線付き          | boolean型                                                   | true       | false      | No Description Provided |
