...
| isRecentlyHit | boolean型                                                                  | true       | false      | Whether the Entity doing the drop has recently been damaged.                                                                                                                                                                          |
| lootingLevel  | int                                                                       | true       | false      | No Description Provided                                                                                                                                                                                                               |
| ソース           | [DamageSource](/vanilla/api/world/DamageSource)                           | true       | false      | No Description Provided                                                                                                                                                                                                               |
