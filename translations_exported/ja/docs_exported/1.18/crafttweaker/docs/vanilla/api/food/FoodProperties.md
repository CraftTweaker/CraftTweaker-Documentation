...
| Parameter    | Type     | Description             |
| ------------ | -------- | ----------------------- |
| canAlwaysEat | boolean型 | No Description Provided |
...
| Parameter | Type     | Description             |
| --------- | -------- | ----------------------- |
| fastFood  | boolean型 | No Description Provided |
...
| Parameter | Type     | Description             |
| --------- | -------- | ----------------------- |
| isMeat    | boolean型 | No Description Provided |
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------- | ----------------------- |
| canAlwaysEat       | boolean型                                                                                                                                                  | true       | true       | No Description Provided |
...
| isFastFood         | boolean型                                                                                                                                                  | true       | true       | No Description Provided |
| isMeat             | boolean型                                                                                                                                                  | true       | true       | No Description Provided |
