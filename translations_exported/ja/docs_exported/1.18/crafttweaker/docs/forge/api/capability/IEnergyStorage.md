...
| simulate   | boolean型 | If the energy should actually be extracted or not. |
...
| simulate   | boolean型 | If the energy should actually be inserted or not. |
...
| --------------- | -------- | ---------- | ---------- | ---------------------------------------------------- |
| canExtract      | boolean型 | true       | false      | Checks if energy can be extracted from this storage. |
| canReceive      | boolean型 | true       | false      | Checks if this storage can receive energy.           |
