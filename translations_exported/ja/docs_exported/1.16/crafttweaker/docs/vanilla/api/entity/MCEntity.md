...
| Parameter | Type     | Description            |
| --------- | -------- | ---------------------- |
| noGravity | boolean型 | The new gravity value. |
...
| Parameter | Type     | Description                            |
| --------- | -------- | -------------------------------------- |
| grounded  | boolean型 | If the Entity is on the ground or not. |
...
| Parameter | Type     | Description                            |
| --------- | -------- | -------------------------------------- |
| isSilent  | boolean型 | If the Entity should be silent or not. |
...
| Parameter | Type     | Description            |
| --------- | -------- | ---------------------- |
| value     | boolean型 | The new sneaking value |
...
| forced    | boolean型                                 | No Description Provided | true     | false        |
...
| canSwim          | boolean型                                           | true       | false      | Checks if this Entity can swim.                                                                                                        |
...
| inLava           | boolean型                                           | true       | false      | Checks if this Entity is in lava or not.                                                                                               |
| inWater          | boolean型                                           | true       | false      | Checks if this Entity is in water.                                                                                                     |
| isWet            | boolean型                                           | true       | false      | Checks if this Entity is wet.                                                                                                          |
...
| silent           | boolean型                                           | true       | true       | Checks if this Entity is silent. <br />  <br />  Silent Entities do not play sounds.                                       |
| sneaking         | boolean型                                           | true       | true       | Checks if this Entity is sneaking or not.                                                                                              |
| spectator        | boolean型                                           | true       | false      | Checks if this Entity is in spectator mode.                                                                                            |
