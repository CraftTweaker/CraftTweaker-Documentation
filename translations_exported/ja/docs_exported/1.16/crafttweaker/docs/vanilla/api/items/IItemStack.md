...
| Parameter    | Type     | Description                        |
| ------------ | -------- | ---------------------------------- |
| immuneToFire | boolean型 | Should the item be immune to fire. |
...
| Parameter | Type                                                      | Description |
| --------- | --------------------------------------------------------- | ----------- |
| テキスト      | [MCTextComponent](/vanilla/api/util/text/MCTextComponent) | stackの新しい名前 |
...
| damageable     | boolean型                                                      | true       | false      | Returns if the ItemStack is damageable <br />  I.E Swords and tools are damageable, sticks are not.                                    |
...
| hasDisplayName | boolean型                                                      | true       | false      | Returns true if the ItemStack has a display name.                                                                                            |
| hasEffect      | boolean型                                                      | true       | false      | Returns true if this ItemStack has an effect.                                                                                                |
...
| isCrossbow     | boolean型                                                      | true       | false      | Returns true if this stack is considered a crossbow item                                                                                     |
| isEnchantable  | boolean型                                                      | true       | false      | Can this ItemStack be enchanted?                                                                                                             |
| isEnchanted    | boolean型                                                      | true       | false      | Is this ItemStack enchanted?                                                                                                                 |
| isImmutable    | boolean型                                                      | true       | false      | No Description Provided                                                                                                                      |
