...
| ---------------- | ------------------------------------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------- |
| absolute         | boolean型                                    | true       | false      | Checks if the damage is absolute.                                                                             |
| bypassCreative   | boolean型                                    | true       | false      | Checks if the damage can bypass creative mode.                                                                |
| creativePlayer   | boolean型                                    | true       | false      | Gets whether the damage was inflicted by a creative player.                                                   |
| difficultyScaled | boolean型                                    | true       | false      | Gets whether the damage changes strength based on the current difficulty.                                     |
| explosion        | boolean型                                    | true       | false      | Checks if the damage is caused by an explosion.                                                               |
| fire             | boolean型                                    | true       | false      | Checks if the damage is caused by fire or burning.                                                            |
...
| 場所               | [MCVector3d](/vanilla/api/util/MCVector3d)? | true       | false      | Gets the location where the damage occurred.                                                                  |
| magic            | boolean型                                    | true       | false      | Checks if the damage is caused by magic.                                                                      |
| projectile       | boolean型                                    | true       | false      | Checks if the damage is caused by a projectile.                                                               |
...
| unblockable      | boolean型                                    | true       | false      | Checks if the damage can be blocked.                                                                          |
