...
| canCollide      | boolean型                                                                                                                 | true       | true       | Checks if entities can collide with this Block.                                                                                                                                                                      |
...
| variableOpacity | boolean型                                                                                                                 | true       | false      | Checks if the opacity of this block is different in different areas of the Block.                                                                                                                                    |
