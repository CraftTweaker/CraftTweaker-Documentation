...
| ----------------- | --------------------------------------------------------------- | ---------- | ---------- | ----------------------------------------------------- |
| allowedOnBook     | boolean型                                                        | true       | false      | Check if this Enchantment is allowed on books.        |
| canGenerateInLoot | boolean型                                                        | true       | false      | Checks if this Enchantment can generate in loot.      |
| canVillagerTrade  | boolean型                                                        | true       | false      | Checks if a villager can sell this Enchantment.       |
| curse             | boolean型                                                        | true       | false      | Checks if this Enchantment is a curse Enchantment.    |
...
| treasure          | boolean型                                                        | true       | false      | Checks if this Enchantment is a treasure Enchantment. |
