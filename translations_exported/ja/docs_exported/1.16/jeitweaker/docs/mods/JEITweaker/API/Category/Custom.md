...
| isInput   | boolean型 | Whether the slot is an input (`true`) or an output (`false`) slot. |
...
| テキスト      | [MCTextComponent](/vanilla/api/util/text/MCTextComponent) | The text that should appear.                   |
...
| テキスト      | [MCTextComponent](/vanilla/api/util/text/MCTextComponent)[] | A list of [MCTextComponent](/vanilla/api/util/text/MCTextComponent)s indicating the text that should be present in the tooltip. |
