...
| ----------- | ------------------------------------------- | ---------------------------------------------------------- |
| stack       | [IItemStack](/vanilla/api/items/IItemStack) | The stack that should be matched.                          |
| matchDamage | boolean型                                    | Whether to consider damage or not when matching the stack. |
...
| stack       | [IItemStack](/vanilla/api/items/IItemStack) | The stack that should be matched.                              |
| matchDamage | boolean型                                    | Whether to consider damage or not when matching the stack.     |
| matchCount  | boolean型                                    | Whether to consider the amount or not when matching the stack. |
...
| matchDamage | boolean型                                    | Whether to consider damage or not when matching the stack.       |
| matchCount  | boolean型                                    | Whether to consider the amount or not when matching the stack.   |
| matchNbt    | boolean型                                    | Whether to consider the NBT data or not when matching the stack. |
...
| Parameter | Type                                                                                            | Description                                                                                                        |
| --------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| ビルダー:     | Consumer&lt;[EnchantmentPredicate](/vanilla/api/predicate/EnchantmentPredicate)&gt; | A consumer that will be used to configure the [EnchantmentPredicate](/vanilla/api/predicate/EnchantmentPredicate). |
