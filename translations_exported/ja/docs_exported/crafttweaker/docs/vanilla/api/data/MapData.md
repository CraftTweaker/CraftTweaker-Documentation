...
戻り値の型: [crafttweaker.api.data.MapData](/vanilla/api/data/MapData)
...
Adds は、与えられたキーの値を設定するか、それ以前に存在しなかった場合に新しいエントリを作成します。
 ...
 戻り値: `前の値が存在する場合はnull、それ以外の場合はnull`
