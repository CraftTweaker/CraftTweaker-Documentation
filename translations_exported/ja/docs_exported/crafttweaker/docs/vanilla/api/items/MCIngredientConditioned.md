...
```zenscript
crafttweaker.api.item.MCIngredientConditional
```

## Implemented Interfaces
MCIngredientConditioned は以下のインターフェイスを実装しています。 That means any method available to them can also be used on this class.
...
| 条件             | [crafttweaker.api.item.IIngredientTransformer](/vanilla/api/items/IIngredientTransformer)&lt;T&gt; | true       | false      |
