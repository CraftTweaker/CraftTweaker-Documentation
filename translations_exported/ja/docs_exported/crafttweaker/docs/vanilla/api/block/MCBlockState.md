...
| occupied  | boolean型                                             | If the bed is occupied or not.              |
...
| canProvidePower | boolean型                                | true       | false      | Checks whether this BlockState can provide Redstone Power                                                                                                                                                                                |
...
| hasTileEntity   | boolean型                                | true       | false      | Checks whether this BlockState has a [MCTileEntity](/vanilla/api/tileentity/MCTileEntity).                                                                                                                                               |
| isSlime         | boolean型                                | true       | false      | Checks if this BlockState is a Slime Block.                                                                                                                                                                                              |
| isSolid         | boolean型                                | true       | false      | Checks whether this BlockState is solid.                                                                                                                                                                                                 |
| isSticky        | boolean型                                | true       | false      | Checks if this BlockState is sticky. <br />  <br />  This is used to determine if the block should pull or push adjacent blocks when pushed / pulled by a piston. <br />  For example, Slime Blocks are sticky blocks. |
...
| ticksRandomly   | boolean型                                | true       | false      | Checks whether this BlockState ticks randomly.                                                                                                                                                                                           |
