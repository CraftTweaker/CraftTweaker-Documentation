...
| Parameter  | Type     | Description                           |
| ---------- | -------- | ------------------------------------- |
| canCollide | boolean型 | Can entities collide with this Block. |
...
| dynamicShape              | boolean型                                                                   | true       | false      | Checks if the opacity of this block is different in different areas of the Block.                                                         |
...
| hasCollision              | boolean型                                                                   | true       | true       | Checks if entities can collide with this Block.                                                                                           |
| isPossibleToRespawnInThis | boolean型                                                                   | true       | false      | Checks if an entity can be spawned inside this Block. <br />  <br />  This is used to find valid spawn locations for players. |
