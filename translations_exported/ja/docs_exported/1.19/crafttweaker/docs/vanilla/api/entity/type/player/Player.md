...
| ソース       | [SoundSource](/vanilla/api/sound/SoundSource) |
| volume    | float                                         |
| pitch     | float                                         |
...
| Parameter | Type                                     |
| --------- | ---------------------------------------- |
| テキスト      | [Component](/vanilla/api/text/Component) |
...
| canUseGameMasterBlocks         | boolean型                                               | true       | false      |
...
| isCreative                     | boolean型                                               | true       | false      |
| isHurt                         | boolean型                                               | true       | false      |
| isLocalPlayer                  | boolean型                                               | true       | false      |
| isReducedDebugInfo             | boolean型                                               | true       | false      |
| isScoping                      | boolean型                                               | true       | false      |
| isSecondaryUseActive           | boolean型                                               | true       | false      |
| isSleepingLongEnough           | boolean型                                               | true       | false      |
| luck                           | float                                                  | true       | false      |
| mainArm                        | [HumanoidArm](/vanilla/api/entity/HumanoidArm)         | true       | false      |
| mayBuild                       | boolean型                                               | true       | false      |
