...
| doesBypassArmor      | boolean型                              | true       | false      |
| doesBypassInvul      | boolean型                              | true       | false      |
| doesBypassMagic      | boolean型                              | true       | false      |
| doesDamageHelmet     | boolean型                              | true       | false      |
| entity               | [Entity](/vanilla/api/entity/Entity)? | true       | false      |
| foodExhaustion       | float                                 | true       | false      |
| isCreativePlayer     | boolean型                              | true       | false      |
| isExplosion          | boolean型                              | true       | false      |
| isFall               | boolean型                              | true       | false      |
| isFire               | boolean型                              | true       | false      |
| isMagic              | boolean型                              | true       | false      |
| isNoAggro            | boolean型                              | true       | false      |
| isProjectile         | boolean型                              | true       | false      |
| msgId                | string                                | true       | false      |
| scalesWithDifficulty | boolean型                              | true       | false      |
| ソース                  | [Vec3](/vanilla/api/util/math/Vec3)?  | true       | false      |
