...
| canOcclude        | boolean型                                  | true       | false      | Checks whether this BlockState is solid.                                                                                                                                                         |
...
| hasBlockEntity    | boolean型                                  | true       | false      | Checks whether this BlockState has a [BlockEntity](/vanilla/api/block/entity/BlockEntity).                                                                                                       |
| isRandomlyTicking | boolean型                                  | true       | false      | Checks whether this BlockState ticks randomly.                                                                                                                                                   |
| isSignalSource    | boolean型                                  | true       | false      | Checks whether this BlockState can provide Redstone Power                                                                                                                                        |
