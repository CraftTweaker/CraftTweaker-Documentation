...
| --------------- | ---------------------------------------------------------- | ---------- | ---------- | ----------------------------------------- |
| blocksMotion    | boolean型                                                   | true       | false      |                                           |
...
| isFlammable     | boolean型                                                   | true       | false      |                                           |
| isLiquid        | boolean型                                                   | true       | false      |                                           |
| isReplaceable   | boolean型                                                   | true       | false      |                                           |
| isSolid         | boolean型                                                   | true       | false      |                                           |
| isSolidBlocking | boolean型                                                   | true       | false      |                                           |
