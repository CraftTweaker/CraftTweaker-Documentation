...
| Parameter | Type     | Description            |
| --------- | -------- | ---------------------- |
| crit      | boolean型 | The crit value to set. |
...
| Parameter | Type     | Description                       |
| --------- | -------- | --------------------------------- |
| noPhysics | boolean型 | If this arrow has physics or not. |
...
| Parameter        | Type     | Description                                    |
| ---------------- | -------- | ---------------------------------------------- |
| shotFromCrossbow | boolean型 | If this arrow was shot from a crossbow or not. |
