...
```zenscript
// FabricItemStack.getOrCreateTag() as IData
...
| Parameter | Type                                     | Description |
| --------- | ---------------------------------------- | ----------- |
| name      | [Component](/vanilla/api/text/Component) | stackの新しい名前 |
...
| fireResistant      | boolean型                                                       | true       | true       | Checks if this IItemStack burns when thrown into fire / lava or damaged by fire.                                                                                  |
